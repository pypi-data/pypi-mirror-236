...
import numpy as np
from AstecManager.libs.lineage import temporal_alignment, get_aligned_time,AddNodeToXML
...
class Manager:
    ...
    def plot_signal_to_noise(self, embryo_name, parameters):
        from AstecManager.libs.analyze import plotsignaltonoise
        plotsignaltonoise(embryo_name, parameters)

    def plot_signal_to_noise_tofolder(self, folder,embryo_name):
        from AstecManager.libs.analyze import plotsignaltonoise_tofolder
    ...
    def plot_mars_info(self, embryo_name, exp_seg, begin_time, working_resolution=0.3):
        from AstecManager.libs.analyze import plotmarsinfos
