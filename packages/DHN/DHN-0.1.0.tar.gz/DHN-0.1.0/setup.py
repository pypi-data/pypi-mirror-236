...
class CMakeBuild(build_ext):
    def build_extension(self, ext):
        ...
        cmake_args = [
            ...
            "-DUSER_INCLUDE_PATH=./src/DHN/_dhn/include"
        ]
...
setup(
    ...
    package_dir = {'': 'src'},
    ext_package='DHN',
    ext_modules=[CMakeExtension('_dhn')],
    packages=['DHN'],
    cmdclass=dict(build_ext=CMakeBuild),
    zip_safe=False,
    url = 'https://github.com/marciogameiro/DHN',
    include_package_data = True,
    install_requires=['scipy', 'numpy', 'graphviz', 'progressbar2', 'pychomp2'],
)
