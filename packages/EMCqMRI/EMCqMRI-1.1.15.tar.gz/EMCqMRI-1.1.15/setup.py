...
setuptools.setup(name="EMCqMRI", # Replace with your own username
    ...
    install_requires=['h5py', 'numpy >=1.19.0', 'scipy >=1.2.1', 'matplotlib >=3.3.2', 'PyQt5 >=5.15.1', 'progress >=1.5', 'monai', 'pytorch-ignite', 'pillow ==8.2.0', 'dipy==1.7.0', 'fury ==0.7.0', 'tensorboard'],
    classifiers=[
