...
class DataQuality:
    ...
    def write_dqresult_in_adls(self,df,folderName):
        ...
        blob_name=f'DQ_result/{folderName}'
    ...
    def main(self):
        ...
        if self.choice['BusinessContext']==1:
            ...
            self.write_dqresult_in_adls(self,result_bc.toPandas(),'business_context')
        if self.choice['DQRules']==1:
            ...
            self.write_dqresult_in_adls(self,result_dq.toPandas(),'DQRules')
        ...
        if self.choice['AnomalyDetection']==1:
            ...
            self.write_dqresult_in_adls(self,result_sp,'AnomalyDetectionResult')
        ...
        if self.choice['Standardization']==1:
            ...
            # result.to_table(final_table, overwriteSchema=True)
            self.write_dqresult_in_adls(self,result.toPandas(),'StandadrizationREsult')
