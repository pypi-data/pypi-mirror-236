...
1.2. Promedio Móvil
1.3. Promedio Móvil Ponderado
1.4. Suavización Exponencial Simple
1.5. Suavización Exponencial Doble (HOLT)
1.6. Suavización Exponencial Triple (HOLT-WINTERS)
2. Planeación Agregada
2.1. Planeación Agregada Con Inventario Cero
2.2. Planeación Agregada Con Fuerza De Trabajo Constante
2.3. Planeación Agregada Con Sin tiempo Extra
2.4. Planeación Agregada Con Sin subcontratación
2.5. Planeación Agregada De Trabajo Mixto (Programación Lineal)
3. Programación De La Producción (MPS)
3.1. Balanceo De Línea
3.1. Reglas de secuenciación
3.1.1. SPT: Tiempo de Procesamiento más Corto
3.1.2. LPT: Tiempo de Procesamiento más Largo
3.1.3. EFT: Tiempo de Finalización más Temprano
3.1.4. LFT: Tiempo de Finalización más Tardío
3.1.5. EDD: Tiempo de Entrega (Earliest Due Date)
3.1.6. S/EDD: Relación Tiempo de Procesamiento-Tiempo de Entrega (Corto/Earliest Due Date)
3.1.7. L/EDD: Relación Tiempo de Procesamiento-Tiempo de Entrega (Largo/Earliest Due Date)
3.1.8. HLC: Costo de Retraso más Alto
3.3. Secuenciación De Trabajos
3.3.1. Jhonson
3.3.2. Branch And Bound
3.3.3. CDS
3.3.4. Programación Lineal
