...
# Description : Wrapper for rule34.xxx on python
# -----------------------------------------------------------------------------
#
...
class Rule34():
    ...
    def paramsGenerator(self, tags: str = "") -> dict[str]:
        ...
        Args:
            tags (str, optional): tags for a search like in the rule34 search bar. Defaults to "".
...
'''
    ...
    def dictOfAPost(self, id: int) -> dict:
        ...
        """
        url = f"https://api.rule34.xxx/index.php?page=dapi&s=post&q=index&id={id}"
    ...
    def download(self, url_file: str, file_name: str = "", save_path: str = "") -> NoReturn:
        """
        Function to download images or videos to rule34 via link from rule34 only
        ...
        Raises:
            ValueError: The URL is not authorized for downloading.
                        Link to download must start with `https://api-cdn.rule34.xxx/`

        Returns:
            NoReturn: no return
        """

        link_base = "https://api-cdn.rule34.xxx/"
    ...
    def safeModeSwitch(self):
        """
        Function which allows you to have only post safe on rule34
    ...
    def explicitModeSwitch(self):
        """
        Function which allows you to have only explicit and questionable posts on rule34
