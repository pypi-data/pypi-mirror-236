...
class OpenAIClient:
    ...
    @staticmethod
    def __handle_error(error: openai.OpenAIError) -> ErrorHandlingMethod:
        ...
        error_handling_map = {
            ...
            TimeoutError: ErrorHandlingMethod.RETRY,
            OSError: ErrorHandlingMethod.RETRY,
            RequestException: ErrorHandlingMethod.RETRY,
            HTTPError: ErrorHandlingMethod.RETRY,
        }
    ...
    def __call_openai(
        ...
        while retries < call_context.call_kwargs.max_retries_after_openai_error:
            try:
                ...
                error_handling_method = OpenAIClient.__handle_error(error)
                ...
                if error_handling_method == ErrorHandlingMethod.RETRY:
                    ...
                    delay *= call_context.call_kwargs.exponential_base * (
                        1 + call_context.call_kwargs.jitter * random.random()
                    )
                    sleep_time = delay
                    print(
