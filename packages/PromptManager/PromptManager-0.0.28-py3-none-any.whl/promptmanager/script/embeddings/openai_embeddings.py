...
def _create_retry_decorator(embeddings: PMOpenAIEmbeddings) -> Callable[[Any], Any]:
    import openai
...
def _async_retry_decorator(embeddings: PMOpenAIEmbeddings) -> Any:
    import openai
...
# https://stackoverflow.com/questions/76469415/getting-embeddings-of-length-1-from-langchain-PMOpenAIEmbeddings
...
def embed_with_retry(embeddings: PMOpenAIEmbeddings, **kwargs: Any) -> Any:
...
async def async_embed_with_retry(embeddings: PMOpenAIEmbeddings, **kwargs: Any) -> Any:
    """Use tenacity to retry the embedding call."""
...
class PMOpenAIEmbeddings(BaseModel, PMEmbeddings):
    ...
    Example:
        .. code-block:: python
            ...
            from langchain.embeddings import PMOpenAIEmbeddings
            openai = PMOpenAIEmbeddings(openai_api_key="my-api-key")
    ...
    Example:
        .. code-block:: python
            ...
            from langchain.embeddings.openai import PMOpenAIEmbeddings
    ...
    def _get_len_safe_embeddings(
        ...
        try:
            ...
            raise ImportError(
                ...
                "This is needed in order to for PMOpenAIEmbeddings. "
