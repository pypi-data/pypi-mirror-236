...
class PMFlowScriptNode(PMFlowNode):
    ...
    def __init__(self, id=None, name=None, path=None, module_id=None, module_name=None, module_type=None, params=None,
...
class PMFlow(object):
    ...
    def remove_edge(self, source_node, source_node_output_name, target_node, target_node_input_name):
        edge = PMFlowEdge(source_node=source_node, source_node_output_name=source_node_output_name,
                          target_node=target_node, target_node_input_name=target_node_input_name)
        ...
        for current_edge in self.edges:
            if current_edge.source_node == current_node.id:
                ...
                if not self.__get_node_status(target_node.id) or self.__get_node_status(
                    ...
                    self._run_node(target_node, node_output_dict, target_node)
                    # run next node
