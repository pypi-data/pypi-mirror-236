...
class QClipBlendNodeCreatedChangeBase(Qt3DCore.QNodeCreatedChangeBase):
    ...
    def __init__(self, node: typing.Optional['QAbstractClipBlendNode']) -> None: ...
...
class QMorphTarget(QtCore.QObject):
    ...
    @staticmethod
    def fromGeometry(geometry: typing.Optional[Qt3DRender.QGeometry], attributes: typing.Iterable[typing.Optional[str]]) -> typing.Optional['QMorphTarget']: ...
    def removeAttribute(self, attribute: typing.Optional[Qt3DRender.QAttribute]) -> None: ...
    def addAttribute(self, attribute: typing.Optional[Qt3DRender.QAttribute]) -> None: ...
