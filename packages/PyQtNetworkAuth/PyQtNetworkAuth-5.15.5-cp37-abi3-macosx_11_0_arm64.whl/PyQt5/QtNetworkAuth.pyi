...
class QAbstractOAuth(QtCore.QObject):
    ...
    def grant(self) -> None: ...
    def prepareRequest(self, request: typing.Optional[QtNetwork.QNetworkRequest], verb: typing.Union[QtCore.QByteArray, bytes, bytearray], body: typing.Union[QtCore.QByteArray, bytes, bytearray] = ...) -> None: ...
    ...
    def deleteResource(self, url: QtCore.QUrl, parameters: typing.Dict[str, typing.Any] = ...) -> typing.Optional[QtNetwork.QNetworkReply]: ...
    def put(self, url: QtCore.QUrl, parameters: typing.Dict[str, typing.Any] = ...) -> typing.Optional[QtNetwork.QNetworkReply]: ...
    def post(self, url: QtCore.QUrl, parameters: typing.Dict[str, typing.Any] = ...) -> typing.Optional[QtNetwork.QNetworkReply]: ...
    def get(self, url: QtCore.QUrl, parameters: typing.Dict[str, typing.Any] = ...) -> typing.Optional[QtNetwork.QNetworkReply]: ...
    def head(self, url: QtCore.QUrl, parameters: typing.Dict[str, typing.Any] = ...) -> typing.Optional[QtNetwork.QNetworkReply]: ...
...
class QAbstractOAuth2(QAbstractOAuth):
    ...
    def put(self, url: QtCore.QUrl, parameters: typing.Dict[str, typing.Any] = ...) -> typing.Optional[QtNetwork.QNetworkReply]: ...
    @typing.overload
    def put(self, url: QtCore.QUrl, data: typing.Union[QtCore.QByteArray, bytes, bytearray]) -> typing.Optional[QtNetwork.QNetworkReply]: ...
    @typing.overload
    def put(self, url: QtCore.QUrl, multiPart: typing.Optional[QtNetwork.QHttpMultiPart]) -> typing.Optional[QtNetwork.QNetworkReply]: ...
    @typing.overload
    def post(self, url: QtCore.QUrl, parameters: typing.Dict[str, typing.Any] = ...) -> typing.Optional[QtNetwork.QNetworkReply]: ...
    @typing.overload
    def post(self, url: QtCore.QUrl, data: typing.Union[QtCore.QByteArray, bytes, bytearray]) -> typing.Optional[QtNetwork.QNetworkReply]: ...
    @typing.overload
...
class QOAuth1(QAbstractOAuth):
    ...
    @typing.overload
    def setup(self, request: typing.Optional[QtNetwork.QNetworkRequest], signingParameters: typing.Dict[str, typing.Any], operation: QtNetwork.QNetworkAccessManager.Operation) -> None: ...
    @typing.overload
    def setup(self, request: typing.Optional[QtNetwork.QNetworkRequest], signingParameters: typing.Dict[str, typing.Any], operationVerb: typing.Union[QtCore.QByteArray, bytes, bytearray]) -> None: ...
    def requestTokenCredentials(self, operation: QtNetwork.QNetworkAccessManager.Operation, url: QtCore.QUrl, temporaryToken: typing.Tuple[typing.Optional[str], typing.Optional[str]], parameters: typing.Dict[str, typing.Any] = ...) -> typing.Optional[QtNetwork.QNetworkReply]: ...
    def requestTemporaryCredentials(self, operation: QtNetwork.QNetworkAccessManager.Operation, url: QtCore.QUrl, parameters: typing.Dict[str, typing.Any] = ...) -> typing.Optional[QtNetwork.QNetworkReply]: ...
...
class QOAuth1Signature(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def __init__(self, url: QtCore.QUrl, clientSharedKey: typing.Optional[str], tokenSecret: typing.Optional[str], method: 'QOAuth1Signature.HttpRequestMethod' = ..., parameters: typing.Dict[str, typing.Any] = ...) -> None: ...
    @typing.overload
