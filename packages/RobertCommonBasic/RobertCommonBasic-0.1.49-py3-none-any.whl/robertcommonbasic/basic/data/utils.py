...
# 添加自定义函数
g_s.functions.update(convert=convert_value, max=max, min=min, sum=sum, bit=bit, _in=_in, signed=signed, inverse_long=inverse_long, inverse_float=inverse_float, inverse_double=inverse_double, _and=_and, _or=_or)
