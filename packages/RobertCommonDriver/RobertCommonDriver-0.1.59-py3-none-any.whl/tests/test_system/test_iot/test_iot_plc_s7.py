...
def test_read_200s():
    dict_config = {'multi_read': 20, 'cmd_interval': 0.3, 'send_timeout': 15, 'rec_timeout': 3500}
    dict_point = {}
    dict_point['PMPower_DHU_B1_4F_13'] = {'point_writable': True, 'point_name': 'PMPower_DHU_B1_4F_13', 'point_device_address': '20.25.34.132/102/0/1/1', 'point_address': 'DB1,REAL3000', 'point_scale': '1'}
    client = IOTPlcS7(configs=dict_config, points=dict_point)
    client.logging(call_logging=logging_print)
    while True:
        try:
...
def test_connect_plc():
    client = IOTPlcS7(configs={}, points={})
    print(client.discover(version=[2], ip='20.25.34.140', port=102))
