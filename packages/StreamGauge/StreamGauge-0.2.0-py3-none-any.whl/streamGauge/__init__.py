...
if not _RELEASE:
    ...
    StreamGauge = components.declare_component(
        "StreamGauge", 
    ...
    StreamGauge = components.declare_component("StreamGauge", path=build_dir)



def StreamGauge(gVal, gTitle="", gMode='gauge+number', gSize="MED",
