...
def StreamIndicator(gVal, gTitle="", gMode='gauge+number', vType="Default", gSize="MED",
                    grLow=.30, grMid=.70, gcLow='red', gcMid='yellow', gcHigh='green',
                    xpLeft=0, xpRight=1, ypBot=0, ypTop=1, arBot=None, arTop=1,
                    pTheme="streamlit", cWidth=True, pFix=None, sFix=None):
