...
class GetUserActiveExtensionsRequest(Utils.RequestBaseClass):
    ...
    def __init__(self, user_id: Optional[str], userAuth=False) -> None:
        if userAuth:
            self.authorization = Utils.AuthRequired.USER
...
class UpdateUserExtensionsRequest(Utils.RequestBaseClass):
    ...
    authorization = Utils.AuthRequired.USER
    endPoint ="/users/extensions"
    def __init__(self, user_id: str, panel: Optional[dict[str, ExtensionItem]]=None, overlay: Optional[dict[str, ExtensionItem]]=None, component: Optional[dict[str, ExtensionItem]]=None) -> None:
        self.user_id = user_id
        self.panel = panel
