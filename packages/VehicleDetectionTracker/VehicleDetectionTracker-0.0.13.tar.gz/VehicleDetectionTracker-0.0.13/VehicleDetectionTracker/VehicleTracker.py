        ...
        if results[0].boxes is not None:
            ...
            for box, track_id in zip(boxes, track_ids):
                ...
                return {
                    ...
                    'frame_base64': self.convert_frame_to_base64(annotated_frame)
                }
        else:
            logger.info("No processed data available for the frame.")
            return {
                'processed_info': [{'message': 'No relevant objects detected in the frame'}],
                'frame_base64': self.convert_frame_to_base64(frame)
            }