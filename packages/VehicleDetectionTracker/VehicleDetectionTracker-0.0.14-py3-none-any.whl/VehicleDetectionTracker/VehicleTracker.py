...
class VehicleTracker:
    ...
    def _enhance_night_vision(self, frame):
        """
        Enhance the night vision of a frame by improving contrast and reducing noise.
        ...
        """
        # Convert the frame to grayscale (assumes the input frame is in color)
    ...
    def process_frame(self, frame):
        ...
        enhanced_frame = self.enhance_night_vision(frame)
