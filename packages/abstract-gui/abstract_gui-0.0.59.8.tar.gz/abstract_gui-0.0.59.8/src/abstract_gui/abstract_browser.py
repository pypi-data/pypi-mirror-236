...
class AbstractBrowser:
    ...
    @staticmethod
    def get_scan_browser_layout(section=None):
        """
        ...
        [make_component("Listbox",[],size=(50, 10),key='-FILES_LIST-',enable_events=True),make_component("Checkbox",'all',default=True,key=text_to_key(text='scan mode all',section=section))],
