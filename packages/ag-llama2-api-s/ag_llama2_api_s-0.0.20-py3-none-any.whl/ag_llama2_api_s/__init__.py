...
MODEL = os.getenv("MODEL", "WizardLM/WizardLM-13B-V1.2")
...
SERVER_IDENTITY = os.getenv("SERVER_IDENTITY", "llama_api")
...
COMPLETION_MAX_PROMPT = int(os.getenv("COMPLETION_MAX_PROMPT", "2048"))
