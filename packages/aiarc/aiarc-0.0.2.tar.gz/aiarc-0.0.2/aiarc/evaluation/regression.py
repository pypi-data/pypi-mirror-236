...
from aiarc.utils.model_files import save_model_parameters
        ...
        **kwargs: Any,
        ...
        for data in train_loader:
            ...
            if len(data.y.size()) == 1:
                #this is the problem giving AssertionError: torch.Size([64, 1]) torch.Size([]) torch.Size([64]) torch.Size([64])
