...
class InitiateCall500ApplicationJSONData(Exception):
...
@dataclasses.dataclass
class InitiateCall422ApplicationJSONData(Exception):
...
@dataclasses.dataclass
class InitiateCall404ApplicationJSONData(Exception):
    r"""https://github.com/colinhacks/zod"""
...
@dataclasses.dataclass
class InitiateCall403ApplicationJSONData(Exception):
    r"""https://github.com/colinhacks/zod"""
