...
class Pipeline(object):
    ...
    def __init__(self, pipeline_id=None, pipeline_name=None, pipeline_type=None, is_attached=None, policy_details=None, background_catalog_status=None, local_vars_configuration=None):  # noqa: E501
