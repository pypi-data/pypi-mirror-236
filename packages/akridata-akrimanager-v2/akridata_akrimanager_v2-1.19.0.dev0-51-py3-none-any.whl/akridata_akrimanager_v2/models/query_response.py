...
class QueryResponse(object):
    ...
    def __init__(self, query_id=None, dataset_id=None, first_table_alias='', query_str=None, query_json=None, status=None, source_type=None, is_internal=None, submitted_at=None, started_at=None, exec_duration=None, submitted_by=None, rows_processed=None, data_scanned=None, s3_result_size=None, status_message=None, s3_result_columns=None, s3_result_row_count=None, total_objects=None, result_available=None, local_vars_configuration=None):  # noqa: E501
