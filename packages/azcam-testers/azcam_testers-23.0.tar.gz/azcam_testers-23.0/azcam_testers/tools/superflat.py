...
from azcam_testers.tools.basetester import Tester
...
class Superflat(Tester):
    ...
    def acquire(self):
        ...
        if azcam.db.tools["detcal"].valid and len(self.exposure_levels) > 0:
            ...
            self.exposure_times = numpy.array(self.exposure_levels) / meanelectrons[wave] / binning
        ...
        for setnum, exposuretime in enumerate(self.exposure_times):
            ...
            currentfolder, subfolder = azcam_console.utils.make_file_folder("superflat", 1, 1)
    ...
    def analyze(self):
        ...
        if self.overscan_correct:
            ...
            superflat_image.set_scaling(self.system_gain, azcam.db.tools["gain"].zero_mean)
