...
def main():
    ...
    parser.add_argument("--save_filtered_baguette", action="store_true", default=False, help="If enabled, instead of saving the raw BAGUETTE graph in the 'baguette.pyt' file, only the filtered BAGUETTE will be saved.")
