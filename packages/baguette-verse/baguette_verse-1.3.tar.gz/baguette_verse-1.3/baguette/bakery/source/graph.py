...
from typing import Any, Callable, Iterable, Iterator, Never, Optional, TypeVar, Union
...
del RLock, Thread, Any, Callable, Iterable, Iterator, Never, Optional, TypeVar, Union, WeakKeyDictionary, WeakValueDictionary, Color, ColorSetting, SizeSetting, SwitchSetting, WeightSetting, InstanceReferencingClass