...
import itertools
from util.str_util import extract_bucket, extract_object_key
...
class S3Util:
    ...
    def upload_file(self, local_file, remote_file):
        ...
        try:
            ...
            logging.error("file: %s 本地文件未找到", local_file)
            return False
        except NoCredentialsError:
            logging.error("AWS凭证未设置")
            return False
    ...
    def download_file(self, remote_file, local_file):
        ...
        try:
            ...
            logging.info("%s 下载成功", local_file)
            return True
        except FileNotFoundError:
            logging.error("%s S3文件未找到", object_key)
            return False
        except NoCredentialsError:
            logging.error("AWS凭证未设置")
            return False
