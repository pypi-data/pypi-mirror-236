...
markets_list = [
    ...
    {'market_id': '189',
         ...
         'market_outcomes': ['GAMES_TOTAL_OVER',
                             'GAMES_TOTAL_UNDER']},
    {'market_id': '190',
         'market_name': 'GAMES_HOME_TOTAL',
         'market_outcomes': ['GAMES_HOME_TOTAL_OVER',
                             'GAMES_HOME_TOTAL_UNDER']},
    {'market_id': '191',
         'market_name': 'GAMES_AWAY_TOTAL',
         'market_outcomes': ['GAMES_AWAY_TOTAL_OVER',
                             'GAMES_AWAY_TOTAL_UNDER']},
]
