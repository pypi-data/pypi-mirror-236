...
class _IHPSG13G2(_tch.Technology):
    ...
    def __init__(self):
        ...
        prims += (
            NWell, pSD, ThickGateOx, EXTBlock, RES, SalBlock,
        )
        ...
        # The ESD
        # esdhvmosgate = _prm.MOSFETGate(name="esdhvmosgate",
        #     active=Activ, poly=GatPoly, oxide=ThickGateOx, inside=SalBlock,
        #     min_l=0.36, # From GDSII
        #     min_gate_space=0.615, 
        # )
        trans = {
            ...
            for name, gate, well, impl, impl_enc in (
                ...
                ("sg13g2_hv_nmos", hvmosgate, None, (), ()), # min_l Gat.a3
