...
stdcell1v2canvas = _fab.StdCellCanvas(
    tech=tech,
    nmos=cast(_prm.MOSFET, prims.sg13g2_lv_nmos), nmos_min_w=0.76,
    pmos=cast(_prm.MOSFET, prims.sg13g2_lv_pmos), pmos_min_w=0.76,
...
stdcell3v3canvas = _fab.StdCellCanvas(
    tech=tech,
    nmos=cast(_prm.MOSFET, prims.sg13g2_hv_nmos), nmos_min_w=0.76,
    pmos=cast(_prm.MOSFET, prims.sg13g2_hv_pmos), pmos_min_w=0.76,
