...
def waveform_mode_func(uargs):
    ...
    # Read each file as a single dc field frequency
    # and create an experiment for this frequency
    all_experiments = wfrm.Experiment.from_files(
        user_cfg.file_name,
        data_header=uargs.data_header,
        temp_thresh=uargs.temp_thresh,
        field_window=uargs.field_window
    )
