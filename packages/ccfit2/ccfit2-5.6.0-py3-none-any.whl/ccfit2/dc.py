...
class Model(ABC):
    ...
    def fit_to(self, experiment: 'Experiment',
        ...
        # <ln(tau)>, sigma_<ln(tau)>, and <ln(tau)>_fit_ul
        ...
        elif any([np.isnan(val) or val is None for val in self.lntau_fit_ul]):
            if verbose:
...
def write_model_params(models: list[Model],
    ...
    if model_type == DoubleExponentialModel: # noqa
        header += [
            '<ln(tau1)> (ln(s))',
            'sigma_ln(tau1) (ln(s))',
            'fit_upper_<ln(tau1)> (ln(s))',
            'fit_lower_<ln(tau1)> (ln(s))',
            '<ln(tau2)> (ln(s))',
            'sigma_ln(tau2) (ln(s))',
            'fit_upper_<ln(tau2)> (ln(s))',
            'fit_lower_<ln(tau2)> (ln(s))'
        ]
    else:
        header += [
            '<ln(tau)> (ln(s))',
            'sigma_<ln(tau)> (ln(s))',
            'fit_upper_<ln(tau)> (ln(s))',
            'fit_lower_<ln(tau)> (ln(s))'
        ]
