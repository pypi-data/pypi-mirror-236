...
class TauHDataset():
    ...
    def from_ccfit2_files(cls, file_names: str | list[str]) -> 'TauHDataset':
        ...
        headers = {
            ...
            'lntau_stdevs': ['sigma_<ln(tau)>', 'sigma_<ln(tau)> (ln(s))', 'sigma_ln(tau)'], # noqa
            'lntau_fus': ['fit_upper_ln(tau)', 'fit_upper_<ln(tau)> (ln(s))', 'fit_upper_<ln(tau)>'], # noqa
            'lntau_fls': ['fit_lower_ln(tau)', 'fit_lower_<ln(tau)> (ln(s))', 'fit_lower_<ln(tau)>'], # noqa
        }
