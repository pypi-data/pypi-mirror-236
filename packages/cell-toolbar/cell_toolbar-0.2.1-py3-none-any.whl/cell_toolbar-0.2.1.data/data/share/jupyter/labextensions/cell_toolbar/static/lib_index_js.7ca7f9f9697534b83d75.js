...
// Module
___CSS_LOADER_EXPORT___.push([module.id, `.jp-cell-editor-active {
  background: orange;
}
...
.jp-Placeholder {
  ...
  `, "",{"version":3,"sources":["webpack://./style/index.css"],"names":[],"mappings":"AAAA;EACE,kBAAkB;AACpB;;AAEA;GACG,aAAa;GACb,mBAAmB,EAAE,gCAAgC;GACrD,2BAA2B,EAAE,4BAA4B;GACzD,mBAAmB,EAAE,iCAAiC;EACvD;;EAEA;IACE,WAAW;IACX,YAAY;IACZ,kBAAkB;IAClB,gBAAgB;IAChB,yBAAyB;IACzB,YAAY;IACZ,gBAAgB;IAChB,gBAAgB;IAChB,4CAA4C;IAC5C,aAAa;IACb,eAAe;IACf,iBAAiB;IACjB,gBAAgB;IAChB,iBAAiB;EACnB;;EAEA;;IAEE,aAAa;EACf;;EAEA,6CAA6C;AAC/C;;;EAGE,uBAAuB;EACvB,+BAA+B;AACjC;;EAEE,iCAAiC;EACjC;IACE,mBAAmB;EACrB;;EAEA;IACE,sBAAsB;EACxB;;EAEA;IACE,sBAAsB;EACxB;;EAEA;IACE,oCAAoC;IACpC,2CAA2C;EAC7C;;EAEA;IACE,oCAAoC;IACpC,UAAU;IACV,2CAA2C;IAC3C,kCAAkC;EACpC;;EAEA;IACE,8BAA8B;EAChC;;EAEA;IACE,wBAAwB;IACxB,sBAAsB;EACxB;;EAEA;IACE,YAAY;IACZ,QAAQ;EACV;;EAEA;IACE,eAAe;EACjB;;EAEA;IACE,QAAQ;EACV","sourcesContent":[".jp-cell-editor-active {\n  background: orange;\n}\n\n.jp-Cell .ccb-cellFooterContainer {\n   display: flex;\n   flex-direction: row; /* Ensure horizontal alignment */\n   justify-content: flex-start; /* Move button to the left */\n   align-items: center; /* Vertically center the button */\n  }\n\n  .jp-Cell .ccb-cellFooterBtn {\n    color: #fff;\n    opacity: 0.7;\n    font-size: 0.65rem;\n    font-weight: 500;\n    text-transform: uppercase;\n    border: none;\n    padding: 4px 8px;\n    margin: 0.2rem 0;\n    text-shadow: 0px 0px 5px rgba(0, 0, 0, 0.15);\n    outline: none;\n    cursor: pointer;\n    user-select: none;  \n    margin-left: 0px;\n    margin-right: 4px;\n  }\n\n  .jp-Placeholder-content .jp-PlaceholderText,\n  .jp-Placeholder-content .jp-MoreHorizIcon {\n    display: none;\n  }\n\n  /* Disable default cell collapsing behavior */\n.jp-InputCollapser,\n.jp-OutputCollapser,\n.jp-Placeholder {\n  cursor: auto !important;\n  pointer-events: none !important;\n}\n\n  /* Add styles for toggle button */\n  .jp-Cell .ccb-toggleBtn{\n    background: #f0f0f0;\n  }\n\n  .jp-Cell .ccb-toggleBtn:hover{\n    background-color: #ccc;\n  }\n\n  .jp-Cell .ccb-toggleBtn:active{\n    background-color: #999;\n  }\n  \n  .jp-Cell .ccb-cellFooterBtn:active {\n    background-color: var(--md-blue-600);\n    text-shadow: 0px 0px 4px rgba(0, 0, 0, 0.4);\n  }\n  \n  .jp-Cell .ccb-cellFooterBtn:hover {\n    background-color: var(--md-blue-500);\n    opacity: 1;\n    text-shadow: 0px 0px 7px rgba(0, 0, 0, 0.3);\n    box-shadow: var(--jp-elevation-z2);\n  }\n  \n  .jp-Cell .ccb-cellFooterBtn {\n    background: var(--md-blue-400);\n  }\n  \n  .jp-CodeCell {\n    display: flex !important;\n    flex-direction: column;\n  }\n  \n  .jp-CodeCell .jp-CellFooter {\n    height: auto;\n    order: 2;\n  }\n  \n  .jp-Cell .jp-Cell-inputWrapper {\n    margin-top: 5px;\n  }\n  \n  .jp-CodeCell .jp-Cell-outputWrapper {\n    order: 4;\n  }\n  "],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=lib_index_js.7ca7f9f9697534b83d75.js.map