...
def register():
    ...
    bpy.types.Scene.preemptible_retries = bpy.props.IntProperty(name="Preempted Retries", default=1, min=1, max=100)
    ...
    bpy.types.Scene.chunk_size = bpy.props.IntProperty(name="Chunk Size", default=1, min=1, max=100)
    ...
    # Add subtype folder to bpy.types.Scene.output_folder

    bpy.types.Scene.output_folder = bpy.props.StringProperty(name="Output Folder", description="", default="", subtype='DIR_PATH')
