...
from citio_trust_adrien.save_and_display_infos import save_infos
...
setup(
    ...
    download_url="https://github.com/adrienrobiliard/citio_trust_Adrien/archive/refs/tags/v1.0.3.tar.gz",
