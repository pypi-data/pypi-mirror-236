...
import clientapi_atrocore.models
from clientapi_atrocore import rest
from clientapi_atrocore.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(clientapi_atrocore.models, klass)
