...
class Attachment(BaseModel):
    ...
    __properties = ["id", "deleted", "name", "url", "type", "private", "size", "field", "createdAt", "createdById", "createdByName", "contents", "role", "storage", "storageFilePath", "storageThumbPath", "global", "md5", "pathsData"]
