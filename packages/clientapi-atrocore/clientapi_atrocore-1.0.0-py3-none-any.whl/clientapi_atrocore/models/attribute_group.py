...
class AttributeGroup(BaseModel):
    ...
    __properties = ["id", "deleted", "name", "nameDeDe", "description", "descriptionDeDe", "code", "isActive", "createdAt", "modifiedAt", "createdById", "createdByName", "modifiedById", "modifiedByName", "ownerUserId", "ownerUserName", "assignedUserId", "assignedUserName", "teamsIds", "teamsNames", "sortOrder"]
