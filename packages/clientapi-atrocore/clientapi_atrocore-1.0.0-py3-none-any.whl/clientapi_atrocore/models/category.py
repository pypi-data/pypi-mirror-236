...
class Category(BaseModel):
    ...
    position: Optional[StrictStr] = Field(None, alias="_position")
    target: Optional[StrictStr] = Field(None, alias="_target")
    children_count: Optional[StrictInt] = Field(None, alias="childrenCount")
    category_parent_id: Optional[StrictStr] = Field(None, alias="categoryParentId")
    category_parent_name: Optional[StrictStr] = Field(None, alias="categoryParentName")
    category_route: Optional[StrictStr] = Field(None, alias="categoryRoute")
    category_route_name: Optional[StrictStr] = Field(None, alias="categoryRouteName")
    has_children: Optional[StrictBool] = Field(None, alias="hasChildren")
    sorting: Optional[StrictInt] = None
    __properties = ["id", "deleted", "name", "nameDeDe", "description", "descriptionDeDe", "code", "isActive", "createdAt", "modifiedAt", "createdById", "createdByName", "modifiedById", "modifiedByName", "ownerUserId", "ownerUserName", "assignedUserId", "assignedUserName", "teamsIds", "teamsNames", "sortOrder", "_position", "_target", "childrenCount", "categoryParentId", "categoryParentName", "categoryRoute", "categoryRouteName", "hasChildren", "sorting"]
    ...
    def from_dict(cls, obj: dict) -> Category:
        ...
        _obj = Category.parse_obj({
            ...
            "position": obj.get("_position"),
            "target": obj.get("_target"),
            "children_count": obj.get("childrenCount"),
            "category_parent_id": obj.get("categoryParentId"),
            "category_parent_name": obj.get("categoryParentName"),
            "category_route": obj.get("categoryRoute"),
            "category_route_name": obj.get("categoryRouteName"),
