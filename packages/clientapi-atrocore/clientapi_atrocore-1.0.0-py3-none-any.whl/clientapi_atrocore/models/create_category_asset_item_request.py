...
class CreateCategoryAssetItemRequest(BaseModel):
    """
    ...
    __properties = ["categoryId", "assetId", "isMainImage", "sorting", "tags", "modifiedById", "preview"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateCategoryAssetItemRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateCategoryAssetItemRequest:
        """Create an instance of CreateCategoryAssetItemRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateCategoryAssetItemRequest.parse_obj(obj)

        _obj = CreateCategoryAssetItemRequest.parse_obj({
