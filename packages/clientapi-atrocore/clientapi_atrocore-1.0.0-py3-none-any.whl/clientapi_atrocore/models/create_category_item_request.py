...
class CreateCategoryItemRequest(BaseModel):
    ...
    __properties = ["name", "nameDeDe", "description", "descriptionDeDe", "code", "isActive", "modifiedById", "ownerUserId", "assignedUserId", "teamsIds", "sortOrder", "childrenCount", "categoryParentId", "categoryRoute", "hasChildren", "sorting"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateCategoryItemRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateCategoryItemRequest:
        """Create an instance of CreateCategoryItemRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateCategoryItemRequest.parse_obj(obj)

        _obj = CreateCategoryItemRequest.parse_obj({
            "name": obj.get("name"),
