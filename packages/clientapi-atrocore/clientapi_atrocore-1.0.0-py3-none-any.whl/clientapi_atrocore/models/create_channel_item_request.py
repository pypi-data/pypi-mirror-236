...
class CreateChannelItemRequest(BaseModel):
    """
    ...
    __properties = ["name", "nameDeDe", "description", "descriptionDeDe", "isActive", "locales", "modifiedById", "code", "type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateChannelItemRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateChannelItemRequest:
        """Create an instance of CreateChannelItemRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateChannelItemRequest.parse_obj(obj)

        _obj = CreateChannelItemRequest.parse_obj({
            "name": obj.get("name"),
