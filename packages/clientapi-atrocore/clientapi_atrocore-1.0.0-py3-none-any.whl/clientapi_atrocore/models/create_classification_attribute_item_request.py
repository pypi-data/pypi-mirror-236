...
class CreateClassificationAttributeItemRequest(BaseModel):
    """
    ...
    __properties = ["classificationId", "attributeId", "language", "languages", "isRequired", "scope", "channelId", "value", "modifiedById", "ownerUserId", "assignedUserId", "teamsIds"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateClassificationAttributeItemRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateClassificationAttributeItemRequest:
        """Create an instance of CreateClassificationAttributeItemRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateClassificationAttributeItemRequest.parse_obj(obj)

        _obj = CreateClassificationAttributeItemRequest.parse_obj({
