...
class CreatePackagingItemRequest(BaseModel):
    """
    ...
    __properties = ["name", "description", "price", "isActive", "modifiedById", "productsIds", "ownerUserId", "assignedUserId", "teamsIds"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreatePackagingItemRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreatePackagingItemRequest:
        """Create an instance of CreatePackagingItemRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreatePackagingItemRequest.parse_obj(obj)

        _obj = CreatePackagingItemRequest.parse_obj({
            "name": obj.get("name"),
