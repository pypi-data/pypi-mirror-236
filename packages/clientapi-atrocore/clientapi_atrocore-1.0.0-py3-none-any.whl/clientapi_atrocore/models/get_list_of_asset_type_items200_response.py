...
class GetListOfAssetTypeItems200Response(BaseModel):
    """
    GetListOfAssetTypeItems200Response
    """
    total: Optional[StrictInt] = None
    list: Optional[conlist(AssetType)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetListOfAssetTypeItems200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetListOfAssetTypeItems200Response:
        """Create an instance of GetListOfAssetTypeItems200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetListOfAssetTypeItems200Response.parse_obj(obj)

        _obj = GetListOfAssetTypeItems200Response.parse_obj({
            "total": obj.get("total"),
            "list": [AssetType.from_dict(_item) for _item in obj.get("list")] if obj.get("list") is not None else None
        })
        return _obj
