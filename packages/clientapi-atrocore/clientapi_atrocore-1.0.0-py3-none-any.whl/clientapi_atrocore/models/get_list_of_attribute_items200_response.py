...
class GetListOfAttributeItems200Response(BaseModel):
    """
    GetListOfAttributeItems200Response
    """
    total: Optional[StrictInt] = None
    list: Optional[conlist(Attribute)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetListOfAttributeItems200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetListOfAttributeItems200Response:
        """Create an instance of GetListOfAttributeItems200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetListOfAttributeItems200Response.parse_obj(obj)

        _obj = GetListOfAttributeItems200Response.parse_obj({
            "total": obj.get("total"),
            "list": [Attribute.from_dict(_item) for _item in obj.get("list")] if obj.get("list") is not None else None
        })
        return _obj
