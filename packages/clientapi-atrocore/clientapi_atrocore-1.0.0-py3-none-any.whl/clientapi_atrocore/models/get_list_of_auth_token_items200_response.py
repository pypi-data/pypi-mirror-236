...
class GetListOfAuthTokenItems200Response(BaseModel):
    """
    GetListOfAuthTokenItems200Response
    """
    total: Optional[StrictInt] = None
    list: Optional[conlist(AuthToken)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetListOfAuthTokenItems200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetListOfAuthTokenItems200Response:
        """Create an instance of GetListOfAuthTokenItems200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetListOfAuthTokenItems200Response.parse_obj(obj)

        _obj = GetListOfAuthTokenItems200Response.parse_obj({
            "total": obj.get("total"),
            "list": [AuthToken.from_dict(_item) for _item in obj.get("list")] if obj.get("list") is not None else None
        })
        return _obj
