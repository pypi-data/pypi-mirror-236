...
class GetListOfChannelItems200Response(BaseModel):
    """
    GetListOfChannelItems200Response
    """
    total: Optional[StrictInt] = None
    list: Optional[conlist(Channel)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetListOfChannelItems200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetListOfChannelItems200Response:
        """Create an instance of GetListOfChannelItems200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetListOfChannelItems200Response.parse_obj(obj)

        _obj = GetListOfChannelItems200Response.parse_obj({
            "total": obj.get("total"),
            "list": [Channel.from_dict(_item) for _item in obj.get("list")] if obj.get("list") is not None else None
        })
        return _obj
