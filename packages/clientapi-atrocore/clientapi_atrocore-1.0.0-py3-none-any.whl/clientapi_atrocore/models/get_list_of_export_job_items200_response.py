...
class GetListOfExportJobItems200Response(BaseModel):
    """
    GetListOfExportJobItems200Response
    """
    total: Optional[StrictInt] = None
    list: Optional[conlist(ExportJob)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetListOfExportJobItems200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetListOfExportJobItems200Response:
        """Create an instance of GetListOfExportJobItems200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetListOfExportJobItems200Response.parse_obj(obj)

        _obj = GetListOfExportJobItems200Response.parse_obj({
            "total": obj.get("total"),
            "list": [ExportJob.from_dict(_item) for _item in obj.get("list")] if obj.get("list") is not None else None
        })
        return _obj
