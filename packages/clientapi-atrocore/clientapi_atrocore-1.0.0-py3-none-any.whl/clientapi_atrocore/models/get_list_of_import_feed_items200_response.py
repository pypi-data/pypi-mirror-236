...
class GetListOfImportFeedItems200Response(BaseModel):
    """
    GetListOfImportFeedItems200Response
    """
    total: Optional[StrictInt] = None
    list: Optional[conlist(ImportFeed)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetListOfImportFeedItems200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetListOfImportFeedItems200Response:
        """Create an instance of GetListOfImportFeedItems200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetListOfImportFeedItems200Response.parse_obj(obj)

        _obj = GetListOfImportFeedItems200Response.parse_obj({
            "total": obj.get("total"),
            "list": [ImportFeed.from_dict(_item) for _item in obj.get("list")] if obj.get("list") is not None else None
        })
        return _obj
