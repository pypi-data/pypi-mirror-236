...
class GetListOfJobItems200Response(BaseModel):
    """
    GetListOfJobItems200Response
    """
    total: Optional[StrictInt] = None
    list: Optional[conlist(Job)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetListOfJobItems200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetListOfJobItems200Response:
        """Create an instance of GetListOfJobItems200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetListOfJobItems200Response.parse_obj(obj)

        _obj = GetListOfJobItems200Response.parse_obj({
            "total": obj.get("total"),
            "list": [Job.from_dict(_item) for _item in obj.get("list")] if obj.get("list") is not None else None
        })
        return _obj
