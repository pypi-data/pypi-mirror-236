...
class GetListOfMeasureItems200Response(BaseModel):
    """
    GetListOfMeasureItems200Response
    """
    total: Optional[StrictInt] = None
    list: Optional[conlist(Measure)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetListOfMeasureItems200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetListOfMeasureItems200Response:
        """Create an instance of GetListOfMeasureItems200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetListOfMeasureItems200Response.parse_obj(obj)

        _obj = GetListOfMeasureItems200Response.parse_obj({
            "total": obj.get("total"),
            "list": [Measure.from_dict(_item) for _item in obj.get("list")] if obj.get("list") is not None else None
        })
        return _obj
