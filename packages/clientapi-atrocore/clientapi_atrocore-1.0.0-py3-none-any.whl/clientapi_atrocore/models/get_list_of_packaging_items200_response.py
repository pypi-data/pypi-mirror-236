...
class GetListOfPackagingItems200Response(BaseModel):
    """
    GetListOfPackagingItems200Response
    """
    total: Optional[StrictInt] = None
    list: Optional[conlist(Packaging)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetListOfPackagingItems200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetListOfPackagingItems200Response:
        """Create an instance of GetListOfPackagingItems200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetListOfPackagingItems200Response.parse_obj(obj)

        _obj = GetListOfPackagingItems200Response.parse_obj({
            "total": obj.get("total"),
            "list": [Packaging.from_dict(_item) for _item in obj.get("list")] if obj.get("list") is not None else None
        })
        return _obj
