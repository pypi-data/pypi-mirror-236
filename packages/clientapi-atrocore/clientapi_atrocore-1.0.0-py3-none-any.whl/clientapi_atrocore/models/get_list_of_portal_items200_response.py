...
class GetListOfPortalItems200Response(BaseModel):
    """
    GetListOfPortalItems200Response
    """
    total: Optional[StrictInt] = None
    list: Optional[conlist(Portal)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetListOfPortalItems200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetListOfPortalItems200Response:
        """Create an instance of GetListOfPortalItems200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetListOfPortalItems200Response.parse_obj(obj)

        _obj = GetListOfPortalItems200Response.parse_obj({
            "total": obj.get("total"),
            "list": [Portal.from_dict(_item) for _item in obj.get("list")] if obj.get("list") is not None else None
        })
        return _obj
