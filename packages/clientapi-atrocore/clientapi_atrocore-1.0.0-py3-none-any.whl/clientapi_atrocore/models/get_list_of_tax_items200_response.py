...
class GetListOfTaxItems200Response(BaseModel):
    """
    GetListOfTaxItems200Response
    """
    total: Optional[StrictInt] = None
    list: Optional[conlist(Tax)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetListOfTaxItems200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetListOfTaxItems200Response:
        """Create an instance of GetListOfTaxItems200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetListOfTaxItems200Response.parse_obj(obj)

        _obj = GetListOfTaxItems200Response.parse_obj({
            "total": obj.get("total"),
            "list": [Tax.from_dict(_item) for _item in obj.get("list")] if obj.get("list") is not None else None
        })
        return _obj
