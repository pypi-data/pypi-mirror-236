...
class GetListOfUnitItems200Response(BaseModel):
    """
    GetListOfUnitItems200Response
    """
    total: Optional[StrictInt] = None
    list: Optional[conlist(Unit)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetListOfUnitItems200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetListOfUnitItems200Response:
        """Create an instance of GetListOfUnitItems200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetListOfUnitItems200Response.parse_obj(obj)

        _obj = GetListOfUnitItems200Response.parse_obj({
            "total": obj.get("total"),
            "list": [Unit.from_dict(_item) for _item in obj.get("list")] if obj.get("list") is not None else None
        })
        return _obj
