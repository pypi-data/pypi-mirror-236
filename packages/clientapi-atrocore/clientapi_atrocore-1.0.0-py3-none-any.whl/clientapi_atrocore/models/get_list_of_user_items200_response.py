...
class GetListOfUserItems200Response(BaseModel):
    """
    GetListOfUserItems200Response
    """
    total: Optional[StrictInt] = None
    list: Optional[conlist(User)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetListOfUserItems200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetListOfUserItems200Response:
        """Create an instance of GetListOfUserItems200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetListOfUserItems200Response.parse_obj(obj)

        _obj = GetListOfUserItems200Response.parse_obj({
            "total": obj.get("total"),
            "list": [User.from_dict(_item) for _item in obj.get("list")] if obj.get("list") is not None else None
        })
        return _obj
