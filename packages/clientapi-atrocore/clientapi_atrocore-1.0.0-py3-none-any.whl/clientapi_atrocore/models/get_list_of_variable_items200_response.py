...
class GetListOfVariableItems200Response(BaseModel):
    """
    GetListOfVariableItems200Response
    """
    total: Optional[StrictInt] = None
    list: Optional[conlist(Variable)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetListOfVariableItems200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetListOfVariableItems200Response:
        """Create an instance of GetListOfVariableItems200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetListOfVariableItems200Response.parse_obj(obj)

        _obj = GetListOfVariableItems200Response.parse_obj({
            "total": obj.get("total"),
            "list": [Variable.from_dict(_item) for _item in obj.get("list")] if obj.get("list") is not None else None
        })
        return _obj
