...
class Library(BaseModel):
    ...
    __properties = ["id", "deleted", "name", "description", "createdAt", "modifiedAt", "createdById", "createdByName", "modifiedById", "modifiedByName", "assignedUserId", "assignedUserName", "teamsIds", "teamsNames", "code", "isActive", "ownerUserId", "ownerUserName"]
