...
class Packaging(BaseModel):
    ...
    __properties = ["id", "deleted", "name", "description", "price", "isActive", "createdAt", "modifiedAt", "createdById", "createdByName", "modifiedById", "modifiedByName", "productsIds", "productsNames", "ownerUserId", "ownerUserName", "assignedUserId", "assignedUserName", "teamsIds", "teamsNames"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Packaging:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Packaging:
        """Create an instance of Packaging from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Packaging.parse_obj(obj)

        _obj = Packaging.parse_obj({
            "id": obj.get("id"),
