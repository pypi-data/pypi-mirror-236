...
class RunImportRequest(BaseModel):
    ...
    __properties = ["importFeedId", "attachmentId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RunImportRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RunImportRequest:
        """Create an instance of RunImportRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RunImportRequest.parse_obj(obj)

        _obj = RunImportRequest.parse_obj({
