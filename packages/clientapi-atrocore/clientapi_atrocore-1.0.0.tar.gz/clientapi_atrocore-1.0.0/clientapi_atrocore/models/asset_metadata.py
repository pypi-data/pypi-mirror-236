...
class AssetMetadata(BaseModel):
    ...
    __properties = ["id", "deleted", "name", "value", "assetId", "assetName"]
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AssetMetadata:
        """Create an instance of AssetMetadata from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AssetMetadata.parse_obj(obj)

        _obj = AssetMetadata.parse_obj({
            "id": obj.get("id"),
