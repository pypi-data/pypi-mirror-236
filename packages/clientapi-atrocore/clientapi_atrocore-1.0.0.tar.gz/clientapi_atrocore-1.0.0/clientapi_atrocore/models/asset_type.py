...
class AssetType(BaseModel):
    ...
    __properties = ["id", "deleted", "name", "nameDeDe", "createdAt", "modifiedAt", "createdById", "createdByName", "modifiedById", "modifiedByName", "sortOrder", "assignAutomatically", "typesToExclude"]
