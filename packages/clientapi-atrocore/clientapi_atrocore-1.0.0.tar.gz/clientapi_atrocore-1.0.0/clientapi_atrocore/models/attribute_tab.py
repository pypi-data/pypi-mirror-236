...
class AttributeTab(BaseModel):
    ...
    __properties = ["id", "deleted", "name", "nameDeDe", "description", "createdAt", "modifiedAt", "createdById", "createdByName", "modifiedById", "modifiedByName"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AttributeTab:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AttributeTab:
        """Create an instance of AttributeTab from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AttributeTab.parse_obj(obj)

        _obj = AttributeTab.parse_obj({
            "id": obj.get("id"),
