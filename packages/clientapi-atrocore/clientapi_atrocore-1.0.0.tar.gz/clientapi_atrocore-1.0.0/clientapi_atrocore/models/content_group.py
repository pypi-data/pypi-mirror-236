...
class ContentGroup(BaseModel):
    ...
    __properties = ["id", "deleted", "name", "contentsIds", "contentsNames", "createdAt", "modifiedAt", "createdById", "createdByName", "modifiedById", "modifiedByName", "ownerUserId", "ownerUserName", "assignedUserId", "assignedUserName", "teamsIds", "teamsNames"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContentGroup:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContentGroup:
        """Create an instance of ContentGroup from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContentGroup.parse_obj(obj)

        _obj = ContentGroup.parse_obj({
            "id": obj.get("id"),
