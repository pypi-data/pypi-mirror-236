...
class CreateAssociationItemRequest(BaseModel):
    """
    ...
    __properties = ["name", "nameDeDe", "code", "description", "descriptionDeDe", "isActive", "modifiedById", "ownerUserId", "assignedUserId", "teamsIds", "backwardAssociationId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateAssociationItemRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateAssociationItemRequest:
        """Create an instance of CreateAssociationItemRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateAssociationItemRequest.parse_obj(obj)

        _obj = CreateAssociationItemRequest.parse_obj({
            "name": obj.get("name"),
