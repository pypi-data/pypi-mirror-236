...
class CreateBrandItemRequest(BaseModel):
    """
    ...
    __properties = ["name", "nameDeDe", "description", "descriptionDeDe", "isActive", "modifiedById", "ownerUserId", "assignedUserId", "teamsIds", "code"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateBrandItemRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateBrandItemRequest:
        """Create an instance of CreateBrandItemRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateBrandItemRequest.parse_obj(obj)

        _obj = CreateBrandItemRequest.parse_obj({
            "name": obj.get("name"),
