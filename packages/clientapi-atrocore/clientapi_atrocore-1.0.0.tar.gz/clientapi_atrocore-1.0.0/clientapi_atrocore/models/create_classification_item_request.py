...
class CreateClassificationItemRequest(BaseModel):
    """
    ...
    __properties = ["name", "nameDeDe", "description", "descriptionDeDe", "synonyms", "synonymsDeDe", "code", "isActive", "modifiedById", "ownerUserId", "assignedUserId", "teamsIds"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateClassificationItemRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateClassificationItemRequest:
        """Create an instance of CreateClassificationItemRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateClassificationItemRequest.parse_obj(obj)

        _obj = CreateClassificationItemRequest.parse_obj({
            "name": obj.get("name"),
