...
class CreateContentGroupItemRequest(BaseModel):
    """
    ...
    __properties = ["name", "contentsIds", "modifiedById", "ownerUserId", "assignedUserId", "teamsIds"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateContentGroupItemRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateContentGroupItemRequest:
        """Create an instance of CreateContentGroupItemRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateContentGroupItemRequest.parse_obj(obj)

        _obj = CreateContentGroupItemRequest.parse_obj({
            "name": obj.get("name"),
