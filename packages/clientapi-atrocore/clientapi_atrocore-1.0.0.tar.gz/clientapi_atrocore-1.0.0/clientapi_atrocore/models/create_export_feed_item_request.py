...
class CreateExportFeedItemRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateExportFeedItemRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateExportFeedItemRequest:
        """Create an instance of CreateExportFeedItemRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateExportFeedItemRequest.parse_obj(obj)

        _obj = CreateExportFeedItemRequest.parse_obj({
            "name": obj.get("name"),
            "code": obj.get("code"),
