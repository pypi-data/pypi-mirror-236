...
class CreatePreferencesItemRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreatePreferencesItemRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreatePreferencesItemRequest:
        """Create an instance of CreatePreferencesItemRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreatePreferencesItemRequest.parse_obj(obj)

        _obj = CreatePreferencesItemRequest.parse_obj({
