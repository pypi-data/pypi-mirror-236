...
class CreateProductChannelItemRequest(BaseModel):
    """
    ...
    __properties = ["modifiedById", "productId", "channelId", "isActive"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateProductChannelItemRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateProductChannelItemRequest:
        """Create an instance of CreateProductChannelItemRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateProductChannelItemRequest.parse_obj(obj)

        _obj = CreateProductChannelItemRequest.parse_obj({
