...
class CreateProductSerieItemRequest(BaseModel):
    """
    ...
    __properties = ["name", "description", "modifiedById", "assignedUserId", "teamsIds", "ownerUserId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateProductSerieItemRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateProductSerieItemRequest:
        """Create an instance of CreateProductSerieItemRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateProductSerieItemRequest.parse_obj(obj)

        _obj = CreateProductSerieItemRequest.parse_obj({
            "name": obj.get("name"),
