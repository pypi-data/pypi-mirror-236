...
class CreateSharingItemRequest(BaseModel):
    ...
    __properties = ["name", "description", "active", "available", "entityType", "entityId", "type", "validTill", "allowedUsage", "used", "link", "modifiedById"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateSharingItemRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateSharingItemRequest:
        """Create an instance of CreateSharingItemRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateSharingItemRequest.parse_obj(obj)

        _obj = CreateSharingItemRequest.parse_obj({
            "name": obj.get("name"),
