...
class CreateTaxItemRequest(BaseModel):
    """
    ...
    __properties = ["name", "nameDeDe", "value", "isActive", "modifiedById", "ownerUserId", "assignedUserId", "teamsIds", "productsIds"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateTaxItemRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateTaxItemRequest:
        """Create an instance of CreateTaxItemRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateTaxItemRequest.parse_obj(obj)

        _obj = CreateTaxItemRequest.parse_obj({
            "name": obj.get("name"),
