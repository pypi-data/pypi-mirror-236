...
class GetInstalledModules200Response(BaseModel):
    """
    GetInstalledModules200Response
    """
    total: Optional[StrictInt] = None
    list: Optional[conlist(GetInstalledModules200ResponseListInner)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetInstalledModules200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetInstalledModules200Response:
        """Create an instance of GetInstalledModules200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetInstalledModules200Response.parse_obj(obj)

        _obj = GetInstalledModules200Response.parse_obj({
            "total": obj.get("total"),
            "list": [GetInstalledModules200ResponseListInner.from_dict(_item) for _item in obj.get("list")] if obj.get("list") is not None else None
        })
        return _obj
