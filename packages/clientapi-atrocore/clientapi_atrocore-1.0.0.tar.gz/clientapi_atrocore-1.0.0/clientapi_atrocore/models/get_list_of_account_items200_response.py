...
class GetListOfAccountItems200Response(BaseModel):
    """
    GetListOfAccountItems200Response
    """
    total: Optional[StrictInt] = None
    list: Optional[conlist(Account)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetListOfAccountItems200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetListOfAccountItems200Response:
        """Create an instance of GetListOfAccountItems200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetListOfAccountItems200Response.parse_obj(obj)

        _obj = GetListOfAccountItems200Response.parse_obj({
            "total": obj.get("total"),
            "list": [Account.from_dict(_item) for _item in obj.get("list")] if obj.get("list") is not None else None
        })
        return _obj
