...
class GetListOfAssetItems200Response(BaseModel):
    """
    GetListOfAssetItems200Response
    """
    total: Optional[StrictInt] = None
    list: Optional[conlist(Asset)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetListOfAssetItems200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetListOfAssetItems200Response:
        """Create an instance of GetListOfAssetItems200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetListOfAssetItems200Response.parse_obj(obj)

        _obj = GetListOfAssetItems200Response.parse_obj({
            "total": obj.get("total"),
            "list": [Asset.from_dict(_item) for _item in obj.get("list")] if obj.get("list") is not None else None
        })
        return _obj
