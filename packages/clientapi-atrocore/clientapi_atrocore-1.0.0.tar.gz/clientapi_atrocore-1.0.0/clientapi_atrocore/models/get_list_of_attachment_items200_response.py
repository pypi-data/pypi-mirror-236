...
class GetListOfAttachmentItems200Response(BaseModel):
    """
    GetListOfAttachmentItems200Response
    """
    total: Optional[StrictInt] = None
    list: Optional[conlist(Attachment)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetListOfAttachmentItems200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetListOfAttachmentItems200Response:
        """Create an instance of GetListOfAttachmentItems200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetListOfAttachmentItems200Response.parse_obj(obj)

        _obj = GetListOfAttachmentItems200Response.parse_obj({
            "total": obj.get("total"),
            "list": [Attachment.from_dict(_item) for _item in obj.get("list")] if obj.get("list") is not None else None
        })
        return _obj
