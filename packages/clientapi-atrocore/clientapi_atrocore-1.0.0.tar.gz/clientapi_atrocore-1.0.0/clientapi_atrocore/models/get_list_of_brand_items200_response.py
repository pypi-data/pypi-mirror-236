...
class GetListOfBrandItems200Response(BaseModel):
    """
    GetListOfBrandItems200Response
    """
    total: Optional[StrictInt] = None
    list: Optional[conlist(Brand)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetListOfBrandItems200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetListOfBrandItems200Response:
        """Create an instance of GetListOfBrandItems200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetListOfBrandItems200Response.parse_obj(obj)

        _obj = GetListOfBrandItems200Response.parse_obj({
            "total": obj.get("total"),
            "list": [Brand.from_dict(_item) for _item in obj.get("list")] if obj.get("list") is not None else None
        })
        return _obj
