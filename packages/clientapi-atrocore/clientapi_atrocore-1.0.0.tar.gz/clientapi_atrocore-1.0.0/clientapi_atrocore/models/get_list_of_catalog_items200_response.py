...
class GetListOfCatalogItems200Response(BaseModel):
    """
    GetListOfCatalogItems200Response
    """
    total: Optional[StrictInt] = None
    list: Optional[conlist(Catalog)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetListOfCatalogItems200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetListOfCatalogItems200Response:
        """Create an instance of GetListOfCatalogItems200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetListOfCatalogItems200Response.parse_obj(obj)

        _obj = GetListOfCatalogItems200Response.parse_obj({
            "total": obj.get("total"),
            "list": [Catalog.from_dict(_item) for _item in obj.get("list")] if obj.get("list") is not None else None
        })
        return _obj
