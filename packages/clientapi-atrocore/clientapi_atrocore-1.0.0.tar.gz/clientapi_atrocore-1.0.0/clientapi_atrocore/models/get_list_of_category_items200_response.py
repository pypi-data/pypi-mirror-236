...
class GetListOfCategoryItems200Response(BaseModel):
    """
    GetListOfCategoryItems200Response
    """
    total: Optional[StrictInt] = None
    list: Optional[conlist(Category)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetListOfCategoryItems200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetListOfCategoryItems200Response:
        """Create an instance of GetListOfCategoryItems200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetListOfCategoryItems200Response.parse_obj(obj)

        _obj = GetListOfCategoryItems200Response.parse_obj({
            "total": obj.get("total"),
            "list": [Category.from_dict(_item) for _item in obj.get("list")] if obj.get("list") is not None else None
        })
        return _obj
