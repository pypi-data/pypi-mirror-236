...
class GetListOfConnectionItems200Response(BaseModel):
    """
    GetListOfConnectionItems200Response
    """
    total: Optional[StrictInt] = None
    list: Optional[conlist(Connection)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetListOfConnectionItems200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetListOfConnectionItems200Response:
        """Create an instance of GetListOfConnectionItems200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetListOfConnectionItems200Response.parse_obj(obj)

        _obj = GetListOfConnectionItems200Response.parse_obj({
            "total": obj.get("total"),
            "list": [Connection.from_dict(_item) for _item in obj.get("list")] if obj.get("list") is not None else None
        })
        return _obj
