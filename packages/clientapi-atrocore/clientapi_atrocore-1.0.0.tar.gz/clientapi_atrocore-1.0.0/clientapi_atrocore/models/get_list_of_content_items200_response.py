...
class GetListOfContentItems200Response(BaseModel):
    """
    GetListOfContentItems200Response
    """
    total: Optional[StrictInt] = None
    list: Optional[conlist(Content)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetListOfContentItems200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetListOfContentItems200Response:
        """Create an instance of GetListOfContentItems200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetListOfContentItems200Response.parse_obj(obj)

        _obj = GetListOfContentItems200Response.parse_obj({
            "total": obj.get("total"),
            "list": [Content.from_dict(_item) for _item in obj.get("list")] if obj.get("list") is not None else None
        })
        return _obj
