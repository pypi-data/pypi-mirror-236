...
class GetListOfExportFeedItems200Response(BaseModel):
    """
    GetListOfExportFeedItems200Response
    """
    total: Optional[StrictInt] = None
    list: Optional[conlist(ExportFeed)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetListOfExportFeedItems200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetListOfExportFeedItems200Response:
        """Create an instance of GetListOfExportFeedItems200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetListOfExportFeedItems200Response.parse_obj(obj)

        _obj = GetListOfExportFeedItems200Response.parse_obj({
            "total": obj.get("total"),
            "list": [ExportFeed.from_dict(_item) for _item in obj.get("list")] if obj.get("list") is not None else None
        })
        return _obj
