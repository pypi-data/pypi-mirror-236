...
class GetListOfLibraryItems200Response(BaseModel):
    """
    GetListOfLibraryItems200Response
    """
    total: Optional[StrictInt] = None
    list: Optional[conlist(Library)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetListOfLibraryItems200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetListOfLibraryItems200Response:
        """Create an instance of GetListOfLibraryItems200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetListOfLibraryItems200Response.parse_obj(obj)

        _obj = GetListOfLibraryItems200Response.parse_obj({
            "total": obj.get("total"),
            "list": [Library.from_dict(_item) for _item in obj.get("list")] if obj.get("list") is not None else None
        })
        return _obj
