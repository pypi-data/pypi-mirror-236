...
class GetListOfLocaleItems200Response(BaseModel):
    """
    GetListOfLocaleItems200Response
    """
    total: Optional[StrictInt] = None
    list: Optional[conlist(Locale)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetListOfLocaleItems200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetListOfLocaleItems200Response:
        """Create an instance of GetListOfLocaleItems200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetListOfLocaleItems200Response.parse_obj(obj)

        _obj = GetListOfLocaleItems200Response.parse_obj({
            "total": obj.get("total"),
            "list": [Locale.from_dict(_item) for _item in obj.get("list")] if obj.get("list") is not None else None
        })
        return _obj
