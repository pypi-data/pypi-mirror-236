...
class GetListOfQueueItemItems200Response(BaseModel):
    """
    GetListOfQueueItemItems200Response
    """
    total: Optional[StrictInt] = None
    list: Optional[conlist(QueueItem)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetListOfQueueItemItems200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetListOfQueueItemItems200Response:
        """Create an instance of GetListOfQueueItemItems200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetListOfQueueItemItems200Response.parse_obj(obj)

        _obj = GetListOfQueueItemItems200Response.parse_obj({
            "total": obj.get("total"),
            "list": [QueueItem.from_dict(_item) for _item in obj.get("list")] if obj.get("list") is not None else None
        })
        return _obj
