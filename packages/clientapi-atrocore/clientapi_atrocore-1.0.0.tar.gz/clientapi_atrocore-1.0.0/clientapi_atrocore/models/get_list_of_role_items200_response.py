...
class GetListOfRoleItems200Response(BaseModel):
    """
    GetListOfRoleItems200Response
    """
    total: Optional[StrictInt] = None
    list: Optional[conlist(Role)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetListOfRoleItems200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetListOfRoleItems200Response:
        """Create an instance of GetListOfRoleItems200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetListOfRoleItems200Response.parse_obj(obj)

        _obj = GetListOfRoleItems200Response.parse_obj({
            "total": obj.get("total"),
            "list": [Role.from_dict(_item) for _item in obj.get("list")] if obj.get("list") is not None else None
        })
        return _obj
