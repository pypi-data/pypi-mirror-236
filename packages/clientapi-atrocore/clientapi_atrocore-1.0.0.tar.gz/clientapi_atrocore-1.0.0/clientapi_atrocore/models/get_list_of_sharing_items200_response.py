...
class GetListOfSharingItems200Response(BaseModel):
    """
    GetListOfSharingItems200Response
    """
    total: Optional[StrictInt] = None
    list: Optional[conlist(Sharing)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetListOfSharingItems200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetListOfSharingItems200Response:
        """Create an instance of GetListOfSharingItems200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetListOfSharingItems200Response.parse_obj(obj)

        _obj = GetListOfSharingItems200Response.parse_obj({
            "total": obj.get("total"),
            "list": [Sharing.from_dict(_item) for _item in obj.get("list")] if obj.get("list") is not None else None
        })
        return _obj
