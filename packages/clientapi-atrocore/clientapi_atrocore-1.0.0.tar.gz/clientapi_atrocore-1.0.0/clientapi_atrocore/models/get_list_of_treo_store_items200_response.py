...
class GetListOfTreoStoreItems200Response(BaseModel):
    """
    GetListOfTreoStoreItems200Response
    """
    total: Optional[StrictInt] = None
    list: Optional[conlist(TreoStore)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetListOfTreoStoreItems200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetListOfTreoStoreItems200Response:
        """Create an instance of GetListOfTreoStoreItems200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetListOfTreoStoreItems200Response.parse_obj(obj)

        _obj = GetListOfTreoStoreItems200Response.parse_obj({
            "total": obj.get("total"),
            "list": [TreoStore.from_dict(_item) for _item in obj.get("list")] if obj.get("list") is not None else None
        })
        return _obj
