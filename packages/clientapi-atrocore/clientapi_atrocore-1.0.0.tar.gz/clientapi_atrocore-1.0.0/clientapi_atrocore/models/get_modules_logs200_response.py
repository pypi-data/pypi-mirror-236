...
class GetModulesLogs200Response(BaseModel):
    """
    GetModulesLogs200Response
    """
    total: Optional[StrictInt] = None
    list: Optional[conlist(GetModulesLogs200ResponseListInner)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetModulesLogs200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetModulesLogs200Response:
        """Create an instance of GetModulesLogs200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetModulesLogs200Response.parse_obj(obj)

        _obj = GetModulesLogs200Response.parse_obj({
            "total": obj.get("total"),
            "list": [GetModulesLogs200ResponseListInner.from_dict(_item) for _item in obj.get("list")] if obj.get("list") is not None else None
        })
        return _obj
