...
class ImportConfiguratorItem(BaseModel):
    """
    ...
    default_name: Optional[StrictStr] = Field(None, alias="defaultName")
    ...
    default_names: Optional[Dict[str, Any]] = Field(None, alias="defaultNames")
    ...
    __properties = ["id", "deleted", "name", "entityIdentifier", "column", "importBy", "createIfNotExist", "replaceArray", "type", "foreignColumn", "foreignImportBy", "attributeId", "attributeName", "scope", "channelId", "channelName", "locale", "defaultContainer", "default", "defaultFrom", "defaultTo", "defaultCurrency", "defaultId", "defaultName", "defaultPathsData", "defaultIds", "defaultNames", "entity", "sourceFields", "createdAt", "importFeedId", "importFeedName", "sortOrder", "attributeValue"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ImportConfiguratorItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ImportConfiguratorItem:
        """Create an instance of ImportConfiguratorItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ImportConfiguratorItem.parse_obj(obj)

        _obj = ImportConfiguratorItem.parse_obj({
            "id": obj.get("id"),
