...
class Measure(BaseModel):
    ...
    __properties = ["id", "deleted", "name", "nameDeDe", "code", "description", "createdAt", "modifiedAt", "createdById", "createdByName", "modifiedById", "modifiedByName"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Measure:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Measure:
        """Create an instance of Measure from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Measure.parse_obj(obj)

        _obj = Measure.parse_obj({
            "id": obj.get("id"),
