...
class NextNumber(BaseModel):
    ...
    __properties = ["id", "deleted", "entityType", "fieldName", "value"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NextNumber:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NextNumber:
        """Create an instance of NextNumber from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NextNumber.parse_obj(obj)

        _obj = NextNumber.parse_obj({
            "id": obj.get("id"),
