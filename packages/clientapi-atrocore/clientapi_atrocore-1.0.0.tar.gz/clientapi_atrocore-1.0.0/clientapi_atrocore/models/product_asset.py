...
class ProductAsset(BaseModel):
    ...
    __properties = ["id", "deleted", "productId", "productName", "assetId", "assetName", "isMainImage", "sorting", "scope", "channelId", "channelName", "tags", "createdAt", "modifiedAt", "createdById", "createdByName", "modifiedById", "modifiedByName", "preview"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductAsset:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductAsset:
        """Create an instance of ProductAsset from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProductAsset.parse_obj(obj)

        _obj = ProductAsset.parse_obj({
            "id": obj.get("id"),
