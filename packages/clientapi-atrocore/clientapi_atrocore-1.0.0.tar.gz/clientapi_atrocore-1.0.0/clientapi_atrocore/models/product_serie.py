...
class ProductSerie(BaseModel):
    ...
    __properties = ["id", "deleted", "name", "description", "createdAt", "modifiedAt", "createdById", "createdByName", "modifiedById", "modifiedByName", "assignedUserId", "assignedUserName", "teamsIds", "teamsNames", "ownerUserId", "ownerUserName"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductSerie:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductSerie:
        """Create an instance of ProductSerie from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProductSerie.parse_obj(obj)

        _obj = ProductSerie.parse_obj({
            "id": obj.get("id"),
