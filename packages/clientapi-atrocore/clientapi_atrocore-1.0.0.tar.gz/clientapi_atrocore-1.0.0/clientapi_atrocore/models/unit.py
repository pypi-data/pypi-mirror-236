...
class Unit(BaseModel):
    ...
    convert_to_name: Optional[StrictStr] = Field(None, alias="convertToName")
    ...
    __properties = ["id", "deleted", "name", "nameDeDe", "code", "description", "descriptionDeDe", "measureId", "measureName", "isDefault", "multiplier", "convertToId", "convertToName", "createdAt", "modifiedAt", "createdById", "createdByName", "modifiedById", "modifiedByName"]
    ...
    def from_dict(cls, obj: dict) -> Unit:
        ...
        _obj = Unit.parse_obj({
            ...
            "convert_to_name": obj.get("convertToName"),
