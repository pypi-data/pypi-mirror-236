...
class CRUDRouter(APIRouter, Generic[T]):
    ...
    async def _get_one(self, pk: str, sk: str):
        """
        ...
        The retrieved item.
        """
        return await self.schema.get(pk, sk)

    async def _get_many(
        self, pk: str, sk: Optional[str] = None, op: Optional[Operator] = None
    ):
        """
        ...
        The retrieved items.
        """
        return await self.schema.query(pk, sk, op)
    ...
    async def _create(self, data: T):
        ...
        The created item.
        """
        return await self.schema.put(data)

    async def _delete(self, pk: str, sk: str):
        """
        ...
        The deleted item.
        """
        return await self.schema.delete(pk, sk)
