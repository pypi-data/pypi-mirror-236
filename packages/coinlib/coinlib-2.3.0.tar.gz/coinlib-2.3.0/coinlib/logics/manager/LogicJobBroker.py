...
class LogicJobBroker:
    ...
    def closePosition(self, clientOrderId, price: float = None, amount=None, symbol= None,  group=None):
        self.manager.saveInfo("trader", "closePosition", {"clientOrderId": clientOrderId,
                                                          "amount": amount, "symbol": symbol.symbol if symbol is not None else "",
    ...
    def buy(self, symbol: BrokerSymbol=None, amount=None, amountQuote=None,
    ...
    def sell(self, symbol: BrokerSymbol=None, amount=None, amountQuote=None,
             price=None, leverage=None, group=None):
        if symbol is None:
            symbol = self.manager.getSymbolForChart()
        symbol = self.fillSymbolInfo(symbol)
    ...
    def longAll(self, symbol: BrokerSymbol=None,
        ...
        self.manager.saveInfo("trader", "longAll",
    ...
    def shortAll(self, symbol: BrokerSymbol=None,
        ...
        if symbol is None or isinstance(symbol, str) or symbol.symbol is None:
            raise WrongArgumentError("Please use a symbol object to use any brokerage  method")
        self.manager.saveInfo("trader", "shortAll", {"symbol": symbol.symbol,
                                                  "price": price, "group": group})
        return True
