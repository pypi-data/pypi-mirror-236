...
class Metrics:
    ...
    def get_info_quantstats(self) -> pd.DataFrame:
        ...
        alphaGeo = annualizedReturns[0] - annualizedReturns[1]
        ...
        data_to_frame = {
            ...
            "Retorno Acumulado": cumulative[0],
            "Retorno Anualizado": annualizedReturns[0],
            "Retorno Anualizado (bench)": annualizedReturns[1],
            "Volatilidade Anual": annualizedVol[0],
            "Alpha Geom.": alphaGeo,
            "Alpha Arit.": alphaAri,
            "% Ret. Positivos (daily)": positiveReturns[0] * 100,
