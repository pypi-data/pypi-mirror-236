from src.critical_node.MODEL.Basic_Model import K_shell
from src.critical_node.COMMON.Graph import MaxConnectSub
from src.critical_node.MODEL.Basic_Model import Degree
