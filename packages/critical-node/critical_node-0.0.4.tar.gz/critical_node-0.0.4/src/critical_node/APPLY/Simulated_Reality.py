...
def Train_Sir(Read_Path,Save_Path,iter_time = 200 , range_begin = 0.01 , range_end = 0.5 , span = 0.01):
    ...
    from src.critical_node.COMMON.Get_Network_Attributes import NodeNumber
    from src.critical_node.COMMON.Save import SaveToTXT
    from src.critical_node.COMMON.Read import ReadFile_TXT
