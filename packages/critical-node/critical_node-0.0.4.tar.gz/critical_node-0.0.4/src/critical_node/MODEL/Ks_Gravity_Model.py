...
def KSGC(G):
    ...
    from src.critical_node.COMMON.Get_Node_Attributes import GetNeighbor
    from src.critical_node.COMMON.Get_Network_Attributes import AverageShortestPath
    from src.critical_node.COMMON.Get_Network_Attributes import GetMaxMinKs
    from src.critical_node.MODEL.Basic_Model import K_shell,Degree
