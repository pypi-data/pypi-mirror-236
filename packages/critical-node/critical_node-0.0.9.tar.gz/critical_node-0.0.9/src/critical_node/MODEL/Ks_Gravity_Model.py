...
def KSGC(G):
    ...
    from COMMON.Get_Node_Attributes import GetNeighbor
    from COMMON.Get_Network_Attributes import AverageShortestPath
    from COMMON.Get_Network_Attributes import GetMaxMinKs
    from MODEL.Basic_Model import K_shell,Degree
