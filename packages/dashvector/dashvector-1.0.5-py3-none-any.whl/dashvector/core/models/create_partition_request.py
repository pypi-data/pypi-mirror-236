    ...
    def __init__(self, *,
        ...
        if not isinstance(partition_name, str):
            raise DashVectorException(
                ...
                reason=f"DashVectorSDK CreatePartitionRequest name type({partition_name}) is invalid and must be str")
        ...
        if re.search(
            ...
            raise DashVectorException(
                ...
                reason=f"DashVectorSDK CreatePartitionRequest name characters({partition_name}) is invalid and " +
        ...
        """
        create_request = dashvector_pb2.CreatePartitionRequest(
