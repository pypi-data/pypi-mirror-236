    ...
    def __init__(self,
        ...
        if not isinstance(partition_name, str):
            raise DashVectorException(
                ...
                reason=f"DashVectorSDK DescribePartitionRequest name type({partition_name}) is invalid and must be str")
        ...
        if re.search(
            ...
            raise DashVectorException(
                ...
                reason=f"DashVectorSDK DescribePartitionRequest name characters({partition_name}) is invalid and " +
        ...
        """
        describe_request = dashvector_pb2.DescribePartitionRequest(
            name=self._partition_name)
