    ...
    def __init__(self, *,
        ...
        if not isinstance(partition_name, str):
            raise DashVectorException(
                ...
                reason=f"DashVectorSDK DropPartitionRequest name type({partition_name}) is invalid and must be str")
        ...
        if re.search(
            ...
            raise DashVectorException(
                ...
                reason=f"DashVectorSDK DropPartitionRequest name characters({partition_name}) is invalid and " +
        ...
        """
        drop_request = dashvector_pb2.DeletePartitionRequest(
