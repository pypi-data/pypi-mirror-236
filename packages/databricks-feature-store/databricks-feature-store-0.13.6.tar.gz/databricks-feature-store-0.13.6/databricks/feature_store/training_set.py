...
class _FseTrainingSet(TrainingSet):
    def _validate_and_inject_dtypes(self):
        """
        Bypass the validation for Feature Serving Endpoint usage because FSE doesn't need to provide
        dataframe while creating training set. Note that this is a temporary workaround and should
        not be relied on in long term.
        TODO[ML-32323]: create valid DF in FSE client and remove this class.
        """
        pass
