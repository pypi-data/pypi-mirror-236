...
class Subsampler:
    ...
    def __init__(self, df_data, column_target, columns_keep_ratio, allowed_deviation, test_size=.2):

        df_ratio = df_data[columns_keep_ratio]
        ...
        self.test_size = test_size  # percentage of datapoints in test dataset which will be excluded from subsampling
    ...
    def extract_test(self, random_state=101):
        if self.test_size == 0:
            return
