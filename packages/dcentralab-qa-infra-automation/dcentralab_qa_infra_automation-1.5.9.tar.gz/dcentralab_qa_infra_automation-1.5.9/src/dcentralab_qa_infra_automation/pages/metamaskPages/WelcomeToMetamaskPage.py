...
"""page locators"""
TITLE = (By.CLASS_NAME, "onboarding-welcome")
...
class WelcomeToMetamaskPage(BasePage):
    ...
    def is_page_loaded(self):
        ...
        return self.is_element_exist("TITLE", TITLE) and "get started" in self.get_text("TITLE",
                                                                                        TITLE) and self.is_element_exist(
            "MASCOT_LOGO", MASCOT_LOGO)
