...
class _PreprocessorAggregator:
    ...
    def _image_property_iter(self):
        ...
        try:
            ...
            raise DegirumException("Cannot access preprocessor image-related properties: the model has no image type inputs")
        yield from iterator
    ...
    def has_image_inputs(self) -> bool:
        ...
        return next(filter(lambda pp: isinstance(pp, _Image_Preprocessor), self._preprocessors), None) != None
