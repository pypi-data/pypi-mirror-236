...
if __name__ == '__main__':
  main()
" -s ${i}  -a ${accessory_dir}/${dt}_ao.fasta  -t ${accessory_dir}/${dt}.nwk  -A 200 -d ${upptmpdir}/tmp_result -x $upp_c -p ${upptmpdir}/tmp 1>${tmpdir}/upp-out.log 2>>${out_dir}/${dt}_upp.log
