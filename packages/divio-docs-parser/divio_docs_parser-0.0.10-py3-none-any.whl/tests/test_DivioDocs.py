...
For a different test""")
    ...
    def test_embed_relative_files(self):
        ...
        other_docs = DivioDocs().import_docs("/home/cat/Documents/Programming/app-mu-info-rework/cache/du-project/", embed_relative_files=True)
        with open("test.md", "w") as file:
            file.write(other_docs.explanation["docs/discussions/design-philosophy.md"])
