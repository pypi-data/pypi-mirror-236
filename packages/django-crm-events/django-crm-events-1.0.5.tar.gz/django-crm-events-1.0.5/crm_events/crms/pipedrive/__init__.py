...
class PipeDrive(BaseService):
    ...
    def organization_data_add_app(self, organization, data, field_data):
        if not field_data:
            return data
    ...
    def update_organization_fields(self, organization, shop_data, action="install"):
        data = {}
        ...
        if action == "install":
            ...
            data = self.organization_data_add_app(
