...
def send_slack(token, channel, msg, files=None):
    """
        ...
        (slack_channel_name_to_id is temporaty)
    """
    slack_channel_name_to_id = {'priceware-devops':'C05ATJLRBSQ'}
    ...
    try:
        ...
        if files is None:
            ...
            res = client.files_upload_v2(channels=channel, file_uploads=files, initial_comment=msg)
        if res['ok']:
            return None
        else:
