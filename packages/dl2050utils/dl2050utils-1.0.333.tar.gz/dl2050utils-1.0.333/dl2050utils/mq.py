...
class MQServer():
    ...
    def connect(self):
        ...
        return pika.BlockingConnection(pika.connection.URLParameters(url))
    ...
    def job_error(self, jid): return sync_job_update(self.LOG, self.db, jid, status=JOB_ERROR, eta=0)
