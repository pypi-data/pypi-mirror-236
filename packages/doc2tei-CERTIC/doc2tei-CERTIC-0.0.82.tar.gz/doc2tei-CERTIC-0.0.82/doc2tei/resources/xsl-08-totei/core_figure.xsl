...
<xsl:template match="table:table-cell">
    <cell>
        ...
        <xsl:choose>
            <xsl:when test="child::text:p[@text:style-name='Standard' and (@rendition or @xml:lang)]">
                <p>
                    <xsl:copy-of select="child::text:p/@* except(child::text:p/@text:style-name)"/>
                    <xsl:apply-templates select="child::text:p[@text:style-name='Standard']/node()"/>
                </p>
            </xsl:when>
<!--
            <xsl:when test="child::text:p[@text:style-name='Standard' and not(@rendition='#rtl')]">
                <xsl:apply-templates select="child::text:p[@text:style-name='Standard']/node()"/>
            </xsl:when>
