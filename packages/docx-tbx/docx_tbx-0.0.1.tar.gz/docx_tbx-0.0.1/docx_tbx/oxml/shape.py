...
class CT_Inline(BaseOxmlElement):
    ...
    def new(cls, cx, cy, shape_id, pic, pos_x, pos_y):
        ...
        as parameters.
        """
        inline = parse_xml(cls._inline_xml(pos_x, pos_y))
        inline.extent.cx = cx
        inline.extent.cy = cy
    ...
    @classmethod
    def new_pic_inline(cls, shape_id, rId, filename, cx, cy, pos_x, pos_y):
        """
        ...
        inline = cls.new(cx, cy, shape_id, pic, pos_x, pos_y)
        inline.graphic.graphicData._insert_pic(pic)
        return inline

    @classmethod
    def _inline_xml(cls, pos_x, pos_y):
        return (
            '<wp:inline %s>\n'
            ...
            '  </a:graphic>\n'
            '</wp:inline>' % (nsdecls('wp', 'a', 'pic', 'r'), int(pos_x), int(pos_y))
        )
