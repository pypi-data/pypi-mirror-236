...
class Run(Parented):
    ...
    def add_picture(self, image_path_or_stream, width=None, height=None, pos_x=0, pos_y=0):
        """
        ...
        *image_path_or_stream* can be a path (a string) or a file-like object
        ...
        """
        inline = self.part.new_pic_inline(image_path_or_stream, width, height, pos_x, pos_y)
