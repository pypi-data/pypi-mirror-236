...
from dotagent.vectorstores import VectorStore
...
class Qdrant(VectorStore):
    ...
    Example:
        .. code-block:: python
            ...
            from dotagent.vectorstores import Qdrant
    ...
    def similarity_search(
        ...
        **kwargs: Any,
        ...
        results = self.client.search(
            ...
            offset=offset,
            with_payload=True,
            with_vectors=False,  # dotagent does not expect vectors to be returned
        ...
        **kwargs: Any,
        ...
        Example:
            .. code-block:: python
                ...
                from dotagent.vectorstores import Qdrant
                from dotagent.embeddings import OpenAIEmbeddings
