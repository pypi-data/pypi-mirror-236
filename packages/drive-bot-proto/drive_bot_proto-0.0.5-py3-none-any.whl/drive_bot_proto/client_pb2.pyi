...
class GetTicketsRequest(google.protobuf.message.Message):
    ...
    @property
    def topic_id(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.int]: ...
    def __init__(
        self,
        *,
        limit: builtins.int | None = ...,
        ...
        topic_id: collections.abc.Iterable[builtins.int] | None = ...,
    ) -> None: ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal["_external_id", b"_external_id", "_lang", b"_lang", "_limit", b"_limit", "_offset", b"_offset", "categories_ids", b"categories_ids", "external_id", b"external_id", "lang", b"lang", "limit", b"limit", "offset", b"offset", "topic_id", b"topic_id"]) -> None: ...
    @typing.overload
