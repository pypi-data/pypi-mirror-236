...
class GetEntityByIdRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_lang", b"_lang", "lang", b"lang"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_lang", b"_lang", "id", b"id", "lang", b"lang"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_lang", b"_lang"]) -> typing_extensions.Literal["lang"] | None: ...
