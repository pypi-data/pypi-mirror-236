...
class Settings(BaseSettings):
    ...
    SONA_MIDDLEWARE_TRACER_SERVICE_NAME: Optional[str] = None
    SONA_MIDDLEWARE_TRACER_JAEGER_HOST: Optional[str] = None
    SONA_MIDDLEWARE_TRACER_JAEGER_PORT: Optional[str] = None
