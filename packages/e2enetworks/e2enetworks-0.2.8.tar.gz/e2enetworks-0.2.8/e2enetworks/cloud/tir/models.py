...
class Models:
    ...
    def push_model(self, model_path, model_id=None, model_type="custom"):
        if model_id:
        ...
        minio_service.upload_directory_recursive(bucket_name=model.data.bucket.bucket_name, source_directory=model_path)
    ...
    def help():
        ...
        print("\t\t2. create(name, storage_type, bucket_name, model_type): Creates a new model with the provided "
              "details.")
        print("\t\t2. push_model(model_path, model_id, model_type): Creates a new model with the provided "
              "details.")
        ...
        print(f"\t\tmodels.push_model(model_path, model_id=None, model_type='custom')")
