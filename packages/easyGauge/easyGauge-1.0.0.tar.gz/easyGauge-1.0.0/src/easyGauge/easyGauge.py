...
Reusable Ploty indicator and streamGauge data visualization component for Streamlit
...
def streamGauge(gVal, gTitle="", gMode='streamGauge+number', gSize="MED",
    ...
    streamGaugePlot = st.plotly_chart(
        fig1, 
