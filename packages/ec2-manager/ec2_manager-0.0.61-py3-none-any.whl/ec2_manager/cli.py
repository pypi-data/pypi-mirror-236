...
update_all_secrets = click.option(
    '--update-all-secrets',
    default=os.environ.get('UPDATE_ALL_SECRETS', False),
    help='If set to true, then you will be prompted to update all secrets, including your github token and aws keys',
    required=False
)
...
def set_secrets(**kwargs):
    ...
    _update_all_secrets = kwargs.get('update_all_secrets')
