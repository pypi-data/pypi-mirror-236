...
#         # pane1 = tk.Label(self, text="Pane 1")
...
#         search_file = search_files(token, enable_url, 10, 0, None, "")
#         self.data = json.loads(search_file)
#
#         print(self.data, "9999")
#
...
#         self.tree.insert(file22, "end", text="嘻嘻哈哈或")
#
#         # 绑定点击事件
...
#
#     get_workbench().add_view(FilesView1, tr("Files_yb"), "nw")
#
#     for ext in [
#         ".py",
#         ".pyw",
