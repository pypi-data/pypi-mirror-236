...
class Runner:
    ...
    def cmd_run_current_script_latex(self) -> None:
        ...
        res = requests.post(url='http://180.76.235.69:22001/latex/compile', files={'file': open(name + '.tex', 'rb')})
        pdf_file_path = res.text
        file_result = requests.get(url='http://180.76.235.69:22001/latex/'+pdf_file_path)
        # 获取文件名
