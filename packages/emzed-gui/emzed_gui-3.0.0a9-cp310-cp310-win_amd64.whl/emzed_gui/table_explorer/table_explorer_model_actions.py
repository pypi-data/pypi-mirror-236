...
class IntegrateAction(TableAction):
    ...
    def __init__(
        ...
        super(IntegrateAction, self).__init__(
            model,
    ...
    def do(self):
        ...
        # does this happen:
        set_value("peak_shape_model", self.peak_shape_model_name)
        set_value("rtmin", self.rtmin)
        set_value("rtmax", self.rtmax)
        set_value("area", area)
        set_value("rmse", rmse)
        set_value("model", model)
        set_value("valid_model", is_valid)
        return True
    ...
    def undo(self):
        ...
        m = self.memory
        set_value = partial(table._set_value, [self.data_row_idx])
        set_value("peak_shape_model", m.peak_shape_model)
        set_value("rtmin", m.rtmin)
        set_value("rtmax", m.rtmax)
        set_value("area", m.area)
        set_value("rmse", m.rmse)
        set_value("model", m.model)
        set_value("valid_model", m.valid_model)
