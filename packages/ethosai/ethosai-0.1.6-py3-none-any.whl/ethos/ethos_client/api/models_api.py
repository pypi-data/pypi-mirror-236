...
class ModelsApi(object):
    ...
    @validate_arguments
    def get_models(self, project_id : Any, name : Optional[Any] = None, expand : Optional[Any] = None, **kwargs) -> ListModel:  # noqa: E501
        """Get Models  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_models(project_id, name, expand, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_models_with_http_info(project_id, name, expand, **kwargs)  # noqa: E501

    @validate_arguments
    def get_models_with_http_info(self, project_id : Any, name : Optional[Any] = None, expand : Optional[Any] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Get Models  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_models_with_http_info(project_id, name, expand, async_req=True)
        >>> result = thread.get()
