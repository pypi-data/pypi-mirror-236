...
class ListDatasource(BaseModel):
    """
    ListDatasource
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListDatasource:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListDatasource:
        """Create an instance of ListDatasource from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListDatasource.parse_obj(obj)

        _obj = ListDatasource.parse_obj({
