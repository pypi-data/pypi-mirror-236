...
class ListTeam(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTeam:
        """Create an instance of ListTeam from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTeam:
        """Create an instance of ListTeam from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTeam.parse_obj(obj)

        _obj = ListTeam.parse_obj({
