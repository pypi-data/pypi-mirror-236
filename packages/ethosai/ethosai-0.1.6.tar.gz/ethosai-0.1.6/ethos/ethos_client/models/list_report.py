...
class ListReport(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListReport:
        """Create an instance of ListReport from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListReport:
        """Create an instance of ListReport from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListReport.parse_obj(obj)

        _obj = ListReport.parse_obj({
