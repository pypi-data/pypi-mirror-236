...
class ListResource(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListResource:
        """Create an instance of ListResource from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListResource:
        """Create an instance of ListResource from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListResource.parse_obj(obj)

        _obj = ListResource.parse_obj({
