...
lang = Lang(
    en=Text(
        ...
        already_exists_text="The {zip_type.name} is already extracted.",
    ...
    de=Text(
        ...
        zip_file_error="{zip_type.name} hat keine gültiges zip Datei.",
        already_exists_text="{zip_type.name} ist bereits entpackt.",
