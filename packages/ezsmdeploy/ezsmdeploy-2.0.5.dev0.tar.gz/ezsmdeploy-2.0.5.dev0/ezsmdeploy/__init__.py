...
class Deploy(object):
    def __init__(
        ...
        if if not isinstance(self.dockerextras,list):
            raise ValueError("Docker extras is a list of lines that will be inserted into the dockerfile and has to be a list of strings")
    ...
    def build_docker(self):
        ...
        if self.dockerextras==[]:
            ...
            open("src/Dockerfile", "w") as new_file:
