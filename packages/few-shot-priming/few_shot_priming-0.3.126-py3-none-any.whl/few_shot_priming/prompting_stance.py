...
from few_shot_priming.topic_similarity_sentence_transformer import *
from few_shot_priming.diversify import *
...
def run_experiment_prompting(config=None, experiment="ibmsc", model=None, offline=False, validate=True, splits=None, logger=None, openai=False, sampling_strategy=None, similarity=None):
    ...
    for i, record in test_dataset.iterrows():
        ...
        if openai:
            ...
            log_message(logger, "***OUTPUT***"+resulting_string, level=logging.INFO)
            resulted_string_truncated = resulting_string[-15:].lower()
