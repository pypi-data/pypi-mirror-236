...
class ImageInference(FireworksClient):
    ...
    def __init__(self, request_timeout=600, **kwargs) -> None:
        ...
        self.endpoint_base_uri = f"{self.base_url}/image_generation/accounts/fireworks/models/stable_diffusion"

    def _img_to_bytes(self, image: Union[Image.Image, str, os.PathLike, bytes]) -> bytes:
