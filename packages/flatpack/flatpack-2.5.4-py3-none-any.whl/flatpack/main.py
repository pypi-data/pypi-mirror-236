...
if __name__ == "__main__":
    ...
    # Create and run the logging task
    logging_coroutine = logging_task(session, API_KEY)
    ...
    try:
        ...
        # Ensure the logging task is also cancelled when the main coroutine exits
        logging_coroutine.cancel()
        loop.run_until_complete(logging_coroutine)
