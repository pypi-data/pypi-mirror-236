...
def add_objects(
    ...
    Args:
        ...
        overwrite: (deprecated) If overwrite is True, will overwrite existing nodes, otherwise will
                   raise an exception if they exist. This will be ignored because data versioning covers this.
...
def _batch_add(
    ...
    **extra_params: dict,
    ...
    while j <= len(values) and (i != j):
        ...
        raise_on_error(entanglement_client.post(endpoint, **params))
