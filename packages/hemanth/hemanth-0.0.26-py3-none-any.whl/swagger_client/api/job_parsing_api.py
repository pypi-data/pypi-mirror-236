...
class JobParsingApi(object):
    ...
    def parse_job(self, body, authorization, **kwargs):  # noqa: E501
        """Job Parsing  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.parse_job(body, authorization, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.parse_job_with_http_info(body, authorization, **kwargs)  # noqa: E501
        else:
            (data) = self.parse_job_with_http_info(body, authorization, **kwargs)  # noqa: E501
            return data

    def parse_job_with_http_info(self, body, authorization, **kwargs):  # noqa: E501
        """Job Parsing  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.parse_job_with_http_info(body, authorization, async_req=True)
        >>> result = thread.get()
        ...
        if ('authorization' not in params or
            ...
            raise ValueError("Missing the required parameter `authorization` when calling `parse_job`")  # noqa: E501
