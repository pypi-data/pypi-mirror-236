...
class JobResponse(object):
    ...
    @property
    def response(self):
        """Gets the response of this JobResponse.  # noqa: E501


        :return: The response of this JobResponse.  # noqa: E501
        :rtype: JobResponseResponse
        """
        return self._response

    @response.setter
    def response(self, response):
        """Sets the response of this JobResponse.


        :param response: The response of this JobResponse.  # noqa: E501
        :type: JobResponseResponse
        """
