...
from hestia_earth.models.geospatialDatabase.utils import (
    ...
    has_geospatial_data, get_area_size, geospatial_data, _run_query, _collection_name
)
...
def _should_cache_results(site: dict):
    ...
    should_cache = all([not has_cache, area_size <= MAX_AREA_SIZE, contains_geospatial_data])
