"use strict";
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[3267], {
    43267: function(e, n, r) {
        r.r(n),
        r.d(n, {
            default: function() {
                return C
        ...
        function y(e) {
            ...
            a.jsx)(c.ZB, {
                $as: "button",
                className: (0,
                x.default)("rounded", t.route !== n && "hover:bg-token-surface-secondary dark:hover:bg-gray-800"),
                onClick: function() {
                    t.push(n)
                },
                children: r
        ...
        function w(e) {
            var n = e.workspaceName
              , r = e.hasAdminPrivileges
              , i = e.hasOwnerPrivileges
              , o = (0,
            v.useRouter)()
              , l = (0,
            ...
            a.jsxs)("nav", {
                ...
                a.jsxs)("div", {
                    ...
                    a.jsxs)("div", {
                        ...
                        a.jsx)("h2", {
                            className: "text-lg text-token-text-primary dark:text-white",
                            children: n
                        })]
                    }), (0,
                    a.jsxs)(y, {
        ...
        function C(e) {
            var n = e.mobilePageTitle
              , r = e.requireAdminPrivileges
              , i = void 0 !== r && r
              , s = e.children
              , c = (0,
            m.ec)(function(e) {
            ...
            a.jsx)(d.Z, {
                ...
                a.jsx)(w, {
                    workspaceName: f ? "" : g,
                    hasAdminPrivileges: x,
                    hasOwnerPrivileges: b
                }),
                children: (0,
                a.jsxs)(M, {
                    children: [f && (0,
                    ...
                    a.jsx)("div", {
                        ...
                        children: (0,
                        a.jsx)(k.Z, (0,
                        t._)({}, Z.workspaceNotFound))
                    }), !f && c && s]
                })
            })
        }
        var M = r(21389).Z.div(N())
          , Z = (0,
        j.vU)({
            workspaceNotFound: {
            ...
            analytics: {
                id: "adminPage.analytics",
                defaultMessage: "Analytics",
                description: "Analytics sidebar item"
            },
            billing: {
                id: "adminPage.billing",
                defaultMessage: "Billing Info",
                description: "Billing sidebar item"
            },
            settings: {
                id: "adminPage.Settings",
                defaultMessage: "Settings",
                description: "Settings sidebar item"
            },
            identity: {
                id: "adminPage.identity",
                defaultMessage: "Identity & Provisioning",
                description: "Identity sidebar item"
            }
        })
    },
    ...
    82277: function(e, n, r) {
        ...
        function c(e) {
            var n = e.children
              , r = e.showNavigation
              , u = e.renderTitle
              , d = e.renderMobileHeaderRightContent
              , f = e.renderSidebar
              , m = (0,
            s.w$)()
              , g = []
              , h = null;
            return i.Children.forEach(n, function(e) {
                i.isValidElement(e) && (e.type === c.Sidebars ? h = e : g.push(e))
            }),
            (0,
            t.jsxs)("div", {
                className: "relative z-0 flex h-full w-full overflow-hidden",
                children: [m && r && null != f ? (0,
                t.jsx)(o.Z, {
                    children: f
                }) : null, (0,
                t.jsxs)("div", {
                    ...
                    t.jsx)(o.Z, {
                        ...
                        t.jsx)(l.Vs, {
                            onClickOpenSidebar: function() {
                                return a.vm.toggleActiveSidebar("mobile-nav")
                            },
                            renderTitle: u,
                            renderSidebar: f,
    ...
    13090: function(e, n, r) {
        ...
        function w(e) {
            ...
            t._)({
                onClick: n,
                className: (0,
                c.default)(r, "flex-grow overflow-hidden")
            }, s))
        }
        function C(e) {
            var n = e.onClick
        ...
        var Z = function(e) {
          ...
          , P = function(e) {
            ...
            m.useEffect)(function() {
                "mobile-nav" === o && p.vm.setActiveSidebar(!1)
            }, [l]),
            (0,
            a.jsxs)(a.Fragment, {
                children: [(0,
        ...
        function S(e) {
            ...
            a.jsxs)(a.Fragment, {
                ...
                a.jsx)(u.E.div, {
                    className: (0,
                    c.default)("h-full flex-shrink-0 overflow-x-hidden", s ? "border-r border-gray-100 bg-gray-50 gizmo:bg-white dark:border-0 dark:bg-gray-800 gizmo:dark:border-r gizmo:dark:border-token-border-light" : "dark bg-gray-900"),
                    ref: t,
                    initial: !1,
                    animate: {
                        width: i ? 0 : "260px",
                ...
                a.jsx)(d.M, {
                    ...
                    a.jsx)(u.E.div, {
                        className: (0,
                        c.default)("absolute z-40 hidden md:inline-block", s && o !== N.Mo.SidebarList ? "bottom-1 left-1" : "left-2 top-2"),
                        initial: {
                            opacity: 0
                        },
                        animate: {
    ...
    52696: function(e, n, r) {
        ...
        function c() {
            var e = (0,
            l.Z)()
              , n = e.formatMessage(b.adminRoleName)
              , r = e.formatMessage(b.ownerRoleName)
              , a = e.formatMessage(b.standardRoleName);
            return (0,
            o.useMemo)(function() {
                var e;
                return e = {},
        ...
        function u(e) {
            var n = (0,
            l.Z)();
            return e ? e.structure === i.CZ.PERSONAL ? n.formatMessage(b.personalPlanName) : n.formatMessage(b.enterprisePlanName) : n.formatMessage(b.personalPlanName)
        }
        function d(e) {
            return m((0,
            l.Z)(), e)
        ...
        function m(e, n) {
            var r;
            return n && n.structure !== i.CZ.PERSONAL ? null !== (r = n.name) && void 0 !== r ? r : e.formatMessage(b.defaultWorkspaceTitle) : e.formatMessage(b.personalWorkspaceTitle)
        }
        function g() {
            var e, n, r, t, i = (0,
            s.kP)().session;
            return null !== (t = null !== (r = null == i ? void 0 : null === (e = i.user) || void 0 === e ? void 0 : e.name) && void 0 !== r ? r : null == i ? void 0 : null === (n = i.user) || void 0 === n ? void 0 : n.email) && void 0 !== t ? t : null
        }
        function h(e) {
            var n = (0,
            a.ec)(function(e) {
              ...
              , r = (0,
            a.ec)(a.F_.isPersonalWorkspace)
              , t = (0,
            a.$T)()
              , s = d(n)
              , o = g();
            return e && !t ? e.structure === i.CZ.PERSONAL ? o : e.name : n ? r ? o : s : o
        }
        function x() {
            return (0,
            a.ec)(function(e) {
        ...
        function v(e) {
            ...
            return (null == n ? void 0 : n.role) === i.r3.OWNER
        }
        function p(e) {
            var n = x().find(function(n) {
                return n.id === e
            });
            return (null == n ? void 0 : n.role) === i.r3.ADMIN
        }
        var b = (0,
        r(94968).vU)({
    ...
    15329: function(e, n, r) {
        ...
        function c() {
            var e = (0,
            t._)(["flex px-3 min-h-[44px] py-1 items-center gap-3 transition-colors duration-200 dark:text-white cursor-pointer text-sm"]);
            return c = function() {
                return e
            }
            ,
        ...
        function d() {
            var e = (0,
            t._)(["my-1.5 h-px dark:bg-white/20 bg-black/20"]);
            return d = function() {
                return e
            }
            ,
            ...
            i.jsx)(a.v.Item, {
                children: function(e) {
                    ...
                    i.jsx)(g, {
                        ...
                        target: t,
                        className: (0,
                        s.default)(a ? "bg-gray-100 dark:bg-gray-800" : "hover:bg-gray-100 dark:hover:bg-gray-800"),
                        children: o
                    })
                }
            })
