...
from shoot_pandora.exts.hooks import hook_logging
from shoot_pandora.exts.token import check_access_token
from shoot_pandora.openai.auth import Auth0
...
class ChatBot:
    ...
    def __after_request(resp):
        resp.headers['X-Server'] = 'shoot_pandora-cloud/{}'.format(__version__)
        return resp
