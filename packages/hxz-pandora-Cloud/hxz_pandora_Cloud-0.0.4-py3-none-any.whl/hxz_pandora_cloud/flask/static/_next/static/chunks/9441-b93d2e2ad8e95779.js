"use strict";
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[9441], {
    ...
    80474: function(e, t, r) {
        ...
        u.b)("Toast", [h])
          , [C,R] = b(T)
          , P = e=>{
            let {__scopeToast: t, label: r="Notification", duration: n=5e3, swipeDirection: a="right", swipeThreshold: i=50, children: l} = e
              , [s,u] = (0,
            o.useState)(null)
              , [c,d] = (0,
            o.useState)(0)
        ...
        let M = ["F8"]
          ...
          , L = (0,
        o.forwardRef)((e,t)=>{
            let {__scopeToast: r, hotkey: a=M, label: i="Notifications ({hotkey})", ...s} = e
              , u = R("ToastViewport", r)
              , d = g(r)
              , p = (0,
            o.useRef)(null)
                    ...
                    let t = t=>{
                        ...
                        if (n) {
                            ...
                            let s = b({
                              ...
                              , u = s.findIndex(e=>e === r);
                            j(s.slice(u + 1)) ? t.preventDefault() : n ? null === (a = v.current) || void 0 === a || a.focus() : null === (i = w.current) || void 0 === i || i.focus()
                        }
                    }
                    ;
            ...
            n.Z)({
                ...
                onFocus: e=>{
                    ...
                    let r = e.relatedTarget
                      , n = !(null !== (t = l.viewport) && void 0 !== t && t.contains(r));
                    n && a()
                }
            }))
        }
        ...
        o.forwardRef)((e,t)=>{
          ...
          , N = (0,
        o.forwardRef)((e,t)=>{
            let {__scopeToast: r, type: s="foreground", duration: u, open: d, onClose: p, onEscapeKeyDown: w, onPause: m, onResume: E, onSwipeStart: T, onSwipeMove: g, onSwipeCancel: h, onSwipeEnd: b, ...x} = e
              , C = R(F, r)
              , [P,M] = (0,
            o.useState)(null)
              , L = (0,
            ...
            v.W)(()=>{
              ...
              , Y = (0,
            o.useCallback)(e=>{
                e && e !== 1 / 0 && (window.clearTimeout(V.current),
            ...
            return C.viewport ? (0,
            o.createElement)(o.Fragment, null, z && (0,
            o.createElement)(A, {
                __scopeToast: r,
                role: "status",
            ...
            n.Z)({
                ...
                onKeyDown: (0,
                i.M)(e.onKeyDown, e=>{
                    "Escape" !== e.key || (null == w || w(e.nativeEvent),
                ...
                i.M)(e.onPointerMove, e=>{
                    ...
                    H("toast.swipeMove", g, c, {
                        discrete: !1
                    })) : $(u, C.swipeDirection, s) ? (_.current = u,
                    H("toast.swipeStart", T, c, {
                        discrete: !1
                    }),
                    e.target.setPointerCapture(e.pointerId)) : (Math.abs(t) > s || Math.abs(r) > s) && (k.current = null)
                }
                ),
                onPointerUp: (0,
                i.M)(e.onPointerUp, e=>{
                    ...
                    t) {
                        ...
                        $(t, C.swipeDirection, C.swipeThreshold) ? H("toast.swipeEnd", b, n, {
                            discrete: !0
