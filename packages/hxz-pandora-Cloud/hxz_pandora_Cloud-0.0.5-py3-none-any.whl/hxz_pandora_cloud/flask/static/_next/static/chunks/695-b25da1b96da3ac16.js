(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[695], {
    695: function(t, e, n) {
        "use strict";
        n.d(e, {
            W: function() {
        ...
        var i = n(39324)
          ...
          , b = n(94968);
        function g(t) {
            var e, n, f, p = t.isTrial, b = (0,
            v.Z)(), g = (0,
            h.useRouter)(), w = (0,
            r._)((0,
            s.useState)(!0), 2), x = w[0], P = w[1], j = (0,
            r._)((0,
            s.useState)(!1), 2), M = j[0], S = j[1];
            (0,
            ...
            s.useCallback)(function(t) {
                t.preventDefault(),
                c.A.logEvent(u.M.clickAccountPaymentSuccessContinue),
                g.push("/")
            }, [g])
              , C = (n = (e = (0,
            r._)((0,
            ...
            o.jsxs)(o.Fragment, {
                ...
                o.jsx)(l(), {
                    children: (0,
                    o.jsx)("title", {
                        children: b.formatMessage(_.pageTitle)
                    })
                }), M && (0,
                o.jsx)(d(), {
                    numberOfPieces: 500,
                    colors: ["#10A37F", "#1563D7", "#479AE7", "#5599FF", "#77B69F", "#8787D9", "#8787D9", "#BD8AF1", "#C089F8", "#FC6770", "#FFFFFF"],
                    recycle: x,
                    width: null != E ? E : void 0,
                    height: null != D ? D : void 0
                }), (0,
                o.jsxs)("div", {
                    ...
                    o.jsx)("div", {
                        ...
                        children: (0,
                        o.jsx)(y.Z, (0,
                        i._)({}, _.paymentReceived))
                    }), (0,
                    o.jsx)(a.z, {
                        onClick: I,
                        children: (0,
                        o.jsx)(y.Z, (0,
                        i._)({}, _.continueButton))
                    })]
                })]
            })
        }
        ...
        b.vU)({
            paymentReceived: {
                id: "PaymentsSuccess.paymentReceived",
                description: "Message displayed when the payment is successful",
                defaultMessage: "Payment received! You've been upgraded to ChatGPT Plus."
            },
            pageTitle: {
                id: "PaymentsSuccess.pageTitle",
                description: "Title for the payment success page",
                defaultMessage: "Account - Payment success"
            },
            continueButton: {
                id: "PaymentsSuccess.continueButton",
                description: "Label for the 'Continue' button on the payment success page",
        ...
        b.vU)({
            paymentReceived: {
                id: "TrialSuccess.paymentReceived",
                description: "Message displayed when the payment is successful",
                defaultMessage: "Trial started! You've been upgraded to ChatGPT Plus."
            },
            pageTitle: {
                id: "TrialSuccess.pageTitle",
                description: "Title for the trial success page",
                defaultMessage: "Account - Trial started"
            },
            continueButton: {
                id: "TrialSuccess.continueButton",
                description: "Label for the 'Continue' button on the trial success page",
                defaultMessage: "Continue"
            }
        })
    },
    12219: function(t, e, n) {
        ...
        , function(t, e, n) {
            ...
            var i = {
                ...
                easeInElastic: function(t, e, n, i) {
                    ...
                    o = .3 * i,
                    (r = s) < Math.abs(s) ? (r = s,
                    a = o / 4) : a = o / (2 * Math.PI) * Math.asin(s / r),
                    -r * Math.pow(2, 10 * (t -= 1)) * Math.sin((t * i - a) * (2 * Math.PI) / o) + e)
                },
                easeOutElastic: function(t, e, n, i) {
                    ...
                    (r = s) < Math.abs(s) ? (r = s,
                    a = o / 4) : a = o / (2 * Math.PI) * Math.asin(s / r),
                    r * Math.pow(2, -10 * t) * Math.sin((t * i - a) * (2 * Math.PI) / o) + s + e)
                },
                easeInOutElastic: function(t, e, n, i) {
                    var r, o, a, s = n - e;
                    return a = 1.70158,
                    0 === t ? e : 2 == (t /= i / 2) ? e + s : (o = 0,
                    o = i * (.3 * 1.5),
                    (r = s) < Math.abs(s) ? (r = s,
                    a = o / 4) : a = o / (2 * Math.PI) * Math.asin(s / r),
                    t < 1 ? -(r * Math.pow(2, 10 * (t -= 1)) * Math.sin((t * i - a) * (2 * Math.PI) / o) * .5) + e : r * Math.pow(2, -10 * (t -= 1)) * Math.sin((t * i - a) * (2 * Math.PI) / o) * .5 + s + e)
                },
                ...
                easeOutBack: function(t, e, n, i, r) {
                    return void 0 === r && (r = 1.70158),
                    (n - e) * ((t = t / i - 1) * t * ((r + 1) * t + r) + 1) + e
                },
                easeInOutBack: function(t, e, n, i, r) {
                    var o = n - e;
                    return void 0 === r && (r = 1.70158),
                    (t /= i / 2) < 1 ? o / 2 * (t * t * ((1 + (r *= 1.525)) * t - r)) + e : o / 2 * ((t -= 2) * t * ((1 + (r *= 1.525)) * t + r) + 2) + e
                },
                easeInBounce: function(t, e, n, r) {
                    var o = n - e;
                    return o - i.easeOutBounce(r - t, 0, o, r) + e
                },
                ...
                easeInOutBounce: function(t, e, n, r) {
                    var o = n - e;
                    return t < r / 2 ? .5 * i.easeInBounce(2 * t, 0, o, r) + e : .5 * i.easeOutBounce(2 * t - r, 0, o, r) + .5 * o + e
                }
            };
            t.exports = i
        }
        ...
        , function(t, e, n) {
            ...
            var i, r, o, a, s = n(0), c = n.n(s), u = n(1), f = n.n(u);
            function l(t, e) {
            ...
            (i = o || (o = {}))[i.Circle = 0] = "Circle",
            i[i.Square = 1] = "Square",
            i[i.Strip = 2] = "Strip",
            (r = a || (a = {}))[r.Positive = 1] = "Positive",
            ...
            var d = function() {
                ...
                function n(t, e, i, r) {
                    ...
                    this.h = l(5, 20),
                    this.radius = l(5, 10),
                    this.vx = "number" == typeof c ? l(-c, c) : l(c.min, c.max),
                    this.vy = "number" == typeof u ? l(-u, 0) : l(u.min, u.max),
                    this.shape = Math.floor(0 + 3 * Math.random()),
                    this.angle = l(0, 360) * Math.PI / 180,
                    this.angularSpin = l(-.2, .2),
                    this.color = s[Math.floor(Math.random() * s.length)],
                    this.rotateY = l(0, 1),
                    this.rotationDirection = l(0, 1) ? a.Positive : a.Negative
                }
                return t = [{
                    key: "update",
                    value: function() {
            ...
            var y = function t(e, n) {
                ...
                v(this, "removeParticleAt", function(t) {
                    i.particles.splice(t, 1)
                }),
                v(this, "getParticle", function() {
                    var t = l(i.x, i.w + i.x)
                      , e = l(i.y, i.h + i.y);
                    return new d(i.context,i.getOptions,t,e)
                }),
                v(this, "animate", function() {
                    ...
                    if (!a)
                        return !1;
                    var h = i.particles.length
                      , p = s ? h : n
                      , d = Date.now();
                    if (p < c) {
                        r !== c && (i.tweenInitTime = d,
                        i.lastNumberOfPieces = c);
                        for (var v = i.tweenInitTime, y = f(d - v > l ? l : Math.max(0, d - v), p, c, l), b = Math.round(y - p), g = 0; g < b; g++)
                            i.particles.push(i.getParticle());
                        i.particlesGenerated += b
                    }
                    return u && (e.font = "12px sans-serif",
                    e.fillStyle = "#333",
                    e.textAlign = "right",
                    e.fillText("Particles: ".concat(h), t.width - 10, t.height - 20)),
                    i.particles.forEach(function(e, n) {
                        e.update(),
                        (e.y > t.height || e.y < -100 || e.x > t.width + 100 || e.x < -100) && (s && p <= c ? i.particles[n] = i.getParticle() : i.removeParticleAt(n))
                    }),
                    h > 0 || p < c
                }),
                this.canvas = e;
            ...
            var w = {
              ...
              , x = function() {
                ...
                function e(t, n) {
                    ...
                    O(this, "generator", void 0),
                    O(this, "rafId", void 0),
                    O(this, "setOptionsWithDefaults", function(t) {
                        var e = {
                            confettiSource: {
                                x: 0,
                                y: 0,
                        ...
                        i._options = g(g(g({}, e), w), t),
                        Object.assign(i, t.confettiSource)
                    }),
                    O(this, "update", function() {
                        ...
                        i.generator.animate() ? i.rafId = requestAnimationFrame(i.update) : (n && "function" == typeof n && i.generator.particlesGenerated > 0 && n.call(i, i),
                        i._options.run = !1)
                    }),
                    O(this, "reset", function() {
                        i.generator && i.generator.particlesGenerated > 0 && (i.generator.particlesGenerated = 0,
                        i.generator.particles = [],
                        i.generator.lastNumberOfPieces = 0)
                    }),
            ...
            var k = c.a.createRef()
              , A = function(t) {
                ...
                function() {
                    ...
                    return (t = n) && ("object" === P(t) || "function" == typeof t) ? t : _(this)
                }
                );
                function o(t) {
                    var e;
                    ...
                    for (var n = arguments.length, i = Array(n > 1 ? n - 1 : 0), a = 1; a < n; a++)
                        i[a - 1] = arguments[a];
                    return F(_(e = r.call.apply(r, [this, t].concat(i))), "canvas", c.a.createRef()),
                    F(_(e), "confetti", void 0),
                ...
                return n = [{
                    ...
                    value: function() {
                        ...
                        return c.a.createElement("canvas", j({
                            width: n.width,
                            height: n.height,
                            ref: this.canvas
                        }, i, {
            ...
            function R(t) {
                var e, n = {}, i = {}, r = [].concat(function(t) {
                    if (Array.isArray(t))
                        return C(t)
                }(e = Object.keys(w)) || function(t) {
                    if ("undefined" != typeof Symbol && Symbol.iterator in Object(t))
                        return Array.from(t)
                }(e) || I(e) || function() {
                    throw TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")
                }(), ["confettiSource", "drawShape", "onConfettiComplete"]), o = ["canvasRef"];
                for (var a in t) {
                    var s = t[a];
                    r.includes(a) ? n[a] = s : o.includes(a) ? o[a] = s : i[a] = s
                }
                return [n, i, {}]
            }
            F(A, "defaultProps", S({}, w)),
            F(A, "displayName", "ReactConfetti");
            var B = c.a.forwardRef(function(t, e) {
