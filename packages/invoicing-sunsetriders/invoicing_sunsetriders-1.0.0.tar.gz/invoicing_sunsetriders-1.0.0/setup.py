...
setup(
  name = 'invoicing_sunsetriders',         #* Your package will have this name
  packages = ['invoicing_sunsetriders'],   #* Name the package again
  ...
  author = 'Bryan Murphy',                   # Your name
  author_email = 'Bryan@HireMeTo.Day',  # Your email
  url = 'https://github.com/BPMData',              # Homepage of your library (e.g. github or your website)
