...
class PageableObject(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["unpaged", "paged", "pageNumber", "pageSize", "offset", "sort", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["unpaged", "paged", "pageNumber", "pageSize", "offset", "sort", ], str]):
