...
class itkImageFunctionPA3DSCIFD(itk.itkFunctionBasePython.itkFunctionBasePD3D):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    SetInputImage = _swig_new_instance_method(_itkImageFunctionBasePython.itkImageFunctionPA3DSCIFD_SetInputImage)
    GetInputImage = _swig_new_instance_method(_itkImageFunctionBasePython.itkImageFunctionPA3DSCIFD_GetInputImage)
    EvaluateAtIndex = _swig_new_instance_method(_itkImageFunctionBasePython.itkImageFunctionPA3DSCIFD_EvaluateAtIndex)
    EvaluateAtContinuousIndex = _swig_new_instance_method(_itkImageFunctionBasePython.itkImageFunctionPA3DSCIFD_EvaluateAtContinuousIndex)
    IsInsideBuffer = _swig_new_instance_method(_itkImageFunctionBasePython.itkImageFunctionPA3DSCIFD_IsInsideBuffer)
    ConvertPointToNearestIndex = _swig_new_instance_method(_itkImageFunctionBasePython.itkImageFunctionPA3DSCIFD_ConvertPointToNearestIndex)
    ConvertPointToContinuousIndex = _swig_new_instance_method(_itkImageFunctionBasePython.itkImageFunctionPA3DSCIFD_ConvertPointToContinuousIndex)
    ConvertContinuousIndexToNearestIndex = _swig_new_instance_method(_itkImageFunctionBasePython.itkImageFunctionPA3DSCIFD_ConvertContinuousIndexToNearestIndex)
    GetStartIndex = _swig_new_instance_method(_itkImageFunctionBasePython.itkImageFunctionPA3DSCIFD_GetStartIndex)
    GetEndIndex = _swig_new_instance_method(_itkImageFunctionBasePython.itkImageFunctionPA3DSCIFD_GetEndIndex)
    GetStartContinuousIndex = _swig_new_instance_method(_itkImageFunctionBasePython.itkImageFunctionPA3DSCIFD_GetStartContinuousIndex)
    GetEndContinuousIndex = _swig_new_instance_method(_itkImageFunctionBasePython.itkImageFunctionPA3DSCIFD_GetEndContinuousIndex)
    __swig_destroy__ = _itkImageFunctionBasePython.delete_itkImageFunctionPA3DSCIFD
    cast = _swig_new_static_method(_itkImageFunctionBasePython.itkImageFunctionPA3DSCIFD_cast)
...
itkImageFunctionPA3DSCIFD_cast = _itkImageFunctionBasePython.itkImageFunctionPA3DSCIFD_cast
...
class itkImageFunctionPA3DSCIUCD(itk.itkFunctionBasePython.itkFunctionBasePD3D):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    SetInputImage = _swig_new_instance_method(_itkImageFunctionBasePython.itkImageFunctionPA3DSCIUCD_SetInputImage)
    GetInputImage = _swig_new_instance_method(_itkImageFunctionBasePython.itkImageFunctionPA3DSCIUCD_GetInputImage)
    EvaluateAtIndex = _swig_new_instance_method(_itkImageFunctionBasePython.itkImageFunctionPA3DSCIUCD_EvaluateAtIndex)
    EvaluateAtContinuousIndex = _swig_new_instance_method(_itkImageFunctionBasePython.itkImageFunctionPA3DSCIUCD_EvaluateAtContinuousIndex)
    IsInsideBuffer = _swig_new_instance_method(_itkImageFunctionBasePython.itkImageFunctionPA3DSCIUCD_IsInsideBuffer)
    ConvertPointToNearestIndex = _swig_new_instance_method(_itkImageFunctionBasePython.itkImageFunctionPA3DSCIUCD_ConvertPointToNearestIndex)
    ConvertPointToContinuousIndex = _swig_new_instance_method(_itkImageFunctionBasePython.itkImageFunctionPA3DSCIUCD_ConvertPointToContinuousIndex)
    ConvertContinuousIndexToNearestIndex = _swig_new_instance_method(_itkImageFunctionBasePython.itkImageFunctionPA3DSCIUCD_ConvertContinuousIndexToNearestIndex)
    GetStartIndex = _swig_new_instance_method(_itkImageFunctionBasePython.itkImageFunctionPA3DSCIUCD_GetStartIndex)
    GetEndIndex = _swig_new_instance_method(_itkImageFunctionBasePython.itkImageFunctionPA3DSCIUCD_GetEndIndex)
    GetStartContinuousIndex = _swig_new_instance_method(_itkImageFunctionBasePython.itkImageFunctionPA3DSCIUCD_GetStartContinuousIndex)
    GetEndContinuousIndex = _swig_new_instance_method(_itkImageFunctionBasePython.itkImageFunctionPA3DSCIUCD_GetEndContinuousIndex)
    __swig_destroy__ = _itkImageFunctionBasePython.delete_itkImageFunctionPA3DSCIUCD
    cast = _swig_new_static_method(_itkImageFunctionBasePython.itkImageFunctionPA3DSCIUCD_cast)
...
itkImageFunctionPA3DSCIUCD_cast = _itkImageFunctionBasePython.itkImageFunctionPA3DSCIUCD_cast
