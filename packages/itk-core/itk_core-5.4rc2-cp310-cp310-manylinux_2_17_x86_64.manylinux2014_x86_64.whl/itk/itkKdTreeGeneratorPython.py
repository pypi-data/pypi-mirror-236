...
class itkKdTreeGeneratorLSVF2(itk.ITKCommonBasePython.itkObject):
    ...
    GetSourceSample = _swig_new_instance_method(_itkKdTreeGeneratorPython.itkKdTreeGeneratorLSVF2_GetSourceSample)
    SetBucketSize = _swig_new_instance_method(_itkKdTreeGeneratorPython.itkKdTreeGeneratorLSVF2_SetBucketSize)
    GetBucketSize = _swig_new_instance_method(_itkKdTreeGeneratorPython.itkKdTreeGeneratorLSVF2_GetBucketSize)
...
class itkKdTreeGeneratorLSVF3(itk.ITKCommonBasePython.itkObject):
    ...
    GetSourceSample = _swig_new_instance_method(_itkKdTreeGeneratorPython.itkKdTreeGeneratorLSVF3_GetSourceSample)
    SetBucketSize = _swig_new_instance_method(_itkKdTreeGeneratorPython.itkKdTreeGeneratorLSVF3_SetBucketSize)
    GetBucketSize = _swig_new_instance_method(_itkKdTreeGeneratorPython.itkKdTreeGeneratorLSVF3_GetBucketSize)
...
class itkKdTreeGeneratorLSVF4(itk.ITKCommonBasePython.itkObject):
    ...
    GetSourceSample = _swig_new_instance_method(_itkKdTreeGeneratorPython.itkKdTreeGeneratorLSVF4_GetSourceSample)
    SetBucketSize = _swig_new_instance_method(_itkKdTreeGeneratorPython.itkKdTreeGeneratorLSVF4_SetBucketSize)
    GetBucketSize = _swig_new_instance_method(_itkKdTreeGeneratorPython.itkKdTreeGeneratorLSVF4_GetBucketSize)
