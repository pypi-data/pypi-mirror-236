...
class itkHistogramD(itk.itkSamplePython.itkSampleAD):
    ...
    ClipBinsAtEndsOn = _swig_new_instance_method(_itkHistogramPython.itkHistogramD_ClipBinsAtEndsOn)
    ClipBinsAtEndsOff = _swig_new_instance_method(_itkHistogramPython.itkHistogramD_ClipBinsAtEndsOff)
...
class itkHistogramF(itk.itkSamplePython.itkSampleAF):
    ...
    ClipBinsAtEndsOn = _swig_new_instance_method(_itkHistogramPython.itkHistogramF_ClipBinsAtEndsOn)
    ClipBinsAtEndsOff = _swig_new_instance_method(_itkHistogramPython.itkHistogramF_ClipBinsAtEndsOff)
