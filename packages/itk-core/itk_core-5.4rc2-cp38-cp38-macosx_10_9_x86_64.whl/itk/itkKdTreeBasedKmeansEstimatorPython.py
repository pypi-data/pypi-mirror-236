...
class itkKdTreeBasedKmeansEstimatorKdTreeLSVF2(itk.ITKCommonBasePython.itkObject):
    ...
    UseClusterLabelsOn = _swig_new_instance_method(_itkKdTreeBasedKmeansEstimatorPython.itkKdTreeBasedKmeansEstimatorKdTreeLSVF2_UseClusterLabelsOn)
    UseClusterLabelsOff = _swig_new_instance_method(_itkKdTreeBasedKmeansEstimatorPython.itkKdTreeBasedKmeansEstimatorKdTreeLSVF2_UseClusterLabelsOff)
...
class itkKdTreeBasedKmeansEstimatorKdTreeLSVF3(itk.ITKCommonBasePython.itkObject):
    ...
    UseClusterLabelsOn = _swig_new_instance_method(_itkKdTreeBasedKmeansEstimatorPython.itkKdTreeBasedKmeansEstimatorKdTreeLSVF3_UseClusterLabelsOn)
    UseClusterLabelsOff = _swig_new_instance_method(_itkKdTreeBasedKmeansEstimatorPython.itkKdTreeBasedKmeansEstimatorKdTreeLSVF3_UseClusterLabelsOff)
...
class itkKdTreeBasedKmeansEstimatorKdTreeLSVF4(itk.ITKCommonBasePython.itkObject):
    ...
    UseClusterLabelsOn = _swig_new_instance_method(_itkKdTreeBasedKmeansEstimatorPython.itkKdTreeBasedKmeansEstimatorKdTreeLSVF4_UseClusterLabelsOn)
    UseClusterLabelsOff = _swig_new_instance_method(_itkKdTreeBasedKmeansEstimatorPython.itkKdTreeBasedKmeansEstimatorKdTreeLSVF4_UseClusterLabelsOff)
