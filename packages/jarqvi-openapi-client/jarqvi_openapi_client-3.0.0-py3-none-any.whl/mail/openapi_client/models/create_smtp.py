...
class CreateSMTP(BaseModel):
    ...
    data: Optional[CreateSMTPData] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateSMTP:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateSMTP:
        """Create an instance of CreateSMTP from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateSMTP.model_validate(obj)

        _obj = CreateSMTP.model_validate({
            "status": obj.get("status"),
            "data": CreateSMTPData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
