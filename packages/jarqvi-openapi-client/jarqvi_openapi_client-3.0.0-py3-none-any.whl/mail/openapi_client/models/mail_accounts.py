...
class MailAccounts(BaseModel):
    """
    MailAccounts
    """
    status: Optional[StrictStr] = None
    data: Optional[MailAccountsData] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MailAccounts:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MailAccounts:
        """Create an instance of MailAccounts from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MailAccounts.model_validate(obj)

        _obj = MailAccounts.model_validate({
            "status": obj.get("status"),
            "data": MailAccountsData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
