...
class MailEvents(BaseModel):
    """
    MailEvents
    """
    status: Optional[StrictStr] = None
    data: Optional[MailEventsData] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MailEvents:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MailEvents:
        """Create an instance of MailEvents from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MailEvents.model_validate(obj)

        _obj = MailEvents.model_validate({
            "status": obj.get("status"),
            "data": MailEventsData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
