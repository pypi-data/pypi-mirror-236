...
class MailMessages(BaseModel):
    ...
    data: Optional[MailMessagesData] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MailMessages:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MailMessages:
        """Create an instance of MailMessages from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MailMessages.model_validate(obj)

        _obj = MailMessages.model_validate({
            "status": obj.get("status"),
            "data": MailMessagesData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
