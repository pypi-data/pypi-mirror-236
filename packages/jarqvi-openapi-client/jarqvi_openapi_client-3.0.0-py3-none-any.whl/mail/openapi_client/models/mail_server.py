...
class MailServer(BaseModel):
    ...
    data: Optional[MailServerData] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MailServer:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MailServer:
        """Create an instance of MailServer from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MailServer.model_validate(obj)

        _obj = MailServer.model_validate({
            "status": obj.get("status"),
            "data": MailServerData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
