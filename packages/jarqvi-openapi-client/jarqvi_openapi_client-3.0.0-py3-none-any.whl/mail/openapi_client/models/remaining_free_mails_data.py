...
class RemainingFreeMailsData(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RemainingFreeMailsData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RemainingFreeMailsData:
        """Create an instance of RemainingFreeMailsData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RemainingFreeMailsData.model_validate(obj)

        _obj = RemainingFreeMailsData.model_validate({
            "count": obj.get("count")
        })
        return _obj
