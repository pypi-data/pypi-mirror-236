...
class TmpAccess(BaseModel):
    """
    TmpAccess
    """
    status: Optional[StrictStr] = None
    data: Optional[TmpAccessData] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TmpAccess:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TmpAccess:
        """Create an instance of TmpAccess from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TmpAccess.model_validate(obj)

        _obj = TmpAccess.model_validate({
            "status": obj.get("status"),
            "data": TmpAccessData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
