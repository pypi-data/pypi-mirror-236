...
class ChangeBucketAccess200Response(BaseModel):
    """
    ChangeBucketAccess200Response
    """
    status: Optional[StrictStr] = None
    permission: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["status", "permission"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ChangeBucketAccess200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ChangeBucketAccess200Response:
        """Create an instance of ChangeBucketAccess200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ChangeBucketAccess200Response.model_validate(obj)

        _obj = ChangeBucketAccess200Response.model_validate({
