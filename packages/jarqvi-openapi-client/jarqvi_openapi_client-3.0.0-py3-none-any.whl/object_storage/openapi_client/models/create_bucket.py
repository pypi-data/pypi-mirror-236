...
class CreateBucket(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "plan", "permission"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateBucket:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateBucket:
        """Create an instance of CreateBucket from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateBucket.model_validate(obj)

        _obj = CreateBucket.model_validate({
            "name": obj.get("name"),
            "plan": obj.get("plan"),
