...
class CreateFolder201ResponseData(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateFolder201ResponseData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateFolder201ResponseData:
        """Create an instance of CreateFolder201ResponseData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateFolder201ResponseData.model_validate(obj)

        _obj = CreateFolder201ResponseData.model_validate({
