...
class CreateKey(BaseModel):
    ...
    CreateKey
    """
    buckets: Optional[List[Union[str, Any]]] = None
    description: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["buckets", "description"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateKey:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateKey:
        """Create an instance of CreateKey from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateKey.model_validate(obj)

        _obj = CreateKey.model_validate({
