...
class CreateKey201Response(BaseModel):
    """
    CreateKey201Response
    """
    status: Optional[StrictStr] = None
    data: Optional[CreateKey201ResponseData] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateKey201Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateKey201Response:
        """Create an instance of CreateKey201Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateKey201Response.model_validate(obj)

        _obj = CreateKey201Response.model_validate({
            "status": obj.get("status"),
            "data": CreateKey201ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
