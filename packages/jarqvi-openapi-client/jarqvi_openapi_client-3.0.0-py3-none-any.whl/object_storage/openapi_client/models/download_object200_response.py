...
class DownloadObject200Response(BaseModel):
    """
    DownloadObject200Response
    """
    status: Optional[StrictStr] = None
    data: Optional[DownloadObject200ResponseData] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DownloadObject200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DownloadObject200Response:
        """Create an instance of DownloadObject200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DownloadObject200Response.model_validate(obj)

        _obj = DownloadObject200Response.model_validate({
            "status": obj.get("status"),
            "data": DownloadObject200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
