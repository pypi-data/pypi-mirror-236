...
class DownloadObject200ResponseData(BaseModel):
    """
    DownloadObject200ResponseData
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DownloadObject200ResponseData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DownloadObject200ResponseData:
        """Create an instance of DownloadObject200ResponseData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DownloadObject200ResponseData.model_validate(obj)

        _obj = DownloadObject200ResponseData.model_validate({
            "url": obj.get("url")
        })
        return _obj
