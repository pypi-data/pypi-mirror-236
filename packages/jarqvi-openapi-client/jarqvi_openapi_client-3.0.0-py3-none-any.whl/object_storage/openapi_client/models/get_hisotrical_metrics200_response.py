...
class GetHisotricalMetrics200Response(BaseModel):
    """
    GetHisotricalMetrics200Response
    """
    status: Optional[StrictStr] = None
    data: Optional[GetHisotricalMetrics200ResponseData] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetHisotricalMetrics200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetHisotricalMetrics200Response:
        """Create an instance of GetHisotricalMetrics200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetHisotricalMetrics200Response.model_validate(obj)

        _obj = GetHisotricalMetrics200Response.model_validate({
            "status": obj.get("status"),
            "data": GetHisotricalMetrics200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
