...
class MigrateBucket(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["from", "to", "path"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MigrateBucket:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MigrateBucket:
        """Create an instance of MigrateBucket from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MigrateBucket.model_validate(obj)

        _obj = MigrateBucket.model_validate({
            "from": obj.get("from"),
            "to": obj.get("to"),
            "path": obj.get("path")
        })
