...
class Stat(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> Stat:
        ...
        if not isinstance(obj, dict):
            return Stat.model_validate(obj)

        _obj = Stat.model_validate({
            "status": obj.get("status"),
            "data": StatData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
