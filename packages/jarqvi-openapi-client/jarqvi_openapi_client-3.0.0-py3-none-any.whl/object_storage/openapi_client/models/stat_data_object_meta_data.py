...
class StatDataObjectMetaData(BaseModel):
    """
    StatDataObjectMetaData
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StatDataObjectMetaData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StatDataObjectMetaData:
        """Create an instance of StatDataObjectMetaData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StatDataObjectMetaData.model_validate(obj)

        _obj = StatDataObjectMetaData.model_validate({
