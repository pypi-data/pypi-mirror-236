...
class UpgradeBucket200Response(BaseModel):
    """
    UpgradeBucket200Response
    """
    status: Optional[StrictStr] = None
    quota: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["status", "quota"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpgradeBucket200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpgradeBucket200Response:
        """Create an instance of UpgradeBucket200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpgradeBucket200Response.model_validate(obj)

        _obj = UpgradeBucket200Response.model_validate({
