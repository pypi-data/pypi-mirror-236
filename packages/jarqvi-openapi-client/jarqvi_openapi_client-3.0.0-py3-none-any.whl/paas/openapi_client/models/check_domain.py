...
class CheckDomain(BaseModel):
    ...
    CheckDomain
    """
    domain: Optional[CheckDomainDomain] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CheckDomain:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CheckDomain:
        """Create an instance of CheckDomain from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CheckDomain.model_validate(obj)

        _obj = CheckDomain.model_validate({
            "domain": CheckDomainDomain.from_dict(obj.get("domain")) if obj.get("domain") is not None else None
        })
        return _obj
