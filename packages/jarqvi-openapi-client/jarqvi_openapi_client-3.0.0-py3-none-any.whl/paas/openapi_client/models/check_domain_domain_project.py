...
class CheckDomainDomainProject(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CheckDomainDomainProject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CheckDomainDomainProject:
        """Create an instance of CheckDomainDomainProject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CheckDomainDomainProject.model_validate(obj)

        _obj = CheckDomainDomainProject.model_validate({
            "_id": obj.get("_id"),
