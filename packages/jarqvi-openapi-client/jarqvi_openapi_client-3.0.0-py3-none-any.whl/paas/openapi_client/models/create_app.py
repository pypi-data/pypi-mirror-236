...
class CreateApp(BaseModel):
    ...
    CreateApp
    """
    name: Optional[StrictStr] = Field(default=None, description="The name of app that you want to create")
    plan_id: Optional[StrictStr] = Field(default=None, description="The plan of app that you want to create", alias="planID")
    platform: Optional[StrictStr] = Field(default=None, description="The platform of app that you want to create")
    __properties: ClassVar[List[str]] = ["name", "planID", "platform"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateApp:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateApp:
        """Create an instance of CreateApp from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateApp.model_validate(obj)

        _obj = CreateApp.model_validate({
            "name": obj.get("name"),
