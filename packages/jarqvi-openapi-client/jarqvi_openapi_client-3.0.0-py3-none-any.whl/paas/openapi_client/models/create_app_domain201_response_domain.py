...
class CreateAppDomain201ResponseDomain(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateAppDomain201ResponseDomain:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateAppDomain201ResponseDomain:
        """Create an instance of CreateAppDomain201ResponseDomain from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateAppDomain201ResponseDomain.model_validate(obj)

        _obj = CreateAppDomain201ResponseDomain.model_validate({
            "_id": obj.get("_id")
        })
        return _obj
