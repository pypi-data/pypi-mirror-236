...
class CreateDiskRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateDiskRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateDiskRequest:
        """Create an instance of CreateDiskRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateDiskRequest.model_validate(obj)

        _obj = CreateDiskRequest.model_validate({
            "name": obj.get("name"),
            "size": obj.get("size")
        })
        return _obj
