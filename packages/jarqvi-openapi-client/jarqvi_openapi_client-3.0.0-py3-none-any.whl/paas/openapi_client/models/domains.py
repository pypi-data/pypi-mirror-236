...
class Domains(BaseModel):
    ...
    Domains
    """
    domains: Optional[List[DomainsDomainsInner]] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Domains:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Domains:
        """Create an instance of Domains from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Domains.model_validate(obj)

        _obj = Domains.model_validate({
            "domains": [DomainsDomainsInner.from_dict(_item) for _item in obj.get("domains")] if obj.get("domains") is not None else None
        })
        return _obj
