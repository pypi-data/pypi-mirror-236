...
class DownloadBackup200Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DownloadBackup200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DownloadBackup200Response:
        """Create an instance of DownloadBackup200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DownloadBackup200Response.model_validate(obj)

        _obj = DownloadBackup200Response.model_validate({
            "link": obj.get("link")
        })
        return _obj
