...
class EnableSsl200Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EnableSsl200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EnableSsl200Response:
        """Create an instance of EnableSsl200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EnableSsl200Response.model_validate(obj)

        _obj = EnableSsl200Response.model_validate({
            "code": obj.get("code")
        })
        return _obj
