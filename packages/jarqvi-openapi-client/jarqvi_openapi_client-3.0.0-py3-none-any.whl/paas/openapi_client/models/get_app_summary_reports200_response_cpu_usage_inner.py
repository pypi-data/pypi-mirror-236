...
class GetAppSummaryReports200ResponseCpuUsageInner(BaseModel):
    """
    GetAppSummaryReports200ResponseCpuUsageInner
    """
    value: Optional[List[GetAppSummaryReports200ResponseCpuUsageInnerValueInner]] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAppSummaryReports200ResponseCpuUsageInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAppSummaryReports200ResponseCpuUsageInner:
        """Create an instance of GetAppSummaryReports200ResponseCpuUsageInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetAppSummaryReports200ResponseCpuUsageInner.model_validate(obj)

        _obj = GetAppSummaryReports200ResponseCpuUsageInner.model_validate({
            "value": [GetAppSummaryReports200ResponseCpuUsageInnerValueInner.from_dict(_item) for _item in obj.get("value")] if obj.get("value") is not None else None,
