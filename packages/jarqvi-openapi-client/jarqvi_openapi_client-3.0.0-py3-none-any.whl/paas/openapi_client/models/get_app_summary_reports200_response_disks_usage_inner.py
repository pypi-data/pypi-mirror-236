...
class GetAppSummaryReports200ResponseDisksUsageInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["size", "usage", "reportedAt", "name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAppSummaryReports200ResponseDisksUsageInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAppSummaryReports200ResponseDisksUsageInner:
        """Create an instance of GetAppSummaryReports200ResponseDisksUsageInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetAppSummaryReports200ResponseDisksUsageInner.model_validate(obj)

        _obj = GetAppSummaryReports200ResponseDisksUsageInner.model_validate({
            "size": obj.get("size"),
            "usage": obj.get("usage"),
