...
class GetDiskBackupBackupsInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetDiskBackupBackupsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetDiskBackupBackupsInner:
        """Create an instance of GetDiskBackupBackupsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetDiskBackupBackupsInner.model_validate(obj)

        _obj = GetDiskBackupBackupsInner.model_validate({
            "name": obj.get("name"),
