...
class Projects(BaseModel):
    ...
    Projects
    """
    projects: Optional[List[ProjectsProjectsInner]] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Projects:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Projects:
        """Create an instance of Projects from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Projects.model_validate(obj)

        _obj = Projects.model_validate({
            "projects": [ProjectsProjectsInner.from_dict(_item) for _item in obj.get("projects")] if obj.get("projects") is not None else None
        })
        return _obj
