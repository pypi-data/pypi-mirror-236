...
class ReleasesDeploy200Response(BaseModel):
    """
    ReleasesDeploy200Response
    """
    release_id: Optional[StrictStr] = Field(default=None, alias="releaseID")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReleasesDeploy200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReleasesDeploy200Response:
        """Create an instance of ReleasesDeploy200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReleasesDeploy200Response.model_validate(obj)

        _obj = ReleasesDeploy200Response.model_validate({
