...
class ResizeDiskRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResizeDiskRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResizeDiskRequest:
        """Create an instance of ResizeDiskRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResizeDiskRequest.model_validate(obj)

        _obj = ResizeDiskRequest.model_validate({
            "size": obj.get("size")
        })
        return _obj
