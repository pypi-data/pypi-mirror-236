...
class MailForwards(BaseModel):
    """
    MailForwards
    """
    status: Optional[StrictStr] = None
    data: Optional[MailForwardsData] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MailForwards:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MailForwards:
        """Create an instance of MailForwards from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MailForwards.model_validate(obj)

        _obj = MailForwards.model_validate({
            "status": obj.get("status"),
            "data": MailForwardsData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
