...
class EnableSslRequest(BaseModel):
    """
    EnableSslRequest
    """
    domain: StrictStr
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EnableSslRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EnableSslRequest:
        """Create an instance of EnableSslRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EnableSslRequest.model_validate(obj)

        _obj = EnableSslRequest.model_validate({
