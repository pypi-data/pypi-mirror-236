...
class UpdateEnvsVariablesInner(BaseModel):
    """
    UpdateEnvsVariablesInner
    """
    key: Optional[StrictStr] = Field(default=None, description="The name of your env")
    value: Optional[StrictStr] = Field(default=None, description="The value of your env")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateEnvsVariablesInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateEnvsVariablesInner:
        """Create an instance of UpdateEnvsVariablesInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateEnvsVariablesInner.model_validate(obj)

        _obj = UpdateEnvsVariablesInner.model_validate({
            "key": obj.get("key"),
            "value": obj.get("value")
        })
        return _obj
