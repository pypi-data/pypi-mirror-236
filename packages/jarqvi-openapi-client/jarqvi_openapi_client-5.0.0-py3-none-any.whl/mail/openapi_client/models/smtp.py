...
class SMTP(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SMTP:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SMTP:
        """Create an instance of SMTP from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SMTP.model_validate(obj)

        _obj = SMTP.model_validate({
            "status": obj.get("status"),
            "data": SMTPData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
