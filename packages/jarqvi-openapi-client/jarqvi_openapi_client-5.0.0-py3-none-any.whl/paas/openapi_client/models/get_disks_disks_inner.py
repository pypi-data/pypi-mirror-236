...
class GetDisksDisksInner(BaseModel):
    """
    GetDisksDisksInner
    """
    ...
    __properties: ClassVar[List[str]] = ["_id", "name", "size", "updatedAt", "createdAt"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetDisksDisksInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetDisksDisksInner:
        """Create an instance of GetDisksDisksInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetDisksDisksInner.model_validate(obj)

        _obj = GetDisksDisksInner.model_validate({
            "_id": obj.get("_id"),
            "name": obj.get("name"),
            "size": obj.get("size"),
