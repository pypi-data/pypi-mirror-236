...
class IpStatic200Response(BaseModel):
    """
    IpStatic200Response
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IpStatic200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IpStatic200Response:
        """Create an instance of IpStatic200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IpStatic200Response.model_validate(obj)

        _obj = IpStatic200Response.model_validate({
            "IP": obj.get("IP")
        })
        return _obj
