...
class ProjectAllDetails(BaseModel):
    ...
    ProjectAllDetails
    """
    project: Optional[ProjectAllDetailsProject] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProjectAllDetails:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProjectAllDetails:
        """Create an instance of ProjectAllDetails from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProjectAllDetails.model_validate(obj)

        _obj = ProjectAllDetails.model_validate({
            "project": ProjectAllDetailsProject.from_dict(obj.get("project")) if obj.get("project") is not None else None
        })
        return _obj
