...
class ProjectAllDetailsProjectEnvsInner(BaseModel):
    """
    ProjectAllDetailsProjectEnvsInner
    """
    key: Optional[StrictStr] = None
    value: Optional[StrictStr] = None
    encrypted: Optional[StrictBool] = None
    id: Optional[StrictStr] = Field(default=None, alias="_id")
    __properties: ClassVar[List[str]] = ["key", "value", "encrypted", "_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProjectAllDetailsProjectEnvsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProjectAllDetailsProjectEnvsInner:
        """Create an instance of ProjectAllDetailsProjectEnvsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProjectAllDetailsProjectEnvsInner.model_validate(obj)

        _obj = ProjectAllDetailsProjectEnvsInner.model_validate({
            "key": obj.get("key"),
            "value": obj.get("value"),
