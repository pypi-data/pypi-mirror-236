...
class SourcesDeploy200Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SourcesDeploy200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SourcesDeploy200Response:
        """Create an instance of SourcesDeploy200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SourcesDeploy200Response.model_validate(obj)

        _obj = SourcesDeploy200Response.model_validate({
