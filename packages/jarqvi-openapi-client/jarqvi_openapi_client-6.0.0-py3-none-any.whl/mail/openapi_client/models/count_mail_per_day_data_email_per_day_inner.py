...
class CountMailPerDayDataEmailPerDayInner(BaseModel):
    """
    CountMailPerDayDataEmailPerDayInner
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CountMailPerDayDataEmailPerDayInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CountMailPerDayDataEmailPerDayInner:
        """Create an instance of CountMailPerDayDataEmailPerDayInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CountMailPerDayDataEmailPerDayInner.model_validate(obj)

        _obj = CountMailPerDayDataEmailPerDayInner.model_validate({
            "count": obj.get("count"),
            "date": obj.get("date")
        })
        return _obj
