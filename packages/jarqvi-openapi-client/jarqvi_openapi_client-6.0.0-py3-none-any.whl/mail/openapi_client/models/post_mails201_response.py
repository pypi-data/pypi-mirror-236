...
class PostMails201Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostMails201Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostMails201Response:
        """Create an instance of PostMails201Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PostMails201Response.model_validate(obj)

        _obj = PostMails201Response.model_validate({
