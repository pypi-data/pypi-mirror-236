...
class CreateBucket201Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateBucket201Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateBucket201Response:
        """Create an instance of CreateBucket201Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateBucket201Response.model_validate(obj)

        _obj = CreateBucket201Response.model_validate({
