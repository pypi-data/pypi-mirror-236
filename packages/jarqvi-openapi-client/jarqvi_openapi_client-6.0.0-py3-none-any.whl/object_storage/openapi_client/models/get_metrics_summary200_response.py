...
class GetMetricsSummary200Response(BaseModel):
    """
    GetMetricsSummary200Response
    """
    status: Optional[StrictStr] = None
    data: Optional[GetMetricsSummary200ResponseData] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetMetricsSummary200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetMetricsSummary200Response:
        """Create an instance of GetMetricsSummary200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetMetricsSummary200Response.model_validate(obj)

        _obj = GetMetricsSummary200Response.model_validate({
            "status": obj.get("status"),
            "data": GetMetricsSummary200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
