...
class ObjectsDataObjectsCommonPrefixesInner(BaseModel):
    """
    ObjectsDataObjectsCommonPrefixesInner
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ObjectsDataObjectsCommonPrefixesInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ObjectsDataObjectsCommonPrefixesInner:
        """Create an instance of ObjectsDataObjectsCommonPrefixesInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ObjectsDataObjectsCommonPrefixesInner.model_validate(obj)

        _obj = ObjectsDataObjectsCommonPrefixesInner.model_validate({
