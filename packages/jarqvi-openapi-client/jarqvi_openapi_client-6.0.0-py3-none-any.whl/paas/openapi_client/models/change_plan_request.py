...
class ChangePlanRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ChangePlanRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ChangePlanRequest:
        """Create an instance of ChangePlanRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ChangePlanRequest.model_validate(obj)

        _obj = ChangePlanRequest.model_validate({
