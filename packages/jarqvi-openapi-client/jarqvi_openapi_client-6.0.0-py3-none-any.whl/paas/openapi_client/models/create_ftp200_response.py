...
class CreateFtp200Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateFtp200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateFtp200Response:
        """Create an instance of CreateFtp200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateFtp200Response.model_validate(obj)

        _obj = CreateFtp200Response.model_validate({
