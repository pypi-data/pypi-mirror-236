...
class LogsInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type", "datetime", "message"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LogsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LogsInner:
        """Create an instance of LogsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LogsInner.model_validate(obj)

        _obj = LogsInner.model_validate({
            "type": obj.get("type"),
