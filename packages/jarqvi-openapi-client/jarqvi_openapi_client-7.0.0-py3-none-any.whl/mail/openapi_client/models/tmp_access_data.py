...
class TmpAccessData(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TmpAccessData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TmpAccessData:
        """Create an instance of TmpAccessData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TmpAccessData.model_validate(obj)

        _obj = TmpAccessData.model_validate({
            "token": obj.get("token")
        })
        return _obj
