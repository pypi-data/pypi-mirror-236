...
class CreateFolder201Response(BaseModel):
    """
    CreateFolder201Response
    """
    status: Optional[StrictStr] = None
    data: Optional[CreateFolder201ResponseData] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateFolder201Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateFolder201Response:
        """Create an instance of CreateFolder201Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateFolder201Response.model_validate(obj)

        _obj = CreateFolder201Response.model_validate({
            "status": obj.get("status"),
            "data": CreateFolder201ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
