...
class CreateKey201ResponseData(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateKey201ResponseData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateKey201ResponseData:
        """Create an instance of CreateKey201ResponseData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateKey201ResponseData.model_validate(obj)

        _obj = CreateKey201ResponseData.model_validate({
