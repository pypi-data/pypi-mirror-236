...
class RevokeSecretKey200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["status", "accessKey", "secretKey"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RevokeSecretKey200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RevokeSecretKey200Response:
        """Create an instance of RevokeSecretKey200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RevokeSecretKey200Response.model_validate(obj)

        _obj = RevokeSecretKey200Response.model_validate({
