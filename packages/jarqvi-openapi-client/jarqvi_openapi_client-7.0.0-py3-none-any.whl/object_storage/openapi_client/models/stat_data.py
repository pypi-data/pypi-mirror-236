...
class StatData(BaseModel):
    ...
    StatData
    """
    object: Optional[StatDataObject] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StatData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StatData:
        """Create an instance of StatData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StatData.model_validate(obj)

        _obj = StatData.model_validate({
            "object": StatDataObject.from_dict(obj.get("object")) if obj.get("object") is not None else None
        })
        return _obj
