...
class GetDiskBackup(BaseModel):
    """
    GetDiskBackup
    """
    backups: Optional[List[GetDiskBackupBackupsInner]] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetDiskBackup:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetDiskBackup:
        """Create an instance of GetDiskBackup from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetDiskBackup.model_validate(obj)

        _obj = GetDiskBackup.model_validate({
            "backups": [GetDiskBackupBackupsInner.from_dict(_item) for _item in obj.get("backups")] if obj.get("backups") is not None else None
        })
        return _obj
