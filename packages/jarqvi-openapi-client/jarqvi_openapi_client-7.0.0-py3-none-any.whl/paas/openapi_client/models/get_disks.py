...
class GetDisks(BaseModel):
    """
    GetDisks
    """
    disks: Optional[List[GetDisksDisksInner]] = None
    mounts: Optional[List[GetDisksMountsInner]] = None
    __properties: ClassVar[List[str]] = ["disks", "mounts"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetDisks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetDisks:
        """Create an instance of GetDisks from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetDisks.model_validate(obj)

        _obj = GetDisks.model_validate({
            "disks": [GetDisksDisksInner.from_dict(_item) for _item in obj.get("disks")] if obj.get("disks") is not None else None,
            "mounts": [GetDisksMountsInner.from_dict(_item) for _item in obj.get("mounts")] if obj.get("mounts") is not None else None
        })
        return _obj
