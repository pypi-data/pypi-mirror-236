...
class RedirectDomainRequest(BaseModel):
    """
    RedirectDomainRequest
    """
    redirect_status: Union[StrictFloat, StrictInt] = Field(description="302 or 301", alias="redirectStatus")
    redirect_to: StrictStr = Field(alias="redirectTo")
    __properties: ClassVar[List[str]] = ["redirectStatus", "redirectTo"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedirectDomainRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedirectDomainRequest:
        """Create an instance of RedirectDomainRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedirectDomainRequest.model_validate(obj)

        _obj = RedirectDomainRequest.model_validate({
