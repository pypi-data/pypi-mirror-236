...
class Keys(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["status", "keys"]
    ...
    def from_dict(cls, obj: dict) -> Keys:
        ...
        if not isinstance(obj, dict):
            return Keys.model_validate(obj)

        _obj = Keys.model_validate({
            "status": obj.get("status"),
            "keys": [Key.from_dict(_item) for _item in obj.get("keys")] if obj.get("keys") is not None else None
        })
        return _obj
