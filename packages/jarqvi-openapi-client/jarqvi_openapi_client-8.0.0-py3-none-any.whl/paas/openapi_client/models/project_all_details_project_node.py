...
class ProjectAllDetailsProjectNode(BaseModel):
    """
    The node of project  # noqa: E501
    """
    id: Optional[StrictStr] = Field(default=None, alias="_id")
    ip: Optional[StrictStr] = Field(default=None, alias="IP")
    __properties: ClassVar[List[str]] = ["_id", "IP"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProjectAllDetailsProjectNode:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProjectAllDetailsProjectNode:
        """Create an instance of ProjectAllDetailsProjectNode from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProjectAllDetailsProjectNode.model_validate(obj)

        _obj = ProjectAllDetailsProjectNode.model_validate({
            "_id": obj.get("_id"),
            "IP": obj.get("IP")
        })
        return _obj
