...
class TurnAppRequest(BaseModel):
    """
    TurnAppRequest
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TurnAppRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TurnAppRequest:
        """Create an instance of TurnAppRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TurnAppRequest.model_validate(obj)

        _obj = TurnAppRequest.model_validate({
            "scale": obj.get("scale")
        })
        return _obj
