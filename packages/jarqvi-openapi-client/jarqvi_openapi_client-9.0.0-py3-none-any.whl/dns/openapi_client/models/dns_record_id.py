...
class DnsRecordId(BaseModel):
    """
    DnsRecordId
    """
    id: Optional[StrictStr] = Field(default=None, description="The id of dns record which need in PUT, DELETE and GET method")
    ...
    type: Optional[StrictStr] = Field(default=None, description="The type of dns record, valid values: [A, AAAA, TXT, CNAME, ALIAS, MX, SRV, CAA]")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "type", "ttl", "contents"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DnsRecordId:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DnsRecordId:
        """Create an instance of DnsRecordId from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DnsRecordId.model_validate(obj)

        _obj = DnsRecordId.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "type": obj.get("type"),
            "ttl": obj.get("ttl"),
