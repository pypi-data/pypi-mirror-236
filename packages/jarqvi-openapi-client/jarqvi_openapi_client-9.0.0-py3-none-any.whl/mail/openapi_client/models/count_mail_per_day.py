...
class CountMailPerDay(BaseModel):
    """
    CountMailPerDay
    """
    status: Optional[StrictStr] = None
    data: Optional[CountMailPerDayData] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CountMailPerDay:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CountMailPerDay:
        """Create an instance of CountMailPerDay from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CountMailPerDay.model_validate(obj)

        _obj = CountMailPerDay.model_validate({
            "status": obj.get("status"),
            "data": CountMailPerDayData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
