...
class MailServers(BaseModel):
    ...
    data: Optional[MailServersData] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MailServers:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MailServers:
        """Create an instance of MailServers from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MailServers.model_validate(obj)

        _obj = MailServers.model_validate({
            "status": obj.get("status"),
            "data": MailServersData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
