...
class GetFtps200Response(BaseModel):
    """
    GetFtps200Response
    """
    accesses: Optional[List[GetFtps200ResponseAccessesInner]] = None
    host: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["accesses", "host"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetFtps200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetFtps200Response:
        """Create an instance of GetFtps200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetFtps200Response.model_validate(obj)

        _obj = GetFtps200Response.model_validate({
            "accesses": [GetFtps200ResponseAccessesInner.from_dict(_item) for _item in obj.get("accesses")] if obj.get("accesses") is not None else None,
            "host": obj.get("host")
        })
        return _obj
