...
class UpdateEnvs200Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateEnvs200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateEnvs200Response:
        """Create an instance of UpdateEnvs200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateEnvs200Response.model_validate(obj)

        _obj = UpdateEnvs200Response.model_validate({
