...
def occupiedVolume(atoms, dl=0.12):
    ...
    # select points in central box with some border layer in neigbor boxes
    # we need the neigbor points that the Voronoi can calc all volumes using neigbor points over box planes
...
class scatteringUniverse(MDAnalysis.Universe):
    ...
    def __init__(self, *args, **kwargs):
        ...
        assignTypes : dict
            ...
            before above assignement ( {'from_names':1} ).
        ...
        Parameters refering to solvent describe the embeding continuous solvent outside.
        ...
        Explicit solvent is in most cases simulated as protonated while neutron scattering expriments are
        ...
        These attributes are used during scattering calculations.
        ...
        **mutable Universe attributes** :
        ...
        - solvent :
            Continous solvent embeding the atoms/universe.  Saved in attribut uni.solvent.
        ...
        - amideHexFract : float 0..1
            Exchangable fraction of backbone amide -NH hydrogens
        ...
        **Fixed attributes**
        ...
        ::
         ...
         uni2 = js.bio.scatteringUniverse('3rnr_h.pdb',addHydrogen=False)
         uni2.view()
