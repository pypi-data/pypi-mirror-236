...
class JunoConfig(UserDict):
    def __init__(self):
        ...
        if os.path.exists('_project.yml') and not os.path.exists('project.yml'):
            shutil.copy('_project.yml', 'project.yml')
        
        if os.path.exists('_config.json') and not os.path.exists('config.json'):
