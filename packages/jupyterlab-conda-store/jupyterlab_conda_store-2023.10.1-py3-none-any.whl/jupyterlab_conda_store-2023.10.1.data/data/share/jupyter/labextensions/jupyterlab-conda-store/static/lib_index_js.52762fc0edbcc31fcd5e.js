...
/***/ "./style/icon/conda-store-notext-logo-greenaccent.svg":
/*!************************************************************!*\
  !*** ./style/icon/conda-store-notext-logo-greenaccent.svg ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const plugin = {
    ...
    requires: [_jupyterlab_settingregistry__WEBPACK_IMPORTED_MODULE_0__.ISettingRegistry, _jupyterlab_mainmenu__WEBPACK_IMPORTED_MODULE_1__.IMainMenu]
};
// eslint-disable-next-line @typescript-eslint/explicit-module-boundary-types
async function activate(app, settingRegistry, mainMenu) {
    var _a;
    ...
    // Initialize widget
    let widget;
    let condaStoreExtension;
    try {
        settings = await settingRegistry.load(plugin.id);
        const addCustomMenuItem = (_a = settings === null || settings === void 0 ? void 0 : settings.composite.addMainMenuItem) !== null && _a !== void 0 ? _a : true;
        const command = 'condastore:open';
        app.commands.addCommand(command, {
            label: 'Conda Store Package Manager',
            execute: () => {
                if (!widget || widget.isDisposed) {
                    condaStoreExtension = new _widget__WEBPACK_IMPORTED_MODULE_4__.CondaStoreWidget(settings);
                    widget = new _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_2__.MainAreaWidget({ content: condaStoreExtension });
                    widget.id = 'jp-conda-store';
                    widget.title.label = 'conda-store';
                    widget.title.caption = 'conda-store extension';
                    widget.title.icon =
                        (settings === null || settings === void 0 ? void 0 : settings.composite.styleType) === 'grayscale'
                            ? _style__WEBPACK_IMPORTED_MODULE_5__.condaStoreNotextIcon
                            : _style__WEBPACK_IMPORTED_MODULE_5__.condaStoreNotextIconGreenAccent;
        ...
        if (addCustomMenuItem) {
            const condaStoreMenu = new _lumino_widgets__WEBPACK_IMPORTED_MODULE_3__.Menu({ commands: app.commands });
...
/* harmony export */   "condaStoreNotextIconGreenAccent": () => (/* binding */ condaStoreNotextIconGreenAccent)
/* harmony export */ });
...
/* harmony import */ var _style_icon_conda_store_notext_logo_greenaccent_svg__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../style/icon/conda-store-notext-logo-greenaccent.svg */ "./style/icon/conda-store-notext-logo-greenaccent.svg");
...
const condaStoreNotextIconGreenAccent = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_0__.LabIcon({
    name: 'conda-store:conda-store-notext-icon-greenaccent',
    svgstr: _style_icon_conda_store_notext_logo_greenaccent_svg__WEBPACK_IMPORTED_MODULE_3__["default"]
});
...
//# sourceMappingURL=lib_index_js.52762fc0edbcc31fcd5e.js.map