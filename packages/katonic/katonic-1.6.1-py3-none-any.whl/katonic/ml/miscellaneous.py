...
class LogModel(MLClient):
    ...
    def __log_keras_model(self) -> None:
        ...
        """
        with mlflow.start_run(run_name="keras-model") as run:
    ...
    def __log_sklearn_model(self) -> None:
        ...
        """
        with mlflow.start_run(run_name="scikit-learn-model") as run:
            self.set_model_tags(run.info.run_uuid)
    ...
    def __log_custom_model(self) -> None:
        ...
        """
        with mlflow.start_run(run_name="custom-model") as run:
            self.set_model_tags(run.info.run_uuid)
