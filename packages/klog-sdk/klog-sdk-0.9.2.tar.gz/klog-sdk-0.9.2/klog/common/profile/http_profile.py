...
class HttpProfile(object):
    ...
    def __init__(self, protocol=None, endpoint=None, reqMethod="POST", reqTimeout=60,
        ...
        """HTTP profile.
        :param protocol: khttp or https, default is https.
        :type protocol: str
        :param endpoint: The domain to access, like: iam.api.klog.com.com
        :type endpoint: str
        :param reqMethod: the khttp method, valid choice: GET, POST
        :type reqMethod: str
        :param reqTimeout: The khttp timeout in second.
        :type reqTimeout: int
        :param rootDomain: The root domain to access, like: api.klog.com.
        :type rootDomain: str
        """
        ...
        self.proxy = proxy
        self.rootDomain = "api.klog.com" if rootDomain is None else rootDomain
