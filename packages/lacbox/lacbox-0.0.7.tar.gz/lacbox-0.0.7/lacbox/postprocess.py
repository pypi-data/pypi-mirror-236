...
def process_statistics(res_dir, save_path, calc_del=True,
    ...
    save_path : str or pathlib.Path
        Path to the HDF5 file, saved using `df.to_hdf()`. Table is saved under key
        `stats_df`.
    ...
    print(f'\n{len(res_paths)} HDF5 files to process.\n')
    ...
    print(f'\nResults saved to stats_df key in file "{str(save_path)}".\n')
