...
namespace COL
{
    ...
    class Pgm2
    {
        static void Main(string[] args)
        {
            ...
            COL c3 = new COL(w, h);
            Console.WriteLine("Enter the Previous Reading, Current Reading, and Unit price to calculate EB Bill ");
...
namespace ConsoleApp5
{
    ...
    class SBI : FD
    {
        ...
        public override void calculate()
        {
            ...
            else if (y > 2 && y <= 5)
            {
                ...
                i = p * y * r / 100;
                Console.WriteLine("Interest you have earned is " + i);
                Console.println("Fixed Deposit amount is " + (i + p));
            }
            if (y > 5)
            {
                r = 8;
    ...
    class UBI : FD
    {
        public UBI() { Console.WriteLine("Welcome to Union Bank of India: FD Scheme"); }
        public void get()
        {
            Console.WriteLine("\n Enter Principle Amount : ");
            p = Convert.ToInt32(Console.ReadLine());
    ...
    class FixedDeposit
    {
        ...
        {
            string bn;
            Console.WriteLine("Enter the Bank in which you want to make a FD: SBI OR UBI");
            bn = Console.ReadLine();
            if (bn.Equals("SBI"))
            {
                SBI sbi = new SBI();
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:ListBox ID="menu" runat="server" AutoPostBack="True" OnSelectedIndexChanged="menu_SelectedIndexChanged">
        ...
        <asp:ListBox ID="item" runat="server" AutoPostBack="True" OnSelectedIndexChanged="item_SelectedIndexChanged"></asp:ListBox><br />
        <asp:Label ID="l3" runat="server" Text="Quantity"></asp:Label>
        <asp:TextBox ID="txtquantity" runat="server" AutoPostBack="True" OnTextChanged="txtquantity_TextChanged"></asp:TextBox><br />
...
def p7():
    g = """
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Client1.aspx.cs" Inherits="ASPAppplication1.Client1" %>
<!DOCTYPE html>
