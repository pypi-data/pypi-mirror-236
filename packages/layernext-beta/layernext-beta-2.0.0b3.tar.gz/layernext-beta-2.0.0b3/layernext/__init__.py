...
class LayerNextClient:
    ...
    def auto_tag_collection(self, collection_id, model_id, input_resolution=(300, 300)):
        _automatic_analysis_client = automatic_analysis.AutomaticAnalysisClient(
            self.encoded_key_secret, self.layernext_url)
    ...
    def generate_auto_tags_to_metalake(self, item_type,  model_id, input_resolution=(300, 300)):
        _automatic_analysis_client = automatic_analysis.AutomaticAnalysisClient(
            self.encoded_key_secret, self.layernext_url)
