...
class StringLogger(logging.Logger):
    ...
    # Used via BaseRequest.capture_logger()

    # format = '%(levelname)s: %(message)s'
    format = '%(message)s'

    def __init__(self, level):
        super().__init__("StringLogger", level)
...
class BaseRequest(object):
    ...
    def capture_logger(self, level=logging.INFO):
        ...
        try:
            ...
            # root logger.
            self.logger = StringLogger(level)
            yield self.logger
    ...
    # def start_log_capture(self, level):
    #     self.logger = StringLogger(level)
    #
    # def end_log_capture(self):
    #     self.logger.streamer.flush()
    #     rv = self.logger.streamer.getvalue()
    #     self.logger = logger # restore default value
    #     return rv
