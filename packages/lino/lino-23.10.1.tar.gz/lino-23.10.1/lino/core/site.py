    ...
    *within* the framework.
    ...
    def setup_logging(self):
        ...
        if len(logging.root.handlers) > 0:
            # # Don't configure logging again. This can happen when Site is
            # # instantiated a second time.
            # return

            # Logging has been configured by some previous process. But we don't
            # care, we want to restart configuration from scratch.
