...
default interval given by every_unit and every_value."""),
    ...
    'lino.modlib.linod.BackgroundTask.name' : _("""Some name for this job rule."""),
    'lino.modlib.linod.BackgroundTask.procedure' : _("""The pointer to an instance of Procedure."""),
    'lino.modlib.linod.BackgroundTask.cancelled' : _("""Tells whether the task should be ignored."""),
    'lino.modlib.linod.BackgroundTask.log_level' : _("""Tells what sort of messeages to put into the Job.message field."""),
    ...
    'lino.modlib.linod.Job.rule' : _("""A pointer to an instance of BackgroundTask which describes the nature of the task."""),
