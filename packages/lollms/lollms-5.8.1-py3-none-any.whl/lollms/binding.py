...
class LLMBinding:
    ...
    def __init__(
        ...
        if models_dir_name is not None:
            self.models_folder = config.lollms_paths.personal_models_path / models_dir_name
        else:
    ...
    def get_model_path(self):
        ...
        if self.config.model_name.endswith(".reference"):
            ...
            file_path = self.models_folder/self.config.model_name
            if file_path.exists():
            ...
            model_path = Path(self.models_folder/self.config.model_name)
    ...
    def list_models(self, config:dict):
        ...
        """
        models_dir = self.models_folder  # replace with the actual path to the models folder
