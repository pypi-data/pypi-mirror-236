...
tests = [
    {
        "calendar": ["20231018", "20231118"],
        "observations": [
            {"id": "obs-1", "lst_start": 8.15, "lst_end": 11.5},
            {"id": "obs-2", "lst_start": 1, "lst_end": 8},
            {
                "id": "obs-3",
                "lst_start": 22,
                "lst_end": 22.5,
...
def print_intervals(observation_id, intervals):
    """fn"""
    print()
    print(f"{observation_id} :: CANDIDATE INTERVALS")
...
def test_observations(test):
    ...
    calendar = generate_calendar(calendar_start, calendar_end)
    idx = create_idx(
        [
            {
    ...
    for observation in observations:
        ...
        print_intervals(observation_id, filtered_intervals)
