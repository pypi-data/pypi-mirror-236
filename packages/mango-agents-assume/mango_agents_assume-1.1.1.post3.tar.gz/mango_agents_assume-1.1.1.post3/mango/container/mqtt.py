...
from mango.container.external_coupling import ext_mirror_container_creator

logger = logging.getLogger(__name__)


def mqtt_mirror_container_creator(container, 
...
class MQTTContainer(Container):
    ...
    def as_agent_process(
        ...
        return super().as_agent_process(
            ...
            mirror_container_creator=mirror_container_creator # partial(mqtt_mirror_container_creator, self),
        )
