...
for normalized_ans, possible_answers in text_type_answers.items():
    dict_text_normalized.update({ans: normalized_ans for ans in possible_answers})
...
for normalized_ans, possible_answers in symbol_type_answers.items():
    dict_symbol_normalized.update({ans: normalized_ans for ans in possible_answers})
