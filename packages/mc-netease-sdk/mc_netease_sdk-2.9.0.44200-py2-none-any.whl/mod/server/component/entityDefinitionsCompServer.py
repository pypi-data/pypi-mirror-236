...
class EntityDefinitionsCompServer(BaseComponent):
    ...
    def GetMobStrengthMax(self):
        # type: () -> int
        """
        获取生物的强度，截止至网易2.9版本，只对羊驼有效，强度越大羊驼驮运的箱子时格子数量越多，SetStrength无法超过strengthMax的值
        """
        pass
    ...
    def SetMobStrengthMax(self, strength):
        # type: (int) -> bool
        """
        设置生物的强度，截止至网易2.9版本，只对羊驼有效，强度越大羊驼驮运的箱子时格子数量越多，SetStrength无法超过strengthMax的值
        """
        pass
