...
def best_cost_stacked(config, dataframe, option_manager):
    ...
    folder = info['path'] + '/' + info['name']
    
    if not os.path.exists(folder):
        os.makedirs(folder)

    fig.write_image(folder + "/best_cost_stacked.png", width=1280, height=720)
    fig.write_html(folder + "/best_cost_stacked.html", include_plotlyjs='cdn', auto_open=False)
    with open(folder + "/best_cost_stacked.html", "r") as f:
        html = f.read()
        html = html.replace("<body>", "<body bgcolor='#2a2a2a'>")
    with open(folder + "/best_cost_stacked.html", "w") as f:
        f.write(html)
...
def table(config, dataframe, option_manager):
    ...
    fig.write_image(folder + "/table.png", width=1280, height=720)
    fig.write_html(folder + "/table.html", include_plotlyjs='cdn', auto_open=False)
    with open(folder + "/table.html", "r") as f:
        html = f.read()
        html = html.replace("<body>", "<body bgcolor='#2a2a2a'>")
    with open(folder + "/table.html", "w") as f:
        f.write(html)
...
def best_cost_by_round(config, dataframe, option_manager):
    ...
    fig.write_image(folder + "/best_cost_by_round.png", width=1280, height=720)
    fig.write_html(folder + "/best_cost_by_round.html", include_plotlyjs='cdn', auto_open=False)
    with open(folder + "/best_cost_by_round.html", "r") as f:
        html = f.read()
        html = html.replace("<body>", "<body bgcolor='#2a2a2a'>")
    with open(folder + "/best_cost_by_round.html", "w") as f:
        f.write(html)
...
def calibrated_params_by_round(config, list_of_objs, option_manager):
    ...
    fig.write_image(folder + "/calibrated_params_by_round.png", width=1280, height=720)
    fig.write_html(folder + "/calibrated_params_by_round.html", include_plotlyjs='cdn', auto_open=False)
    with open(folder + "/calibrated_params_by_round.html", "r") as f:
        html = f.read()
        html = html.replace("<body>", "<body bgcolor='#2a2a2a'>")
    with open(folder + "/calibrated_params_by_round.html", "w") as f:
        f.write(html)
