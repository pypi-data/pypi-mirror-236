...
class TestAcuSim(unittest.TestCase):
    ...
    def test_tracking_table(self):
        ...
        self.assertTrue(pd.api.types.is_string_dtype(df['acu.azimuth.state']))
        self.assertTrue(pd.api.types.is_string_dtype(df['acu.elevation.state']))
        self.assertTrue(pd.api.types.is_string_dtype(df['acu.feed_indexer.state']))
        self.assertTrue(pd.api.types.is_string_dtype(df['acu.general_management_and_controller.state']))
