...
def log_model(
    ...
    try:
        ...
        print("DEBUG: MAIN LOG FAILED, USING BACKUP!" )
        succ, inferred_signature = _maybe_unpack_and_save_model(
            spark_model,
...
def save_model(
    ...
    if not signature:
        signature = _unpack_and_save_model(spark_model, tmp_path)
    ...
    try:
        ...
        if isinstance(spark_model, PipelineModel):
            ...
            try:
                ...
                signature = infer_signature("Init", spark_model.predict("Init"))
