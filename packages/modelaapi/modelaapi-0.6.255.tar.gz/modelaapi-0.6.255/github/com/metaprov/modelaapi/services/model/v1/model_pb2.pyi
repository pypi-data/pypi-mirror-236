...
class PreviewScoreRequest(_message.Message):
    ...
    def __init__(self, snapshot: _Optional[_Union[_generated_pb2_1.DatasetSnapshot, _Mapping]] = ..., pipelines: _Optional[_Iterable[_Union[_generated_pb2.FeatureEngineeringPipeline, _Mapping]]] = ..., estimator: _Optional[str] = ..., metric: _Optional[str] = ..., rows: _Optional[str] = ..., client: _Optional[str] = ...) -> None: ...
