...
class APIUser(BaseModel):
    ...
    APIUser
    """
    token: Union[StrictBytes, StrictStr] = Field(...)
    __properties = ["token"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> APIUser:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> APIUser:
        """Create an instance of APIUser from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return APIUser.parse_obj(obj)

        _obj = APIUser.parse_obj({
            "token": obj.get("token")
        })
        return _obj
