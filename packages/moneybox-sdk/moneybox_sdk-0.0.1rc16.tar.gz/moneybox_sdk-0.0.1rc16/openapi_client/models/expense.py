...
class Expense(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Expense:
    ...
    def from_dict(cls, obj: dict) -> Expense:
        ...
        if not isinstance(obj, dict):
            return Expense.parse_obj(obj)

        _obj = Expense.parse_obj({
            "id": obj.get("id"),
