...
class PatchedTransfer(BaseModel):
    """
    PatchedTransfer
    """
    ...
    amount: Optional[constr(strict=True)] = Field(None, description="The amount of money transferred.")
    comment: Optional[constr(strict=True, max_length=255)] = Field(None, description="Additional comment about the transfer (optional).")
    from_wallet: Optional[StrictInt] = Field(None, description="The wallet from which the transfer is made.")
    to_wallet: Optional[StrictInt] = Field(None, description="The wallet to which the transfer is made.")
    created_by: Optional[StrictInt] = Field(None, description="The user who made the transfer.")
    group: Optional[StrictInt] = Field(None, description="The group to which the transfer belongs.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedTransfer:
        """Create an instance of PatchedTransfer from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedTransfer:
        """Create an instance of PatchedTransfer from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedTransfer.parse_obj(obj)

        _obj = PatchedTransfer.parse_obj({
            "id": obj.get("id"),
