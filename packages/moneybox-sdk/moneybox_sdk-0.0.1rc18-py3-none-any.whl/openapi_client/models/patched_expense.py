...
class PatchedExpense(BaseModel):
    """
    PatchedExpense
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedExpense:
        """Create an instance of PatchedExpense from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedExpense:
        """Create an instance of PatchedExpense from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedExpense.parse_obj(obj)

        _obj = PatchedExpense.parse_obj({
            "id": obj.get("id"),
