...
from openapi_client.models.paginated_expense_list import PaginatedExpenseList  # noqa: E501
...
class TestPaginatedExpenseList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaginatedExpenseList:
        """Test PaginatedExpenseList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedExpenseList`
        """
