...
query testAgentReachability($agentId: UUID!) {
  testAgentReachability(agentId: $agentId) {
    success
    validationName
    description
    errors{
...
mutation upgradeAgent($agentId: UUID!, $image: String!, $traceId: String, $timeout: Int) {
  upgradeAgent(agentId: $agentId, image: $image, traceId: $traceId, timeout: $timeout) {
    upgradeResult
  }
}
"""
