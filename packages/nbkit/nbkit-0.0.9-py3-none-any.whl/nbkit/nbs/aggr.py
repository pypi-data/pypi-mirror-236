...
class NotebookAggregator:
    ...
    Methods
    -------
    next(path: str, name: Optional[str] = None, maximum: bool = False, pad: int = 2) -> int:
        Class method. Get the next available notebook number in a given directory.
        
    aggr(path: str, name: Optional[str] = None, prefix: Optional[str] = None, 
        add_prefix: bool = True, prefix_dir: Optional[str] = None, output: Optional[str] = None, 
        ignore: Optional[List[str]] = None, maximum: bool = False, pad: int = 2) -> NotebookNode:
    ...
    >>> )
    '''
    path: Optional[str] = field(default_factory=os.getcwd, metadata={'help': 
        'The path to the directory containing the notebooks to be aggregated.'
    })

    name: Optional[str] = field(default=None, metadata={'help': 
        'The name of the nbdev module. Defaults to the basename of the file specified in path.'
    })

    prefix: Optional[str] = field(default=None, repr=False, metadata={'help': (
    ...
    add_prefix: Optional[bool] = field(default=True, repr=False, metadata={'help': (
             'Whether or not to add a prefix to the notebook file name.'
    )})

    prefix_dir: Optional[str] = field(default=None, repr=False, metadata={'help': (
        'The directory to use for the determining the prefix number if different than the dirname of `path`.'
    )})

    output: Optional[str] = field(default=None, metadata={'help': (
        'The output filename. This will be autogenerated if `None`.'
    )})

    ignore: Optional[List[str]] = field(default_factory=list, repr=False, metadata={'help': (
        'A list of file basenames to ignore in the `path` directory.'
    )})

    maximum: Optional[bool] = field(default=False, repr=False, metadata={'help': (
    ...
    pad: Optional[int] = field(default=2, repr=False, metadata={'help': (
    ...
    @classmethod
    def next(cls, path: str, name: Optional[str] = None, maximum: bool = False, pad: int = 2) -> int:
    ...
    def aggr(
        ...
        prefix: Optional[str] = None, add_prefix: bool = True, prefix_dir: Optional[str] = None, 
        output: Optional[str] = None, ignore: Optional[List[str]] = None, maximum: bool = False, pad: int = 2
    ) -> NotebookNode:
    ...
    def make_output_name(self, 
        module: str, dirname: Optional[str] = '',  
        prefix: Optional[str] = None, add_prefix: Optional[bool] = True, prefix_dir: Optional[str] = None, 
    ...
    def get_prefix(self, path: Optional[str] = None, name: Optional[str] = None, maximum: bool = False, pad: int = 2):
        '''Get the next available notebook number in a given directory.
