...
class SubjectOnDiskTrialPass():
    ...
    def computeValuesFromForcePlates(self, skel: nimblephysics_libs._nimblephysics.dynamics.Skeleton, timestep: float, poses: numpy.ndarray[numpy.float64, _Shape[m, n]], footBodyNames: list[str], forcePlates: list[ForcePlate], rootHistoryLen: int = 5, rootHistoryStride: int = 1) -> None: ...
    def getAccs(self) -> numpy.ndarray[numpy.float64, _Shape[m, n]]: ...
