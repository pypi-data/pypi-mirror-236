...
__all__ = ['DIR', 'LOC', 'SRC', 'BASE', 'DEST', 'FILE', 'PATH', 'ROOT', 'NODE', 'ROOT_DIR', 'NBS', 'FIG', 'IMG', 'RES', 'DATA',
           ...
           'HEAD', 'TAIL', 'PBCOPY', 'SYMLINK', 'HARDLINK', 'METADATA', 'CORE', 'FLDR', 'LEAF', 'REST', 'EntryType',
           'OSType', 'PathLibType']
...
# %% ../nbs/50_path.ipynb 16
NT = 'nt'
POSIX = 'posix'
WINDOWS = 'windows'

# %% ../nbs/50_path.ipynb 18
