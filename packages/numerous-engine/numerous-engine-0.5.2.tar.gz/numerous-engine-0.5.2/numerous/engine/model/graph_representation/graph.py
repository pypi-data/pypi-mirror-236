...
class Node:
    def __init__(self, key=None, ao=None, file=None, name=None, ln=None,
        ...
        self.node_n = -1
        self.max_edge_per_node_counter = 0
        self.ctx = ctx
...
class Graph:
    ...
    def add_edge(self, edge: Edge):
        ...
        self.edge_counter += 1
        self.nodes[edge.start].max_edge_per_node_counter += 1
        self.nodes[edge.end].max_edge_per_node_counter += 1
        self.max_edge_per_node_counter = max([self.nodes[edge.start].max_edge_per_node_counter,
                                              self.nodes[edge.end].max_edge_per_node_counter,
                                             self.max_edge_per_node_counter])
    ...
    def make_lower_graph(self, top_sort=False):
        self.lower_graph = _Graph(self.max_edge_per_node_counter+1,
                                  self.node_counter,
