...
class Secret(o7lib.aws.base.Base):
    ...
    def display_secret(self):
        ...
        Table(
            ...
            [ {'Key': key, 'Value': value}  for key , value in self.secret_details.get("VersionIdsToStages", []).items()]
        ).print()
        print()
    ...
    def menu_secret(self, index):
        ...
        obj = o7m.Menu( exit_option = 'b', title='Secret Details', title_extra=self.session_info(), compact=False)

        obj.add_option(o7m.Option(key='r', name='Display Raw Data',callback=lambda: pprint.pprint(self.secret_details)))
        obj.add_option(o7m.Option(key='c', name='View Current Value', callback=lambda: self.view_secret('AWSCURRENT')))
        obj.add_option(o7m.Option(key='p', name='View Previous Value',callback=lambda: self.view_secret('AWSPREVIOUS')))
    ...
    def menu_secrets(self):
        ...
        obj = o7m.Menu(exit_option = 'b', title='Secrets', title_extra=self.session_info(), compact=False)
