...
class FindIntersectionResponseItem2(BaseModel):
    ...
    id: Optional[Any] = Field(None, description="Any value that was set by a client request in the 'id' field.")
...
class NextBlock(BaseModel):
    ...
    jsonrpc: Jsonrpc
    method: Method4
    id: Optional[Any] = Field(None, description='An arbitrary JSON value that will be mirrored back in the response.')
...
class Transaction(BaseModel):
    ...
    cbor: constr(regex=r'^[0-9a-f]+$') = Field(..., description='CBOR-serialized signed transaction (base16)')
...
class AcquireLedgerStateFailure(BaseModel):
    ...
    jsonrpc: Jsonrpc
    method: Method14
    error: Error2 = Field(..., description='Unable to acquire the ledger state at the request point.')
    id: Optional[Any] = Field(None, description="Any value that was set by a client request in the 'id' field.")
...
class QueryLedgerStateUnavailableInCurrentEra(BaseModel):
    ...
    jsonrpc: Jsonrpc
    method: Method19
    error: Error4 = Field(..., description='Some query is not available for the requested ledger era.')
    id: Optional[Any] = Field(None, description="Any value that was set by a client request in the 'id' field.")
...
class QueryLedgerStateAcquiredExpire(BaseModel):
    ...
    jsonrpc: Jsonrpc
    method: Method19
    error: Error5 = Field(..., description='Previously acquired ledger state is no longer available.')
    id: Optional[Any] = Field(None, description="Any value that was set by a client request in the 'id' field.")
...
class MustAcquireMempoolFirst(BaseModel):
    ...
    jsonrpc: Jsonrpc
    method: Method57
    error: Error6 = Field(..., description='Must acquire a mempool snapshot prior to performing any query.')
    id: Optional[Any] = Field(None, description="Any value that was set by a client request in the 'id' field.")
...
class Error7(BaseModel):
    ...
    code: conint(ge=-32700, le=-32000) = Field(..., description='An error code telling about the nature of the error.')
    message: Optional[str] = Field(None, description='A descriptive error message giving hints about the error.')
...
class Slot(BaseModel):
    __root__: conint(ge=0, le=18446744073709552000) = Field(..., description='An absolute slot number.', title='Slot')
...
class AssetQuantity(BaseModel):
    __root__: int = Field(
        ..., description='A number of asset, can be negative went burning assets.', title='AssetQuantity'
    )
...
class BlockHeight(BaseModel):
    __root__: conint(ge=0, le=18446744073709552999) = Field(
        ..., description='A block number, the i-th block to be minted is number i.', title='BlockHeight'
    )
...
class BootstrapProtocolId(BaseModel):
    __root__: conint(ge=0, le=4294967295) = Field(..., examples=[764824073], title='BootstrapProtocolId')


class Ratio(BaseModel):
    __root__: constr(regex=r'^-?[0-9]+/[0-9]+$') = Field(
        ..., description='A ratio of two integers, to express exact fractions.', examples=['2/3', '7/8'], title='Ratio'
    )
...
class ChainCode(BaseModel):
    __root__: str = Field(..., description='An Ed25519-BIP32 chain-code for key deriviation.', title='ChainCode')
...
class DelegateRepresentative(BaseModel):
    __root__: Union[DelegateRepresentativeItem, DelegateRepresentativeItem1, DelegateRepresentativeItem2] = Field(
...
class TransactionId(BaseModel):
    __root__: constr(min_length=64, max_length=64) = Field(
        ..., description='A Blake2b 32-byte hash digest of a transaction body', title='TransactionId'
    )
...
class GovernanceVoter(BaseModel):
    __root__: Union[GovernanceVoterItem, GovernanceVoterItem1, GovernanceVoterItem2, GovernanceVoterItem3]
...
class RedeemerPointer(BaseModel):
    __root__: constr(regex=r'^(spend|mint|certificate|withdrawal):[0-9]+$') = Field(..., title='RedeemerPointer')
...
class Signature(BaseModel):
    __root__: constr(min_length=128, max_length=128) = Field(..., description='An EdDSA signature.', title='Signature')
...
class AnyStakeCredential(BaseModel):
    __root__: Union[
        constr(min_length=56, max_length=56), constr(regex=r'^(stake_vkh|script)1[0-9a-z]*$'), StakeAddress
...
class StakePoolSummary(BaseModel):
    ...
    parameters: Parameters = Field(..., description='Some of the pool parameters relevant for the reward calculation.')
...
class AcquireLedgerStateFailureModel(BaseModel):
    ...
    jsonrpc: Jsonrpc
    method: Method65
    error: Error8 = Field(..., description='Unable to acquire the ledger state at the request point.')
    id: Optional[Any] = Field(None, description="Any value that was set by a client request in the 'id' field.")
...
class QueryLedgerStateUnavailableInCurrentEraModel(BaseModel):
    ...
    jsonrpc: Jsonrpc
    method: Method66
    error: Error10 = Field(..., description='Some query is not available for the requested ledger era.')
    id: Optional[Any] = Field(None, description="Any value that was set by a client request in the 'id' field.")
...
class QueryLedgerStateAcquiredExpireModel(BaseModel):
    ...
    jsonrpc: Jsonrpc
    method: Method66
    error: Error11 = Field(..., description='Previously acquired ledger state is no longer available.')
    id: Optional[Any] = Field(None, description="Any value that was set by a client request in the 'id' field.")
...
class MustAcquireMempoolFirstModel(BaseModel):
    ...
    jsonrpc: Jsonrpc
    method: Method69
    error: Error12 = Field(..., description='Must acquire a mempool snapshot prior to performing any query.')
    id: Optional[Any] = Field(None, description="Any value that was set by a client request in the 'id' field.")
...
class RewardsProvenance(BaseModel):
    ...
    totalRewardsInEpoch: TotalRewardsInEpoch = Field(..., description='Total rewards available for the given epoch.')
...
class ScriptPurpose(BaseModel):
    __root__: Union[ScriptPurposeItem, ScriptPurposeItem1, ScriptPurposeItem2, ScriptPurposeItem3] = Field(
        ..., title='ScriptPurpose'
    )
...
class Ogmios(BaseModel):
    ...
    NextBlock: NextBlock = Field(
        ..., description="Request next block from the current cardano-node's cursor.", title='NextBlock'
    )
    ...
    SubmitTransaction: SubmitTransaction = Field(
        ..., description='Submit a signed and serialized transaction to the network.', title='SubmitTransaction'
    )
    SubmitTransactionResponse: Union[
        SubmitTransactionResponseItem, SubmitTransactionResponseItem1, SubmitTransactionResponseItem2
    ]
    ...
    EvaluateTransactionResponse: Union[
        EvaluateTransactionResponseItem, EvaluateTransactionResponseItem1, EvaluateTransactionResponseItem2
    ]
    AcquireLedgerState: AcquireLedgerState = Field(
        ..., description='Acquire a point on chain from which to run ledger-state queries.', title='AcquireLedgerState'
    )
    AcquireLedgerStateFailure: Optional[AcquireLedgerStateFailure] = Field(None, title='AcquireLedgerStateFailure')
    AcquireLedgerStateResponse: Union[AcquireLedgerStateResponseItem, AcquireLedgerStateFailureModel]
    ...
    ReleaseLedgerStateResponse: ReleaseLedgerStateResponse = Field(
        ..., description="Response to a 'releaseLedgerState' request.", title='ReleaseLedgerStateResponse'
    )
    QueryLedgerStateEraMismatch: Optional[QueryLedgerStateEraMismatchModel] = Field(
        None, title='QueryLedgerStateEraMismatch'
    )
    QueryLedgerStateUnavailableInCurrentEra: Optional[QueryLedgerStateUnavailableInCurrentEra] = Field(
        None, title='QueryLedgerStateUnavailableInCurrentEra'
    )
    ...
    QueryLedgerStateEpoch: QueryLedgerStateEpoch = Field(
        ..., description='Query the current epoch number the ledger is at.', title='QueryLedgerStateEpoch'
    )
    ...
    QueryLedgerStateEraStart: QueryLedgerStateEraStart = Field(
        ..., description='Query the start of the current ledger era.', title='QueryLedgerStateEraStart'
    )
    ...
    QueryLedgerStateProtocolParameters: QueryLedgerStateProtocolParameters = Field(
        ..., description='Query the current protocol parameters.', title='QueryLedgerStateProtocolParameters'
    )
    ...
    QueryNetworkBlockHeight: QueryNetworkBlockHeight = Field(
        ..., description='Query the network’s highest block number.', title='QueryNetworkBlockHeight'
    )
    ...
    QueryNetworkGenesisConfiguration: QueryNetworkGenesisConfiguration = Field(
        ..., description='Query the genesis configuration of a given era.', title='QueryNetworkGenesisConfiguration'
    )
    ...
    QueryNetworkStartTimeResponse: QueryNetworkStartTimeResponse = Field(..., title='QueryNetworkStartTimeResponse')
    ...
    NextTransaction: NextTransaction = Field(
        ..., description='Request the next transaction from an acquired mempools napshot.', title='NextTransaction'
    )
    MustAcquireMempoolFirst: Optional[MustAcquireMempoolFirst] = Field(None, title='MustAcquireMempoolFirst')
    ...
    SizeOfMempool: SizeOfMempool = Field(
        ..., description='Get size and capacities of the mempool (acquired snapshot).', title='SizeOfMempool'
    )
    SizeOfMempoolResponse: Optional[Union[SizeOfMempoolResponseItem, MustAcquireMempoolFirstModel]] = None
    ...
    RpcError: RpcError = Field(
        ...
        examples=[{'jsonrpc': '2.0', 'error': {'message': 'Invalid request: invalid query.', 'code': '-32601'}}],
        title='RpcError',
    )
...
class ScriptNative(BaseModel):
    __root__: Union[
        ScriptNativeItem, ScriptNativeItem1, ScriptNativeItem2, ScriptNativeItem3, ScriptNativeItem4, ScriptNativeItem5
    ] = Field(
        ...,
...
class TransactionModel(BaseModel):
    ...
    cbor: Optional[str] = Field(None, description='The raw serialized (CBOR) transaction, as found on-chain.')
