...
def upload(
    ...
    uploader = PluginUploader(snowflake_connection=snowflake_connection.ctx)
    ...
    packager = NativeAppPackaging(
        snowflake_connection=snowflake_connection.ctx,
...
def register(
    ...
    """
    snowflake_connection = connect_to_snowflake(connection_name=environment)
    registerer = PluginRegistration(snowflake_connection=snowflake_connection.ctx)
