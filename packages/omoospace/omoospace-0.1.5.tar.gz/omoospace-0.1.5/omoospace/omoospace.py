...
from omoospace.package import Package, PackageProfile
from omoospace.subspace import SubspaceTree, SubspaceProfile
from omoospace.common import console, yaml
from omoospace.ui import Board, Info, ItemList, Table
from omoospace.utils import format_name, replace_or_append, reveal_in_explorer, is_subpath, PathLike, copy_to_path
from omoospace.types import Creator, Entity, Item, Software, Structure, Work
...
class OmoospaceProfile(TypedDict):
    name: str
    description: str
