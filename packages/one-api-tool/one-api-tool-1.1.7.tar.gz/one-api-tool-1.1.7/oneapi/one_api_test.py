...
if __name__ == "__main__":
   ...
   tool = OneAPITool.from_config(api_key="", api_base="http://10.0.0.135:8080", api_type="custom")
   ...
   print(tool._preprocess_custom_prompt(msg))
   res = tool.chat(msg, stream=True, max_new_tokens=1024)
   print(res)
   for i in res:
        print(i)
