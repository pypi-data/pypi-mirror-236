...
class OneAPITool():
    ...
    def from_config_file(cls, config_file):
        ...
        if api_type == "claude":
            ...
            return cls(HuggingfaceClient(HuggingFaceMethod(api_key=config["api_key"], api_base=config["api_base"])))
        else:
    ...
    def from_config(cls, api_key, api_base, api_type, api_version="2023-07-01-preview"):
        if api_type == "claude":
            ...
            return cls(HuggingfaceClient(HuggingFaceMethod(api_key=api_key, api_base=api_base)))
        else:
