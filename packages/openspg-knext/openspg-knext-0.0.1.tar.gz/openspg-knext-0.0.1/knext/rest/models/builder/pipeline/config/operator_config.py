...
class OperatorConfig(object):
    ...
    def __init__(self, name=None, version=None, jar_address=None, main_class=None, lang_type=None, operator_type=None, params=None, local_vars_configuration=None):  # noqa: E501
