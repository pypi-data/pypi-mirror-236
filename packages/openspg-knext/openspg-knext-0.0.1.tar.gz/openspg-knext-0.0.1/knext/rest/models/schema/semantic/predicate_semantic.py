...
class PredicateSemantic(object):
    ...
    def __init__(self, ontology_enum=None, project_id=None, ontology_id=None, alter_operation=None, ext_info=None, subject_type_ref=None, predicate=None, object_type_ref=None, local_vars_configuration=None):  # noqa: E501
