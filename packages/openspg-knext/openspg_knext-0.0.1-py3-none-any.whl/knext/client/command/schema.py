...
def diff_schema():
    ...
    schema_path = os.path.join(
        os.environ["KNEXT_ROOT_PATH"], os.environ["KNEXT_SCHEMA_DIR"], os.environ["KNEXT_SCHEMA_FILE"]
    )
...
def commit_schema():
    ...
    if is_altered:
        ...
        click.secho("There is no diff between local and server-side schema.", fg="bright_yellow")
