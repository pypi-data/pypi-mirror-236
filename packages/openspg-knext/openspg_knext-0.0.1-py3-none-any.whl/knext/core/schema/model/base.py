...
class BaseProperty(ABC):
    ...
    def object_type_name_zh(self, object_type_name_zh):
    ...
    def object_spg_type(self) -> Optional[SpgTypeEnum]:
        ...
        return (
            SpgTypeEnum(self._rest_model.object_type_ref.spg_type_enum)
            if spg_type_enum
            else None
        )
    ...
    def property_group(self) -> Optional[PropertyGroupEnum]:
        ...
        return (
            PropertyGroupEnum(self._rest_model.advanced_config.property_group)
            if property_group
            else None
        )
    ...
    def alter_operation(self):
        ...
        return self._rest_model.alter_operation
...
class BaseSpgType(ABC):
    _rest_model: Union[rest.ConceptType, rest.EntityType, rest.EventType, rest.StandardType]
    ...
    def spg_type_enum(self) -> SpgTypeEnum:
        ...
        return SpgTypeEnum(self._rest_model.spg_type_enum) if spg_type_enum else None
    ...
    @staticmethod
    def by_type_enum(type_enum):
        import knext
        class_obj = getattr(knext.core.schema.model.spg_type, f"{SpgTypeEnum(type_enum).name}Type")
        return class_obj
