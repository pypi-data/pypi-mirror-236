...
class MappingNodeConfig(object):
    ...
    def __init__(self, type='MAPPING', spg_name=None, mapping_type=None, mapping_filters=None, mapping_schemas=None, mapping_configs=None, local_vars_configuration=None):  # noqa: E501
