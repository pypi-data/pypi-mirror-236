...
class ReasonerJobInst(object):
    ...
    def __init__(self, job_id=None, project_id=None, start_time=None, end_time=None, log_info=None, progress=None, result=None, job_inst_id=None, status=None, external_job_inst_id=None, local_vars_configuration=None):  # noqa: E501
