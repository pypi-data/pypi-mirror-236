...
class RemoveLogicalCausationRequest(object):
    ...
    def __init__(self, subject_concept_type_name=None, subject_concept_name=None, predicate_name=None, object_concept_type_name=None, object_concept_name=None, local_vars_configuration=None):  # noqa: E501
