...
class TemporalSolver:
    ...
    **discr_params : keywords
    ...
    def get_current_PVgradP_interp(self):
        ...
        P_interp_loc = [t_pipe.get_P_interp() for k, t_pipe in enumerate(self.t_pipes_sorted)]
        V_interp_loc = [t_pipe.get_V_interp() for k, t_pipe in enumerate(self.t_pipes_sorted)]
        gradP_interp_loc = [t_pipe.get_gradP_interp() for k, t_pipe in enumerate(self.t_pipes_sorted)]
