...
class TemporalReed1dof(TemporalComponentExit):
    ...
    def one_step(self):
        ...
        (Sr, Mr, g, omega02, w, y0, epsilon, p_m, omega_nl, alpha_nl) = self.reed1dof.get_dimensionfull_values(self.t, self.Zc, self.rho)
    ...
    def energy(self):
        ...
        (Sr, mr, g, omega02, w, y0, epsilon, p_m, omega_nl, nl_exp) = self.reed1dof.get_dimensionfull_values(self.t, self.Zc, self.rho)
