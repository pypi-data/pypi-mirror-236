...
class ErrorDict:
    ...
    @classmethod
    def set(cls, error_key: str, estimator_str: str, error_data: EstimatorErrorInfo | List[EstimatorErrorInfo]):
...
class DefaultArgsDict:
    ...
    _default_args_dict: Dict = dict()

    @classmethod
    def get(cls, estimator_str, param=None):
        return (
