...
class ComponentService:
    ...
    def __init__(
        ...
        *,
        ...
        log_file_path : Optional[str] = None
            Path to log file. If None, no log file will be created and messages will be printed to console, given that verbose > 0.
        ...
        self.categorical_features_pca_variance_threshold = categorical_features_pca_variance_threshold
    ...
    def initialize(
        ...
        end_to_end_pipe, X_preprocessed = _create_preprocessing_pipeline(
            ...
            categorical_features_pca_variance_threshold=self.categorical_features_pca_variance_threshold,
        )
    ...
    def _scoring_base_models(self, name, model, X_test, y_test, cv_obj, scoring, verbose, n_jobs) -> np.ndarray | None:
        try:
    ...
    def optimize_estimator_list(
        ...
        logger.notice(
            f"Optimized estimator list order results in seconds:\n{results.to_string()}",
        )
