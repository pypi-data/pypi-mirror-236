...
@trace(eval_funcs_names=["Is equal"], eval_funcs=[friendliness, usefulness])
...
@trace(eval_funcs_names=["Is equal"], eval_funcs=[goal_success_ratio], access_output_of_func=lambda x: x[0])
def unhelpful_chat():
