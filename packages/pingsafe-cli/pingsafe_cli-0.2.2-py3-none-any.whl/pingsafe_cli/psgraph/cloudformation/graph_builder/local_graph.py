...
from pingsafe_cli.psgraph.cloudformation.graph_builder.graph_components.block_types import BlockType
from pingsafe_cli.psgraph.cloudformation.graph_builder.graph_components.blocks import CloudformationBlock
from pingsafe_cli.psgraph.cloudformation.graph_builder.utils import GLOBALS_RESOURCE_TYPE_MAP
from pingsafe_cli.psgraph.cloudformation.graph_builder.variable_rendering.renderer import CloudformationVariableRenderer
from pingsafe_cli.psgraph.cloudformation.parser.cfn_keywords import IntrinsicFunctions, ConditionFunctions, ResourceAttributes, \
    TemplateSections
...
from pingsafe_cli.psgraph.common.graph.graph_builder.local_graph import LocalGraph
from pingsafe_cli.psgraph.common.util.consts import START_LINE, END_LINE
from pingsafe_cli.psgraph.common.util.data_structures_utils import search_deep_keys
from pingsafe_cli.psgraph.cloudformation.graph_builder.graph_components.generic_resource_encryption import ENCRYPTION_BY_RESOURCE_TYPE
