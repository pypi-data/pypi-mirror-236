...
from pingsafe_cli.psgraph.common.parsers.json.decoder import SimpleDecoder
from pingsafe_cli.psgraph.common.parsers.node import StrNode, DictNode, ListNode
from pingsafe_cli.psgraph.common.util.consts import MAX_IAC_FILE_SIZE
...
class CfnParseError(ConstructorError):
    ...
    def __init__(self, filename: str, message: str, line_number: int, column_number: int) -> None:
        ...
        # Now for your custom codescanner...
    ...
    if file_path.suffix == ".json":
        ...
        if file_size > MAX_IAC_FILE_SIZE:
            ...
            logging.info(
                ...
                "This limit can be adjusted via the environment variable 'PINGSAFE_MAX_IAC_FILE_SIZE'."
            )
