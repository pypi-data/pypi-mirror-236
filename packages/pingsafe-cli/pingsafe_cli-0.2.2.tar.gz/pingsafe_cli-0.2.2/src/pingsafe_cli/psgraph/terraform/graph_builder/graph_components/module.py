...
from pingsafe_cli.psgraph.common.util.parser_utils import get_abs_path, get_module_from_full_path
from pingsafe_cli.psgraph.terraform.checks.utils.dependency_path_handler import unify_dependency_path
from pingsafe_cli.psgraph.terraform.graph_builder.graph_components.block_types import BlockType
from pingsafe_cli.psgraph.terraform.graph_builder.graph_components.blocks import TerraformBlock
from pingsafe_cli.psgraph.terraform.parser_functions import handle_dynamic_values
...
class Module:
    def __init__(
        ...
        self.render_dynamic_blocks_env_var = os.getenv('PINGSAFE_RENDER_DYNAMIC_MODULES', 'True')
        self.enable_nested_modules = strtobool(os.getenv('PINGSAFE_ENABLE_NESTED_MODULES', 'True'))
        self.use_new_tf_parser = strtobool(os.getenv('PINGSAFE_NEW_TF_PARSER', 'False'))
