...
class Device(_message.Message):
    __slots__ = ["native_id", "integration_type", "outlet_index", "gateway_id"]
    ...
    outlet_index: int
    gateway_id: str
    def __init__(self, native_id: _Optional[str] = ..., integration_type: _Optional[_Union[Device.IntegrationType, str]] = ..., outlet_index: _Optional[int] = ..., gateway_id: _Optional[str] = ...) -> None: ...
