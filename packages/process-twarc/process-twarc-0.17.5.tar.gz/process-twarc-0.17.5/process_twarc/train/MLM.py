...
from modules.util import load_datasets, init_run, reinit_run, get_sampler, configure_dropout, check_if_complete, get_optimizers, complete_trial, get_callbacks, print_parameters
import torch
import optuna
...
def initiate_trial(
    ...
    def objective(trial):
        ...
        parameters, trial_checkpoint, trial_complete, training_args, model = init_run(trial, config, AutoModelForMaskedLM)
