...
from utils.web.django.swagger import ResponseType, ResponseSchema, ParamsTypes
...
class SwaggerTypeBase(metaclass=ABCMeta):
    ...
    def response(self, properties: Optional[Dict[str, Schema]] = None) -> Dict[Union[str, int], Schema]:
        return {
            200: ResponseType().success(properties=properties),
