...
def approximate_cost(test_cases, method, prompts_value, model_test='gpt-3.5-turbo', model_test_max_tokens=1000, number_of_prompts=4, model_generation='gpt-4', model_generation_max_tokens=500, iterations=0, functions=None, prompt_change=None, model_iteration=None, model_iteration_max_tokens=None, best_prompts=None, model_embedding=None):
