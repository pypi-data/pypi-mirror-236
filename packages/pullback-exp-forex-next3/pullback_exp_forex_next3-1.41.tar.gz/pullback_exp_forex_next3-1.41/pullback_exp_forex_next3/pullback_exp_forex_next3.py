                                ...
                                #  print("status_trade:" , status_trade)
                                 ...
                                 if status_trade == True:
                                    ...
                                    #  print("shakhes: True" )
                                         ...
                                         point = mt5.symbol_info(Pullback().symbol_EURUSD).point
                                         tp = point_high - (shakhes * point)
                                         tp = Pullback.decimal(tp , Pullback().decimal_sambol)
                                         tp = float(tp)

                                         rec_pos = BUY_SELL.pos_sell(tp , lot , self.symbol_EURUSD , commands)
                                         execution = rec_pos.comment
                                         if execution == 'Request executed':
                                                ticket =  rec_pos.order
                                                # print("rec_pos:" , rec_pos)
