...
from hs.common.pb.common.constant.NotifyMsgType_pb2 import OrderDepthBookerFullMsgType, NotifyMsgType
...
PB_NOTIFY_CLASS_LIST = [
    StatisticsV2Notify,  # 行情推送
    OrderBookFullV2Notify,  # 买卖档推送\美股深度摆盘-ARCABOOK\TOTALVIEW 买卖档推送, 沙股MBO买卖档推送
