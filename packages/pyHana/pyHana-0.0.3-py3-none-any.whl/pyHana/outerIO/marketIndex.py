...
indexList = {
    ...
    'CD금리(91일)' : ['IRR_CD91',  '금리',     2, 'PC', 'BS', '%'], 
    '콜금리(1일)' :  ['IRR_CALL',  '금리',     2, 'PC', 'BS', '%'], 
    '국고채(3년)' :  ['IRR_GOVT03Y','금리',    2, 'PC', 'BS', '%'], 
    '회사채(3년)' :  ['IRR_CORP03Y','금리',    2, 'PC', 'BS', '%'], 
    'COFIX잔액' :    ['IRR_COFIXBAL','금리',    2, 'PC', 'BS', '%'], 
    'COFIX신규' :    ['IRR_COFIXNEW','금리',    2, 'PC', 'BS', '%'], 
...
urlDict = {
    'PC' : {
            ...
            '금리'     : "/interestDailyQuote.naver?marketindexCd={}&page={}",
    },
    '모바일' : {
