...
class PyDSP():
    ...
    def __init__(self, config_file="", protein_seqs=None, **kwargs):
        ...
        self.use_dsp = kwargs.get('use_dsp') if 'use_dsp' in kwargs else self.dsp_parameters["use_dsp"]
        ...
        self.window_type = kwargs.get('window_type') if 'window_type' in kwargs else self.window_parameters["type"]
        self.window = None
        self.filter_parameters = kwargs.get('filter_parameters') if 'filter_parameters' in kwargs else self.dsp_parameters["filter"]
        self.filter_type = kwargs.get('filter_type') if 'filter_type' in kwargs else self.filter_parameters["type"]
        self.filter = None
