...
def check_finetune_type(args_dict):
    ...
    full_not_support_mdoels = [Model.alpaca, Model.chinese_alpaca,Model.chinese_alpaca_2,Model.chinese_alpaca_2_13b,
                               Model.vicuna, Model.baichuan_13b, Model.moss_moon_003_base, Model.xverse_13b, Model.ziya_llama_13b]
