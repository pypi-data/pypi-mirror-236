...
class Signal:
    ...
    def __init__(self, samplerate: float, signal: Union[np.ndarray[np.float64], np.ndarray[np.int16]], beacon_frequency: Optional[float] = None):
    ...
    def clean(self):
        ...
        self.data = np.clip(self.data - corrected_beacon, -1, 1)
