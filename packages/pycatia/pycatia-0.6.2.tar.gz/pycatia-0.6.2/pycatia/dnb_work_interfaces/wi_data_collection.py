...
class WIDataCollection(WIText):
    ...
    def __init__(self, com_object):
        ...
        self.wi_data_collection = com_object
    ...
    def set_parameters_list(self, i_list_of_parameters: tuple) -> None:
        ...
        # # vba_code = """
        # # Public Function set_parameters_list(wi_data_collection)
        # #     Dim iListOfParameters (2)
        # #     wi_data_collection.SetParametersList iListOfParameters
    ...
    def __repr__(self):
        return f'WIDataCollection(name="{self.name}")'
