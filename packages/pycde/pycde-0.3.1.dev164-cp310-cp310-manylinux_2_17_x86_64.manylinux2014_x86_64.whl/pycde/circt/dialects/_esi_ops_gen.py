...
def service_req_inout(to_client, service_port, to_server, client_name_path, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(RequestInOutChannelOp(toClient=to_client, servicePort=service_port, toServer=to_server, clientNamePath=client_name_path, loc=loc, ip=ip))
...
def service_inout(inner_sym, to_server_type, to_client_type, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ServiceDeclInOutOp(inner_sym=inner_sym, toServerType=to_server_type, toClientType=to_client_type, loc=loc, ip=ip))
...
def service_hierarchy_metadata(server_name_path, impl_type, clients, *, service_symbol=None, impl_details=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ServiceHierarchyMetadataOp(serverNamePath=server_name_path, impl_type=impl_type, clients=clients, service_symbol=service_symbol, impl_details=impl_details, loc=loc, ip=ip))
