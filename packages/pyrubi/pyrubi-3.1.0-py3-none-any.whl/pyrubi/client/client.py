...
class Client(object):
    ...
    def upload_avatar(self, object_guid:str, main_file:str and bytes, thumbnail_file:str and bytes=None) -> dict:
    ...
    def send_file(self, object_guid:str, file:str and bytes, message_id:str=None, text:str=None, file_name:str=None) -> dict:
        return self.methods.sendFile(objectGuid=object_guid, file=file, text=text, messageId=message_id, fileName=file_name)
    
    def send_image(self, object_guid:str, file:str and bytes, message_id:str=None, text:str=None, file_name:str=None) -> dict:
        return self.methods.sendImage(objectGuid=object_guid, file=file, text=text, messageId=message_id, fileName=file_name)
    
    def send_video(self, object_guid:str, file:str and bytes, message_id:str=None, text:str=None, file_name:str=None) -> dict:
        return self.methods.sendVideo(objectGuid=object_guid, file=file, text=text, messageId=message_id, fileName=file_name)
    
    def send_gif(self, object_guid:str, file:str and bytes, message_id:str=None, text:str=None, file_name:str=None) -> dict:
        return self.methods.sendGif(objectGuid=object_guid, file=file, text=text, messageId=message_id, fileName=file_name)
    
    def send_music(self, object_guid:str, file:str and bytes, message_id:str=None, text:str=None, file_name:str=None) -> dict:
        return self.methods.sendMusic(objectGuid=object_guid, file=file, text=text, messageId=message_id, fileName=file_name)
    
    def send_voice(self, object_guid:str, file:str and bytes, message_id:str=None, text:str=None, file_name:str=None) -> dict:
