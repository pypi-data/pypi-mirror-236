...
class Methods:
    ...
    def uploadAvatar(self, objectGuid:str, mainFile:str and bytes, thumbnailFile:str and bytes) -> dict:
    ...
    def baseSendFileInline(self, objectGuid:str, file:str and bytes, text:str, messageId:str, fileName:str, type:dict) -> dict:
        ...
        if type in ["Music", "Voice"]:
            input["file_inline"]["time"] = Tools.getVoiceDuration(uploadData["file"])
    ...
    def sendFile(self, objectGuid:str, file:str and bytes, messageId:str, text:str, fileName:str) -> dict:
    ...
    def sendImage(self, objectGuid:str, file:str and bytes, messageId:str, text:str, fileName:str) -> dict:
        return self.baseSendFileInline(
            objectGuid=objectGuid,
            file=file,
            text=text,
    ...
    def sendVideo(self, objectGuid:str, file:str and bytes, messageId:str, text:str, fileName:str) -> dict:
        return self.baseSendFileInline(
            objectGuid=objectGuid,
            file=file,
            text=text,
    ...
    def sendGif(self, objectGuid:str, file:str and bytes, messageId:str, text:str, fileName:str) -> dict:
        return self.baseSendFileInline(
            objectGuid=objectGuid,
            file=file,
            text=text,
    ...
    def sendMusic(self, objectGuid:str, file:str and bytes, messageId:str, text:str, fileName:str) -> dict:
        return self.baseSendFileInline(
            objectGuid=objectGuid,
            file=file,
            text=text,
    ...
    def sendVoice(self, objectGuid:str, file:str and bytes, messageId:str, text:str, fileName:str) -> dict:
        return self.baseSendFileInline(
            objectGuid=objectGuid,
            file=file,
            text=text,
