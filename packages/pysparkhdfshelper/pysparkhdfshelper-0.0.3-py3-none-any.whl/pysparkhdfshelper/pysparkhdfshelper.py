...
class PySparkHdfsHelper(LogClsHelper):
    ...
    def walk_non_recursive(cls, parent_dir = '/'):
        ...
        print(f'#end# walk_non_recursive {parent_dir, len(dirs), len(files)}', end = '\r')
    ...
    def rename(cls, src_path, dst_path):
        ...
        res = cls.jhfs().get(cls.jhconf()).rename(cls.jhpath()(src_path), cls.jhpath()(dst_path))
    ...
    def mkdir(cls, path):
        ...
        cls.logger().debug(f'#ens# mkdir {path, res}')
