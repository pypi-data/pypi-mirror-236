...
from pytest_atf_allure.utils import allure_description, allure_description_html
from pytest_atf_allure.utils import allure_labels, allure_links, pytest_markers
from pytest_atf_allure.utils import allure_full_name, allure_package, allure_name
from pytest_atf_allure.utils import allure_suite_labels
from pytest_atf_allure.utils import get_status, get_status_details
from pytest_atf_allure.utils import get_outcome_status, get_outcome_status_details
from pytest_atf_allure.utils import get_pytest_report_status
from pytest_atf_allure.utils import format_allure_link
from pytest_atf_allure.utils import get_history_id
...
class AllureListener:
    ...
    def start_step(self, uuid, title, params):
        ...
        logging.info(f"[Step] {title}, params: {dict(params)}")
