...
def mask_seq(seqs: Tensor, vaild_lens: Tensor, mask_value=0.0) -> Tensor:
    ...
    #                      for vaild_len in vaild_lens], device=seqs.device)
    # # 把零元素都换成屏蔽元素的值
...
class TransformerEncoder(nn.Module):
    ...
    def __init__(self, vocab_size, num_hiddens, num_lays, num_heads, normalized_shape, ffn_num_hiddens, dropout, use_bias=False):
