...
if __name__ == '__main__':
    ...
    target_video = os.path.join("images", "video", "origin.mp4")
    origin_video = os.path.join("images", "video", "target.mp4")
    ...
    quick_v = QuickVerifyVideo(verify_engine_list, 0.8, crop_place=crop_place, background_similar=0.99, auto_crop=False, background_path=back)
