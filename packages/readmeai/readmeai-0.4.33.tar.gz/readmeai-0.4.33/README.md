...
Additionally, you can run the readme-ai in offline mode, or without an API key. This option is useful for spinning up a quick baseline template that still contains your repository metadata.
