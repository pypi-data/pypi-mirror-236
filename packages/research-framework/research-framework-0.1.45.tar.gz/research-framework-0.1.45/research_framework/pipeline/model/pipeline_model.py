...
class PLGridSearchInputFilterModel(FilterModel):
    name: str
    
    
class PLGridSearchFilterModel(BaseModel):
    clazz: str
    params: Dict[str, List[Any]]
    overwrite: Optional[bool] = None
    params: Dict[str, Any]
...
class PipelineGridSearch(BaseModel):
    ...
    name: str
    train_input: PLGridSearchInputFilterModel
    test_input: PLGridSearchInputFilterModel
    filters: List[PLGridSearchFilterModel]
    metrics: Optional[List[MetricModel]] = None
    params: Optional[Dict[str, Any]] = None
    scoring: Optional[str] = None
