...
from rhino_health.lib.metrics.basic import Count
from rhino_health.lib.metrics.metric_calculations import METRIC_CALCULATION_STEPS_MAPPING
...
class ProjectFutureEndpoints(ProjectEndpoints):
    ...
    def aggregate_cohort_metric(
        ...
        metric_config_mapping = METRIC_CALCULATION_STEPS_MAPPING.get(
            metric_configuration.metric_name(), METRIC_CALCULATION_STEPS_MAPPING["default"]
        )
        data_cache = {}
        for step_function in metric_config_mapping["Steps"]:
            step_function(
