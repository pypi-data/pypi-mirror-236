...
@lru_cache(maxsize=1)
def get_domain_id():
    return _watched_resource_metadata_file.get_key("DomainId")


@lru_cache(maxsize=1)
def get_user_profile_name():
    return _watched_resource_metadata_file.get_key("UserProfileName")
...
@lru_cache(maxsize=1)
def get_space_name():
    return _watched_resource_metadata_file.get_key("SpaceName")
