...
const ResourceUsageComponent: FC<ResourceUsageComponentProps> = ({
  ...
  return (
    <div className={`${instanceMetricsClassNames.widgetContainer} ${styles.RemoteStatusContainer}`}>
      <div
      ...
      >
        ...
        {instanceMetricsDisplayValue === undefined ? (
          <LinearProgress className={styles.StatusBarProgressBarContainerStyle} />
        ) : (
          <div className={styles.ResourceWidgetConatiner}>
            <LinearProgress
      ...
      {openMetricWindow && (
        <div className={`${instanceMetricsClassNames.metricsContainer} ${styles.MetricsWindowStyle}`}>
