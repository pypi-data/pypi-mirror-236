...
import schedule_service_client.models
from schedule_service_client import rest
from schedule_service_client.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(schedule_service_client.models, klass)
