...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[264], {
    ...
    33264: function(e, t, n) {
        ...
        var p = n(34388)
          , l = n(49674)
          , f = window.__shootpandora_base + "/api"
          , g = ["cf-ipcountry"]
          , m = function() {
            function e() {
                (0,
                    ...
                    h.__generator)(this, function(h) {
                        ...
                        case 11:
                            if (null == c ? void 0 : c.type)
                                throw new l.gK((null == c ? void 0 : c.message) || c,a.status,null == c ? void 0 : c.code,null == c ? void 0 : c.type);
                            throw new l.kb;
                        case 12:
                            if (204 === a.status)
                                return [2, {}];
            ...
            e.upload = function(e, t, n, o) {
                var i = new FormData;
                return t && i.append("conversation_id", t),
                i.append("model", n),
                i.append("parent_message_id", e),
                i.append("file", o),
                this.fetch("".concat(f, "/conversation/upload"), {
                    method: "POST",
                    headers: (0,
                    s.Z)({}, this.getAuthHeader()),
                    body: i
                })
            }
            ,
            ...
            e.publicApiCompletionStream = function(e, t) {
                ...
                o.Z)(function() {
                    ...
                    h.__generator)(this, function(c) {
                        ...
                        (0,
                        u.L)("".concat(window.__shootpandora_base + "/api", "/conversation/", eps[e.completionType]), {
                            method: "POST",
                            credentials: "include",
                            headers: (0,
                            s.Z)({
            ...
            e.getAccountStatus = function(e, t) {
                ...
                return this.fetch("/api/accounts/check", {
                    method: "GET",
                    headers: n
                })
            }
