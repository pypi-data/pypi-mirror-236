 ...
 */
    ...
    89335: function(t, e, r) {
        ...
        class c extends u.l {
            ...
            onSubscribe() {
                ...
                l(this.currentQuery, this.options) && this.executeFetch(),
                this.updateTimers())
            }
            onUnsubscribe() {
            ...
            updateStaleTimeout() {
                ...
                s.PN)(this.options.staleTime))
                    return;
                let t = (0,
                s.Kp)(this.currentResult.dataUpdatedAt, this.options.staleTime);
            ...
            createResult(t, e) {
                let r = this.currentQuery, n = this.options, i = this.currentResult, u = this.currentResultState, c = this.currentResultOptions, a = t !== r, f = a ? t.state : this.currentQueryInitialState, p = a ? this.currentResult : this.previousQueryResult, {state: y} = t, {dataUpdatedAt: v, error: R, errorUpdatedAt: S, fetchStatus: b, status: m} = y, E = !1, Q = !1, g;
                ...
                if (e.keepPreviousData && !y.dataUpdatedAt && null != p && p.isSuccess && "error" !== m)
                    g = p.data,
                    v = p.dataUpdatedAt,
                    m = p.status,
                    E = !0;
                ...
                if (void 0 !== e.placeholderData && void 0 === g && "loading" === m) {
                    let w;
                    if (null != i && i.isPlaceholderData && e.placeholderData === (null == c ? void 0 : c.placeholderData))
                        w = i.data;
                    else if (w = "function" == typeof e.placeholderData ? e.placeholderData() : e.placeholderData,
                    e.select && void 0 !== w)
                        try {
                            w = e.select(w),
                            this.selectError = null
                    ...
                    void 0 !== w && (m = "success",
                    g = (0,
                    s.oE)(null == i ? void 0 : i.data, w, e),
                    Q = !0)
                }
                this.selectError && (R = this.selectError,
                g = this.selectResult,
                S = Date.now(),
                m = "error");
                let U = "fetching" === b
            ...
            updateResult(t) {
                ...
                (null == t ? void 0 : t.listeners) !== !1 && (()=>{
                    ...
                    if ("all" === t || !t && !this.trackedProps.size)
                        return !0;
            ...
            notify(t) {
                n.V.batch(()=>{
                    var e, r, s, n, i, u, o, c;
                    t.onSuccess ? (null == (e = (r = this.options).onSuccess) || e.call(r, this.currentResult.data),
                    null == (s = (n = this.options).onSettled) || s.call(n, this.currentResult.data, null)) : t.onError && (null == (i = (u = this.options).onError) || i.call(u, this.currentResult.error),
                    null == (o = (c = this.options).onSettled) || o.call(c, void 0, this.currentResult.error)),
    ...
    60112: function(t, e, r) {
        ...
        let i = (t,e)=>{
          ...
          , o = ({result: t, errorResetBoundary: e, useErrorBoundary: r, query: s})=>t.isError && !e.isReset() && !t.isFetching && (0,
        n.L)(r, [t.error, s])
    },
    ...
    52696: function(t, e, r) {
        ...
        function h(t, e) {
            ...
            f._optimisticResults = h ? "isRestoring" : "optimistic",
            f.onError && (f.onError = i.V.batchCalls(f.onError)),
            f.onSuccess && (f.onSuccess = i.V.batchCalls(f.onSuccess)),
            f.onSettled && (f.onSettled = i.V.batchCalls(f.onSettled)),
            (0,
            a.Fb)(f),
            (0,
            l.pf)(f, d),
            (0,
            l.JN)(d);
            let[p] = s.useState(()=>new e(r,f))
              , y = p.getOptimisticResult(f);
            if ((0,
            n.$)(s.useCallback(t=>h ? ()=>void 0 : p.subscribe(i.V.batchCalls(t)), [p, h]), ()=>p.getCurrentResult(), ()=>p.getCurrentResult()),
            s.useEffect(()=>{
                p.setOptions(f, {
                    listeners: !1
                })
