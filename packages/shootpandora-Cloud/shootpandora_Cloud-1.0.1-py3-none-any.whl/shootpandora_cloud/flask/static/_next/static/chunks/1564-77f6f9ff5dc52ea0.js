"use strict";
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[1564], {
    61564: function(e, t, a) {
        ...
        function P(e) {
            ...
            h.useEffect)(function() {
                ...
                r && function e(t, n, o, i) {
                    g.current = w(function() {
                        if (n.length !== o.length) {
                            var a = n + o.slice(t, t + i);
                            m(a),
                            null == u || u(),
                            e(t + i, a, o, i)
                        }
            ...
            s.jsx)("span", {
                className: (0,
                l.default)("whitespace-pre-wrap", p.length < o.length && "result-streaming", "dark" === y ? "dark" : "light"),
                children: (0,
                s.jsx)("span", {
                    children: p
                })
        ...
        function x() {
            var e = (0,
            r._)(["w-full h-full overflow-auto"]);
            return x = function() {
                return e
            }
            ,
        ...
        function G() {
            var e = (0,
            r._)(["flex w-full max-w-lg mx-auto shrink-0 flex-col gap-6 overflow-auto px-6 pt-20 lg:w-3/5 lg:px-14 lg:pt-32 lg:max-w-none"]);
            return G = function() {
                return e
            }
            ,
        ...
        function j() {
            var e = (0,
            r._)(["absolute bottom-0 w-full lg:w-auto lg:relative flex flex-grow items-center justify-center bg-white rounded-t-xl lg:rounded-none transition-transform\n", ""]);
            return j = function() {
                return e
            }
            ,
        ...
        function I() {
            ...
            T.Z)()
              , G = (0,
            h.useRef)(E[Math.floor(Math.random() * E.length)])
              , j = (0,
            i._)((0,
            h.useState)(!1), 2)
              , I = j[0]
            ...
            h.useCallback)(function(e) {
                ...
                var t = e.target
                  , a = g()(t.email.value);
                L(!0),
                w.ZP.getLoginLink(a).catch(function(e) {
                    C.m.forError(e)
                }).finally(function() {
                    L(!1),
                    W(!0)
                    ...
                    s.jsx)(N, {
                        ...
                        s.jsxs)("div", {
                            ...
                            s.jsxs)("button", {
                                ...
                                s.jsx)(u.bTu, {
                                    className: (0,
                                    l.default)("icon-lg absolute right-0 top-0", !B && "rotate-180")
                                })]
                            }), (0,
                            s.jsxs)("div", {
                                    ...
                                    s.jsxs)("div", {
                                        ...
                                        s.jsx)("div", {
                                            ...
                                            s.jsx)("input", {
                                                ...
                                                id: "email",
                                                className: (0,
                                                l.default)("form-input block w-full rounded-none rounded-l-md border-gray-300 focus:border-green-500 focus:ring-green-500 sm:text-sm", {
                                                    "opacity-50": I
                                                }),
                                                required: !0,
                                                disabled: I,
                                                placeholder: e.formatMessage(_.emailPlaceholder)
                                            })
                                        }), (0,
                                        s.jsxs)(k.z, {
                                            as: "button",
        ...
        f.vU)({
            title: {
                ...
                description: "Title indicating that ChatGPT is currently at capacity"
            },
            getNotified: {
                id: "CapacityGate.getNotified",
                defaultMessage: "Get notified when we're back",
                description: "Link text for users to get notified when ChatGPT is available again"
            },
            chatGPTPlus: {
                id: "CapacityGate.chatGPTPlus",
                defaultMessage: "ChatGPT Plus subscriber login",
                description: "Title for the ChatGPT Plus subscriber login section"
            },
            allSet: {
                id: "CapacityGate.allSet",
                defaultMessage: "You're all set! If you're a {chatGPTPlus} subscriber, check your email for a login link.",
                description: "Message indicating that the user has successfully requested a login link"
            },
            addEmail: {
                id: "CapacityGate.addEmail",
                defaultMessage: "Add your email for a personalized login link",
                description: "Instructions to add email for a personalized login link"
            },
            searchCandidates: {
            ...
            sendLink: {
                ...
                description: "Button text for sending the login link"
            },
            sent: {
                id: "CapacityGate.sent",
                defaultMessage: "Sent!",
                description: "Message indicating that the login link has been sent"
            },
            notSubscriber: {
                id: "CapacityGate.notSubscriber",
                defaultMessage: "Not a {chatGPTPlus} subscriber yet? Join the <waitlist>waitlist</waitlist>.",
                description: "Message for users who are not ChatGPT Plus subscribers, prompting them to join the waitlist"
            },
            waitlist: {
                id: "CapacityGate.waitlist",
                defaultMessage: "waitlist",
                description: "Link text for the waitlist"
            }
        })
          , E = [{
    ...
    21817: function(e, t, a) {
        ...
        function o() {
            ...
            n.useRef)([])
              , t = (0,
            n.useRef)(function(t, a) {
                var n = setTimeout(t, a);
                return e.current.push(n),
                n
            });
            return (0,
