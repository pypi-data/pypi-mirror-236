...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[667], {
    16266: function(t, e, n) {
        var r = n(70079);
        let i = r.forwardRef(function({title: t, titleId: e, ...n}, i) {
 ...
 */
                ...
                return function t(e, n, r, i) {
                    ...
                    return new Proxy(o,{
                        ...
                        get: (e,n,r)=>ej(e, n, ()=>(function(e, n, r) {
                            let {_proxy: i, _context: o, _subProxy: a, _descriptors: l} = e
                              , u = i[n];
                            return tr(u) && l.isScriptable(n) && (u = function(t, e, n, r) {
                                let {_proxy: i, _context: o, _subProxy: a, _stack: l} = n;
                                if (l.has(t))
                                    throw Error("Recursion detected: " + Array.from(l).join("->") + "->" + t);
                                l.add(t);
                                let u = e(o, a || r);
                                return l.delete(t),
                                eC(t, u) && (u = eI(i._scopes, i, t, u)),
                                u
                            }(n, u, e, r)),
                            Y(u) && u.length && (u = function(e, n, r, i) {
                                let {_proxy: o, _context: a, _subProxy: l, _descriptors: u} = r;
        ...
        function M(t) {
            ...
            return l !== u && (r = l - u,
            n = f > .5 ? r / (2 - l - u) : r / (l + u),
            e = 60 * (e = i === l ? (o - a) / r + (o < a ? 6 : 0) : o === l ? (a - i) / r + 2 : (i - o) / r + 4) + .5),
            [0 | e, n || 0, f]
        }
        function k(t, e, n, r) {
        ...
        class I {
            ...
            mix(t, e) {
                if (t) {
                    ...
                    n = 1 - u,
                    r.r = 255 & u * r.r + n * i.r + .5,
                    r.g = 255 & u * r.g + n * i.g + .5,
                    r.b = 255 & u * r.b + n * i.b + .5,
                    r.a = o * r.a + (1 - o) * i.a,
                    this.rgb = r
                }
                return this
 ...
 */
        ...
        let tA = (t,e,n,r)=>tI(t, n, r ? r=>{
            let i = t[r][e];
            return i < n || i === n && t[r + 1][e] === n
        }
        : r=>t[r][e] < n)
          , tW = (t,e,n)=>tI(t, n, r=>t[r][e] >= n);
        function tF(t, e, n) {
            let r = 0
              , i = t.length;
            for (; r < i && t[r] < e; )
        ...
        let tX = t=>"start" === t ? "left" : "end" === t ? "right" : "center"
          , tz = (t,e,n)=>"start" === t ? e : "end" === t ? n : (e + n) / 2
          , tq = (t,e,n,r)=>t === (r ? "left" : "right") ? n : "center" === t ? (e + n) / 2 : e;
        function tZ(t, e, n) {
            let r = e.length
              , i = 0
              , o = r;
            if (t._sorted) {
                ...
                s && (i = tC(Math.min(tA(l, u, f).lo, n ? r : tA(e, u, a.getPixelForValue(f)).lo), 0, r - 1)),
                o = h ? tC(Math.max(tA(l, a.axis, c, !0).hi + 1, n ? 0 : tA(e, u, a.getPixelForValue(c), !0).hi + 1), i, r) - i : r - i
            }
            return {
                start: i,
                count: o
        ...
        function t0(t) {
            return tG(t) ? t : new I(t)
        }
        function t1(t) {
            return tG(t) ? t : new I(t).saturate(.5).darken(.1).hexString()
        }
        ...
        let t4 = {
            ...
            numeric(t, e, n) {
                ...
                return Object.assign(u, this.options.ticks.format),
                t7(t, i, u)
            },
            logarithmic(t, e, n) {
                if (0 === t)
                ...
                return [1, 2, 3, 5, 10, 15].includes(r) || e > .8 * n.length ? t4.numeric.call(this, t, e, n) : ""
            }
        };
        var t6 = {
            formatters: t4
        ...
        function eg(t, e, n, r, i, o={}) {
            ...
            l = 0; l < f.length; ++l)
                ...
                c && (o.strokeColor && (t.strokeStyle = o.strokeColor),
        ...
        function ek(t, e) {
            ...
            r && !("" + r).match(ey) && (console.warn('Invalid font style specified: "' + r + '"'),
            r = void 0);
            let i = {
        ...
        let eR = (t,e)=>t ? t + te(e) : e
          , eC = (t,e)=>N(e) && "adapters" !== t && (null === Object.getPrototypeOf(e) || e.constructor === Object);
        function ej(t, e, n) {
        ...
        function eI(t, e, n, r) {
            ...
            return null !== f && (void 0 === a || a === n || null !== (f = eA(u, l, a, f, r))) && eP(Array.from(u), [""], o, a, ()=>(function(t, e, n) {
                let r = t._getTarget();
                e in r || (r[e] = {});
                let i = r[e];
                return Y(i) && N(n) ? n : i || {}
        ...
        function eH(t, e, n, r, i) {
            ...
            "monotone" === e.cubicInterpolationMode)
                ...
                a = t.length; o < a; ++o)
                    ...
                    }(n, l = t[o], t[Math.min(o + 1, a - (r ? 0 : 1)) % a], e.tension),
                    l.cp1x = u.previous.x,
                    l.cp1y = u.previous.y,
                    l.cp2x = u.next.x,
                    l.cp2y = u.next.y,
            ...
            e.capBezierPoints && function(t, e) {
                ...
                r = t.length; n < r; ++n)
                    ...
                    l = n < r - 1 && ef(t[n + 1], e),
                    o && (i = t[n],
                    a && (i.cp1x = eD(i.cp1x, e.left, e.right),
                    i.cp1y = eD(i.cp1y, e.top, e.bottom)),
                    l && (i.cp2x = eD(i.cp2x, e.left, e.right),
        ...
        function eJ(t, e, n, r) {
            ...
            f && !c && (c = eU(f / 2)),
            (void 0 !== e || void 0 !== n) && r && u.height && c > u.height && (f = eU(Math.floor((c = u.height) * r))),
            {
                width: f,
                height: c
            }
        ...
        function nt(t, e, n) {
            ...
            for (let t = d, n = d; t <= g; ++t)
                (i = e[t % f]).skip || (r = h(i[a])) === o || (m = s(r, l, u),
        ...
        function nn(t, e) {
            ...
            return nr(t, function(t, e, n, r) {
                ...
                for (i = e + 1; i <= n; ++i) {
                    let n = t[i % o];
                    n.skip || n.stop ? u.skip || (r = !1,
                    a.push({
                        start: e % o,
                        end: (i - 1) % o,
                        loop: r
                    }),
                    e = l = n.stop ? i : null) : (l = i,
                    u.skip && (e = i)),
                    u = n
                }
        ...
        function nr(t, e, n, r) {
            return r && r.setContext && n ? function(t, e, n, r) {
                let i = t._chart.getContext()
                  , o = ni(t.options)
                  , {_datasetIndex: a, options: {spanGaps: l}} = t
                  , u = n.length
                  , f = []
                  , c = o
                  , s = e[0].start
    ...
    25771: function(t, e, n) {
        ...
        i.forwardRef)(function(t, e) {
            let {height: n=150, width: r=300, redraw: f=!1, datasetIdKey: c, type: s, data: h, options: d, plugins: g=[], fallbackContent: p, updateMode: b, ...y} = t
              , m = (0,
            i.useRef)(null)
              , x = (0,
            i.useRef)()
              , v = ()=>{
                m.current && (x.current = new o.kL(m.current,{
                    type: s,
                    data: function(t) {
                        var e, n;
        ...
        o.kL.register(r),
        (0,
        i.forwardRef)((t,e)=>i.createElement(f, Object.assign({}, t, {
            ref: e,
            type: "bar"
        }))))
    }
