...
class Broker:
    ...
    @classmethod
    def get_object_type(cls, name):
        """
        Returns the implementations for the provided simtwin object.
        """
        return {'Geometry': geometry.Geometry,
                ...
                'Solution': simulation.Solution}[name]
    ...
    def __cmd_push__(self, command):
        ...
        type_from_client = self.__class__.get_object_type(obj_type)
