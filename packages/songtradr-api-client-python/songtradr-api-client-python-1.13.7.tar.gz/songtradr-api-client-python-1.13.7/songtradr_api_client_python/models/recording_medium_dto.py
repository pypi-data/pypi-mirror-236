...
class RecordingMediumDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["recordingPartyEntities", "genres", "languageOfPerformance", "releaseDate", "titles", "tracks", "musicalFeatures", "isrc", "tags", "spotifyId", "genrePredictions"]
