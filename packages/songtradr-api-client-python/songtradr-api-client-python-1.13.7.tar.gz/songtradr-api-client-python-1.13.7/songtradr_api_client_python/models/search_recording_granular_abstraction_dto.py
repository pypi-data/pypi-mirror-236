...
class SearchRecordingGranularAbstractionDTO(BaseModel):
    ...
    abstraction_name: StrictStr = Field(description="Current status of the recording.", alias="abstractionName")
    __properties: ClassVar[List[str]] = ["strength", "abstractionName"]

    @field_validator('abstraction_name')
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "abstractionName": obj.get("abstractionName")
        })
        return _obj
