...
class RecordingLargeDTO(BaseModel):
    ...
    tracks: Optional[List[TrackToMediumProductDTO]] = None
    ...
    __properties: ClassVar[List[str]] = ["duration", "parties", "genres", "languageOfPerformance", "titles", "tracks", "musicalFeatures", "isrc", "tags", "pline", "spotifyId", "genrePredictions"]
