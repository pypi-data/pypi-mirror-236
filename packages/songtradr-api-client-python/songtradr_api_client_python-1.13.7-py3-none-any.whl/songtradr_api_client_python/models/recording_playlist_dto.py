...
class RecordingPlaylistDTO(BaseModel):
    ...
    songtradr_track_guid: Optional[StrictStr] = Field(default=None, alias="songtradrTrackGuid")
    assigned_by_id: Optional[StrictInt] = Field(default=None, alias="assignedById")
    sequence: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["recording", "songtradrTrackGuid", "assignedById", "sequence"]
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "songtradrTrackGuid": obj.get("songtradrTrackGuid"),
            "assignedById": obj.get("assignedById"),
