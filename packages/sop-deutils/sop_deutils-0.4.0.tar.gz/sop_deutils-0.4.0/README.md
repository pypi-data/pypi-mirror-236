...
* ### [Modules usage](#modulesusage)
	1. #### [Airflow](#1)
	2. #### [GoogleSheet](#2)
		* ##### [initialize module](#21)
		* ##### [```create_spread_sheet```](#22)
		* ##### [```list_all_work_sheets```](#23)
		* ##### [```delete_work_sheet```](#24)
		* ##### [```clear_work_sheet```](#25)
		* ##### [```get_data```](#26)
		* ##### [```insert_data```](#27)
		* ##### [```update_data```](#28)
		* ##### [```remove_data```](#29)
	3. #### [MinIO](#3)
		* ##### [initialize module](#31)
		* ##### [```data_exist```](#32)
		* ##### [```get_data_value_exist```](#33)
		* ##### [```load_data```](#34)
		* ##### [```get_data```](#35)
		* ##### [```get_data_wildcard```](#36)
	4. #### [PostgreSQL](#4)
		* ##### [initialize module](#41)
		* ##### [```read_sql_file```](#42)
		* ##### [```insert_data```](#43)
		* ##### [```bulk_insert_data```](#44)
		* ##### [```upsert_data```](#45)
...
##### <a name='36'></a>3.6 ```get_data_wildcard```
...
##### <a name='44'></a>4.4 ```bulk_insert_data```
...
##### <a name='49'></a>4.9 ```select_distinct```
...
##### <a name='413'></a>4.13 ```create_table```
