        ...
        for user_persona_manager in user_persona_managers:
            if not evaluation_manager:
                evaluation_manager = EvaluationManager(
                    ...
                    llm_name_rationale=evaluation_llm_name_rationale if evaluation_llm_name_rationale else "gpt-4",
                    llm_name_accuracy=evaluation_llm_name_accuracy if evaluation_llm_name_accuracy else "gpt-4",
                )
