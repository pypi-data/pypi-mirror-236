...
class MainPySIGMA:
    ...
    def build(self, input_yaml_file_path: str = None, input_coordinates_path=None, results_folder_name=None):
        """
        ...
        BuildComsolModel(model_data=dm, input_conductor_params=sdm, settings=get_user_settings(),
