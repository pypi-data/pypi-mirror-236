...
def get_tPCoff_dictionary_from_PSPICE_netlist_data(path_to_circuit_file: str, verbose: bool = False) -> dict:
    """
    ** Extracts t_PC_off values from a PSPICE netlist file and returns them in a dictionary. **
    ...
    if verbose:
        print(f"The following values of t_PC_off were extracted from the netlist file: {output_dict}")
    return output_dict
