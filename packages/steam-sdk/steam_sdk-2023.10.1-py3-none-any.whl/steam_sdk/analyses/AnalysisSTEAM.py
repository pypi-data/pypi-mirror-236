        ...
        for v, value in enumerate(step.variable_value):
            ...
            if len_simulation_numbers > 0:
                ...
                if 'SIGMA' in step.software:
                    results_folder_name = os.path.join(self.settings.local_SIGMA_folder, step.simulation_name, f"{step.simulation_name}_{simulation_number}")
                    make_folder_if_not_existing(results_folder_name)
                    BM.buildPySIGMA(results_folder_name=results_folder_name)
