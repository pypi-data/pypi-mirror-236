...
from steam_sdk.analyses.AnalysisEvent import find_n_magnets_in_circuit, find_IPQ_circuit_type_from_IPQ_parameters_table, \
    ...
    get_tPCoff_dictionary_from_PSPICE_netlist_data
...
class TestAnalysisEvent(unittest.TestCase):
    ...
    def test_get_circuit_type(self):
        ...
        path_tests_folder = os.path.dirname(self.current_path)
        library_path = os.path.join(path_tests_folder, 'builders', 'model_library')
                                    # )fr'C:\Users\{user_name}\cernbox\steam_models'
    ...
    def test_get_tPCoff_dictionary_from_PSPICE_netlist_data(self):
        """
        **Test case for the get_tPCoff_dictionary_from_PSPICE_netlist_data.
        ...
        # Arrange
        test_cases = [
            {'circuit_file_name': "IPD.cir", 'target_dictionary': {'t_PC_off': '682.2153061979649'}},
            {'circuit_file_name': "IPQ_RQ4_4_2xRPHH_4xMQY.cir", 'target_dictionary': {'t_PC_off_PC1': '324.7833333333333', 't_PC_off_PC2': '324.7833333333333'}},
            {'circuit_file_name': "RCO.cir",'target_dictionary': {'t_PC_off': '15.0'}},
            {'circuit_file_name': "RQT.cir", 'target_dictionary': {'t_PC_off': '369.55'}},
            {'circuit_file_name': "RQX.cir", 'target_dictionary':  {'t_PC_off_PC1': '169.74117647058824','t_PC_off_PC2': '169.74117647058824','t_PC_off_PC3': '169.74117647058824'}},
        ]

        for scenario in test_cases:
                circuit_file_name = scenario['circuit_file_name']
                target_dictionary = scenario['target_dictionary']

                path_to_circuit_file = os.path.join(os.getcwd(),"input","dummy_circuit_files",circuit_file_name)

                # Act
                dictionary = get_tPCoff_dictionary_from_PSPICE_netlist_data(path_to_circuit_file)

                # Assert
                self.assertEqual(dictionary, target_dictionary)
