...
from sunpeek.core_methods.pc_method import PCMethods, PCFormulae, OutputUnits
...
METHOD_DESCRIPTION = 'Thermal Power Check according to ISO 24194:2022'
    ...
    def __init__(self,
        ...
        for k in settings:
            if k not in self.names:
                raise PCMethodError(f'Unknown Performance Check method setting: {k}.'
