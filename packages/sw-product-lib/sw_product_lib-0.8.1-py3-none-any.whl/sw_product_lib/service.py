...
# These will be removed in some future release.
api_key = os.getenv("PRODUCT_LIB_API_KEY")
base_url = os.getenv("PRODUCT_LIB_BASE_URL", DEFAULT_PLATFORM_BASE_URL)


def _api():
    _api_key = os.getenv("PRODUCT_LIB_API_KEY")
    _base_url = os.getenv("PRODUCT_LIB_BASE_URL", DEFAULT_PLATFORM_BASE_URL)
    return (
...
class RequestContext:
    ...
    product_api_key: Optional[str] = os.getenv("PRODUCT_LIB_API_KEY")
    ...
    def new(
        ...
        return RequestContext(
            ...
            product_api_key=product_api_key or os.getenv("PRODUCT_LIB_API_KEY"),
        )
    ...
    def from_request(request: Request):
        ...
        return RequestContext.from_jwt(
            ...
            _auth_token=token,
            product_api_key=os.getenv("PRODUCT_LIB_API_KEY"),
...
def get_token(key: Optional[str] = None, url: Optional[str] = None) -> str:
    ...
    return auth.get_token(
        api_key=key or os.getenv("PRODUCT_LIB_API_KEY"),
        base_url=url or os.getenv("PRODUCT_LIB_BASE_URL", DEFAULT_PLATFORM_BASE_URL),
