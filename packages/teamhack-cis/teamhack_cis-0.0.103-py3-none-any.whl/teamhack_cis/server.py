...
def get_mount(file_path:str, dest:Optional[str]=None, read_only:bool=True)->types.Mount:
    """ create mount object """
    if dest is None:
        dest = file_path
...
def get_dc()->DockerClient:
    ...
    #check_file_exists(file_path)
    #mount = get_mount(file_path, dest='/home/cis/.bazelrc')
    #mounts.append(mount)
    ...
    # mount /var/cache/ccache, named-volume, rw
