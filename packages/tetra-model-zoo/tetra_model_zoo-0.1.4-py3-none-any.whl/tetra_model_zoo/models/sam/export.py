...
def main():
    ...
    # Load SAM models
    sam_tetra_wrapper = SAMTetraWrapper.from_pretrained()

    sam_encoder = sam_tetra_wrapper.sam_encoder
    sam_decoder = sam_tetra_wrapper.get_sam_decoder(orig_img_size=input_img_size,
