...
from tinybird.tb_cli_modules.exceptions import CLIPipeException, CLIGitReleaseException, CLIBranchException
    ...
    if git_release:
        ...
        if not current_release:
            if current_ws.get("is_branch"):
                raise CLIBranchException(FeedbackManager.error_env_init_release(workspace=current_ws["name"]))
            else:
