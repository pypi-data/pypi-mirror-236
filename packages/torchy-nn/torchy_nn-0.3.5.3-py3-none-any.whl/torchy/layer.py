...
from nn.initializations import kaiming_uniform
from nn.values import Value
...
class Linear(NnLayer):
    ...
    def __init__(self, n_input: int, n_output: int, bias: bool = True):
        ...
        self.weight = Value(kaiming_uniform(n_input) * np.random.randn(n_input, n_output))
...
class Conv2d(NnLayer):
    ...
    def __init__(
        ...
        init_value = kaiming_uniform(in_channels * kernel_size * kernel_size)
