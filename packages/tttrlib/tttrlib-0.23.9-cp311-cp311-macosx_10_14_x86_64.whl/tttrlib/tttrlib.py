...
def selection_by_count_rate(time, time_window, n_ph_max, macro_time_calibration=1.0, invert=False):
    r"""
    selection_by_count_rate(time, time_window, n_ph_max, macro_time_calibration=1.0, invert=False)
    ...
    * `invert` :  
    ...
    """
    return _tttrlib.selection_by_count_rate(time, time_window, n_ph_max, macro_time_calibration, invert)
...
class TTTR(object):
    ...
    def get_selection_by_count_rate(self, time_window, n_ph_max, invert=False):
        r"""
        get_selection_by_count_rate(self, time_window, n_ph_max, invert=False)
        ...
        * `n_ph_max` :  
        ...
        """
        return _tttrlib.TTTR_get_selection_by_count_rate(self, time_window, n_ph_max, invert)

    def get_tttr_by_count_rate(self, time_window, n_ph_max, invert=False):
        r"""
        get_tttr_by_count_rate(self, time_window, n_ph_max, invert=False) -> std::shared_ptr< TTTR >
        ...
        """
        return _tttrlib.TTTR_get_tttr_by_count_rate(self, time_window, n_ph_max, invert)
    ...
    def mean_lifetime(self, tttr_irf=None, m0_irf=1, m1_irf=1, tttr_indices=None, dt=-1.0, minimum_number_of_photons=1):
        r"""
        mean_lifetime(self, tttr_irf=None, m0_irf=1, m1_irf=1, tttr_indices=None, dt=-1.0, minimum_number_of_photons=1) -> double
        ...
        """
        return _tttrlib.TTTR_mean_lifetime(self, tttr_irf, m0_irf, m1_irf, tttr_indices, dt, minimum_number_of_photons)
...
class TTTRMask(object):
    ...
    def select_channels(self, tttr, routing_channels, mask=True):
        r"""
        select_channels(self, tttr, routing_channels, mask=True)
...
class CLSMImage(object):
    ...
    def get_fcs_image(self, *args, **kwargs):
        r"""
        get_fcs_image(self, tttr, clsm_other, correlation_method="default", n_bins=50, n_casc=1, stack_frames=False, normalized_correlation=False, min_photons=2)
    ...
    def get_roi(*args, **kwargs):
        r"""
        get_roi(clsm=None, x_range=std::vector< int >({0,-1}), y_range=std::vector< int >({0,-1}), subtract_average="", background=0.0, clip=False, clip_max=1e6, clip_min=-1e6, images=None, mask=None, selected_frames=std::vector< int >())
