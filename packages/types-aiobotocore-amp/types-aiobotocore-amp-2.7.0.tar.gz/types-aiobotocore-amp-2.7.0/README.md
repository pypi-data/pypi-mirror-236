...
[aiobotocore.PrometheusService 2.7.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/amp.html#PrometheusService)
...
from types_aiobotocore_amp.waiter import WorkspaceActiveWaiter, WorkspaceDeletedWaiter
