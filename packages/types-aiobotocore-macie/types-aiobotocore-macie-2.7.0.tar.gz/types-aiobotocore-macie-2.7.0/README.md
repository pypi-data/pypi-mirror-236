...
[aiobotocore.Macie 2.7.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/macie.html#Macie)
...
from types_aiobotocore_macie import MacieClient
from types_aiobotocore_macie.paginator import ListMemberAccountsPaginator, ListS3ResourcesPaginator
...
async with session.create_client("macie") as client:
    ...
    list_s3_resources_paginator: ListS3ResourcesPaginator = client.get_paginator(
        "list_s3_resources"
    )
```
