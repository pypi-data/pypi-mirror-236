...
class S3Client(AioBaseClient):
    ...
    async def delete_bucket_metrics_configuration(
        ...
        (specified by the metrics configuration ID) from the
        bucket.
    ...
    async def delete_object(
        ...
        *,
        ...
        marker, which becomes the latest version of the
        object.
    ...
    async def get_bucket_acl(
        ...
        the access control list (ACL) of a
        bucket.
    ...
    async def get_bucket_analytics_configuration(
        ...
        (identified by the analytics configuration ID) from the
        bucket.
    ...
    async def put_bucket_encryption(
        ...
        *,
        ...
        and Amazon S3 Bucket Keys for an existing
        bucket.
    ...
    async def put_bucket_inventory_configuration(
        ...
        *,
        ...
        (identified by the inventory ID) to the
        bucket.
    ...
    async def put_object_acl(
        ...
        *,
        ...
        a new or existing object in an S3
        bucket.
