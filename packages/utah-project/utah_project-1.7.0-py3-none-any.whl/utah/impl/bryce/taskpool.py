from utah.impl.bryce.utilities import RWD
...
class ProcessingPool(CoreProcessingPool, RWD):
    def __init__(self, total_threads:int, gc_secs:int, status_retention_days:int, upd_timeout_secs:int, task_timeout_secs:int, mongo_db_info:dict, collection:str):
        RWD.__init__(self, mongo_db_info=mongo_db_info, collection=collection)
