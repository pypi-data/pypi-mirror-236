    ...
    def __init__(self, limit=None, *args, **kwargs):
        ...
        for user_agent in self.load_user_agents():        
            ...
            if self.software_engines and user_agent['software_engine'].lower() not in self.software_engines:
                continue
            if self.operating_systems and user_agent['operating_system'].lower() not in self.operating_system:
                continue
            if self.popularity and user_agent['popularity_types'].lower() not in self.popularity_types:
                continue
