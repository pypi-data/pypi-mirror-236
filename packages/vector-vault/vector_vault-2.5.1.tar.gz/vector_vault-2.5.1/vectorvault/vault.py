...
class Vault:
    ...
    def get_vectors(self, batch_size: int = 32, never_stop: bool = False, loop_timeout: int = 180):
        ...
        rate_ratio = projected_tokens_per_min / 10000000  # 1,000,000 tokens per minute limit
        ...
        token_sleep = 60 / (1000000 / text_len) - trip_time  # sleep time based on token rate
        req_sleep = (60 / 3000) - trip_time  # sleep time based on request rate
