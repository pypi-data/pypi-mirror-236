...
class KafkaConsumer:
    ...
    def process_events(self, events, handler):
        try:
            handler(events)
        ...
        try:
            while True:
                ...
                if event.error():
                    ...
                    self.event_rate.batch.append(event)
