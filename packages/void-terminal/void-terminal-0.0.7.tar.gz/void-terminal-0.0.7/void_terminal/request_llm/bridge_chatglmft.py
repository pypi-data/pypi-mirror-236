...
class GetGLMFTHandle(Process):
    ...
    def check_dependency(self):
        try:
            ...
            self.info = "Missing dependency of ChatGLMFT，If you want to use ChatGLMFT，In addition to the basic pip dependencies，You also need to run`pip install -r request_llm/requirements_chatglm.txt`Install dependencies for ChatGLM。"
            self.success = False
