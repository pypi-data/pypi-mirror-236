...
class GetGLMHandle(Process):
    ...
    def check_dependency(self):
        try:
            ...
            self.info = r"Missing dependencies for jittorllms，If you want to use jittorllms，In addition to the basic pip dependencies，You also need to run`pip install -r request_llm/requirements_jittorllms.txt -i https://pypi.jittor.org/simple -I`"+\
                        r"and`git clone https://gitlink.org.cn/jittor/JittorLLMs.git --depth 1 request_llm/jittorllms`Two commands to install jittorllms dependencies（Run these two commands in the project root directory）。" +\
        ...
        def load_model():
            ...
            try:
                if self.jittorllms_model is None:
                    ...
                    from void_terminal.request_llm.jittorllms.models import get_model
