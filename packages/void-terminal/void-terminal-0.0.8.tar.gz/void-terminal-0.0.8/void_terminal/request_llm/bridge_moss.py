...
class GetGLMHandle(Process):
    ...
    def check_dependency(self): # Main process execution
        try:
            ...
            self.info = """
            Lack of dependencies for MOSS，If you want to use MOSS，In addition to the basic pip dependencies，You also need to run`pip install -r request_llm/requirements_moss.txt`and`git clone https://github.com/OpenLMLab/MOSS.git request_llm/moss`Install dependencies for MOSS。
            """
            self.success = False
        return self.success
