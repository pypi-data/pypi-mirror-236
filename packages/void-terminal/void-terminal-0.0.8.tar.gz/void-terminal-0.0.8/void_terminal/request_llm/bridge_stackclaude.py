from void_terminal.request_llm.bridge_newbingfree import preprocess_newbing_out, preprocess_newbing_out_simple
...
class ClaudeHandle(Process):
    ...
    def check_dependency(self):
        try:
            ...
            self.info = "Missing dependencies，If you want to use Claude，In addition to the basic pip dependencies，You also need to run`pip install -r request_llm/requirements_slackclaude.txt`Install Claude`s dependencies，Then restart the program。"
            self.success = False
