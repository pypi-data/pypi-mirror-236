...
# P.S. Other available models include ["qianfan", "llama2", "qwen", "gpt-3.5-turbo-0613", "gpt-3.5-turbo-16k-0613",  "gpt-3.5-random"
...
# If you need to use Slack Claude，See request_llm/README.md for detailed usage instructions
SLACK_CLAUDE_BOT_ID = ''   
SLACK_CLAUDE_USER_TOKEN = ''


# If you need to use AZURE, please refer to the additional document docs\use_azure.md for details
