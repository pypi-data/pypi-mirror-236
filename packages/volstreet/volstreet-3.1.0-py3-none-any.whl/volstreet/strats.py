...
def overnight_straddle(
    ...
    if eligible_for_short:
        ...
        sell_strike = findstrike(ltp * strike_offset, underlying.base)
...
def buy_weekly_hedge(
    ...
    call_strike = findstrike(ltp * call_offset, underlying.base)
    put_strike = findstrike(ltp * put_offset, underlying.base)
    instrument = Strangle(
...
def biweekly_straddle(
    ...
    ltp = underlying.fetch_ltp()
    strike = findstrike(ltp * strike_offset, underlying.base)
...
def intraday_strangle(
    ...
    def trend_catcher(info_dict, sl_type, qty_ratio, sl, strike_offset):
        ...
        strike = findstrike(strike, underlying.base)
    ...
    if strike_selection == "equal":
        ...
        atm_strike = findstrike(underlying.fetch_ltp(), underlying.base)
...
def intraday_trend(
    ...
    while entries < max_entries and currenttime().time() < exit_time:
        ...
        atm_strike = findstrike(price, underlying.base)
