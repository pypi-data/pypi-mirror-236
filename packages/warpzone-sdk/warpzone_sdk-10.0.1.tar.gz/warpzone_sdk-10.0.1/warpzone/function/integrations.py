...
def get_table_client() -> WarpzoneTableClient:
    return WarpzoneTableClient.from_resource_name(os.environ["STORAGE_ACCOUNT"])


def get_table_client_async() -> WarpzoneTableClientAsync:
    return WarpzoneTableClientAsync.from_resource_name(os.environ["STORAGE_ACCOUNT"])


def get_db_client() -> WarpzoneDatabaseClient:
    return WarpzoneDatabaseClient.from_resource_name(os.environ["STORAGE_ACCOUNT"])


def get_db_client_async() -> WarpzoneDatabaseClientAsync:
    return WarpzoneDatabaseClientAsync.from_resource_name(os.environ["STORAGE_ACCOUNT"])


def get_blob_client() -> WarpzoneBlobClient:
    return WarpzoneBlobClient.from_resource_name(os.environ["STORAGE_ACCOUNT"])
