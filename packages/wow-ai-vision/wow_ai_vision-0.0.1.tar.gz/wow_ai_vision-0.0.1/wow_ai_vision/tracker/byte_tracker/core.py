...
from wow_ai_vision.tracker.byte_tracker import matching
from wow_ai_vision.tracker.byte_tracker.basetrack import BaseTrack, TrackState
from wow_ai_vision.tracker.byte_tracker.kalman_filter import KalmanFilter
...
def detections2boxes(detections: Detections) -> np.ndarray:
    """
    Convert wow_ai_vision Detections to numpy tensors for further computation.
    Args:
