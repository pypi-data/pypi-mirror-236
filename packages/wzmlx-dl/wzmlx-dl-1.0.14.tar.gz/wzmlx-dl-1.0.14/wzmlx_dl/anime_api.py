...
class AnimeAPI:
    ...
    def __init__(self):
        self.base_url = "https://consumet-private.vercel.app/anime/zoro"
    ...
    def get_watch_info(self, episode_id, server):
        response = requests.get(f"{self.base_url}/watch?episodeId={episode_id}?server={server}").json()
        return response
