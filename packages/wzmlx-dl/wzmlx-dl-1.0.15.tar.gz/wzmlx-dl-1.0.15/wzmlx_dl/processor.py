...
class ZORO:
    ...
    @tenacity.retry(
        stop=tenacity.stop_after_attempt(10),  # Retry 3 times
        wait=tenacity.wait_fixed(15),          # Wait 5 seconds between retries
        retry=tenacity.retry_if_exception_type(Exception)
    )
    ...
    def mux_files(self):
        ...
        try:
            ...
            print(colored_text(f"[+] ERROR - Failed to Mux stream data.", "red"))
            # print("Failed to retrieve Mux stream data.")
