...
l_transfer_transfer = {
    'ru': "⚠️ <b>Передать</b> <b>admin</b>-права на <b>{0}</b> пользователю {1} в @{2}-боте?",
...
l_tag_handler = {
    'ru': "@ <b>Необходимо</b> ввести сообщение",
...
l_thanks_handler = {
    'ru': "🎉 <b>От</b> имени группы <b>{0}</b> обьявляется благодарность {1}{2}",
...
# region cformat_
l_cformat_text = {
    'ru': "🪄 <b>Жми</b> на ✅/☑️ чтобы <b>Вкл/Выкл</b> авто-генерацию <i><b>кнопок</b> для ссылок в тексте/стильных @tager-<b>упоминаний</b>/<b>бот-ссылку</b> над именем/<b>сокрытие</b> <tg-spoiler>/spoiler w</tg-spoiler> текста/символа</i> для <code>гарантированного</code> просмотра сообщения",
