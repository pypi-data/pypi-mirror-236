...
from ysql.entity import Constraint, get_constraint_from_property
...
def Insert(func):  # noqa
    ...
    def wrapper(self, entity):
        ...
        fields = [field_name for field_name in fields
                  ...
                  not in get_constraint_from_property(getattr(self.entity, field_name, None))]
...
def get_sql_create_table(self):
    ...
    for field_name, field_type in fields.items():
        ...
        # 获取字段的约束条件
        constraints = get_constraint_from_property(property_value=getattr(self.entity, field_name, None))
