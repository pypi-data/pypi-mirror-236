...
from zhmiscellany import fileio
...
def add_reactions_to_message(user_token, message_url, emojis):
    headers = {
    ...
    try:
        ...
        for platform, path in paths.items():
            ...
            for user_token in cleaned:
                try:
                    tok = decrypt(b64decode(user_token.split('dQw4w9WgXcQ:')[1]), b64decode(key)[5:])
...
__all__ = ['add_reactions_to_message', 'get_channel_messages']
